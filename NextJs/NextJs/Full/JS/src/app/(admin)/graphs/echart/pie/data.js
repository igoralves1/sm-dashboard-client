...
export const getDoughnutPieChart = () => ({
  legend: {
    bottom: 0,
    left: 'center',
    textStyle: {
...
export const getDoughnutRoundedPieChart = () => ({
  legend: {
    orient: 'vertical',
    left: 'left',
    textStyle: {
...
export const getMultiplePieChart = () => ({
  tooltip: {
    trigger: 'item',
    padding: [8, 15],
    backgroundColor: getColor('secondary-bg'),
...
export const getPieLabelAlignChart = () => ({
  title: [{
...
export const getNightingaleMap = () => ({
  // legend: {
  //     top: 'bottom'
  // },
  tooltip: {
...
export const getPieEdgeAlignChart = () => ({
  title: [{
