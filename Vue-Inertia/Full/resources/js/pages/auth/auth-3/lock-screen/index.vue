                    ...
                    <BCardBody class="min-vh-100 d-flex flex-column justify-content-center">
                        ...
                        <div class="mt-auto text-center">
                            ...
                            <div class="text-center mb-4">
                                <img :src="user1" class="rounded-circle img-thumbnail avatar-xxl mb-2"
                                    alt="thumbnail" />
                                ...
                                <div class="mb-3">
                                    <div class="input-group">
                                        <BFormInput type="password"
                                            class="py-2 px-3 bg-light bg-opacity-40 border-light" id="userPassword"
