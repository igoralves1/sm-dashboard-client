                    ...
                    <BCard no-body class="position-relative">
                        <div class="position-absolute top-0 end-0">
                            <svg style="opacity: 0.05;" width="600" height="560" viewBox="0 0 600 560" fill="none"
                                ...
                                <!-- Star -->
                                <path
                                    d="M380 80 L388 100 H410 L392 115 L400 135 L380 123 L360 135 L368 115 L350 100 H372 Z"
                                    fill="#0acf97" />
                        ...
                        <BCardBody class="position-relative">
                            <p class="fst-italic fs-sm">Welcome to our website. By accessing or using this site, you
                                agree
                                to be bound by these terms and conditions. Please read them carefully.</p>

                            <h4 class="fw-bold mt-3">1. Acceptance of Terms</h4>
                            <p>By using this website, you acknowledge that you have read, understood, and agree to be
                                bound
                            ...
                            <p>We reserve the right to modify these Terms and Conditions at any time. Updated terms will
                                be
                            ...
                            <p>All content, trademarks, graphics, and materials on this website are owned or licensed by
                                us
                            ...
                            <p>All purchases are final unless otherwise specified. Refund requests will be considered on
                                a
