...
import RealTimeChart from '@/app/(admin)/graphs/apex/line/components/RealTimeChart';
import ComponentCard from '@/components/cards/ComponentCard';
import ApexChartClient from '@/components/client-wrapper/ApexChartClient';
import PageBreadcrumb from '@/components/PageBreadcrumb';
import { Col, Container, Row } from 'react-bootstrap';
import { getBrushChart, getBrushChart2, getDashedLineChart, getLineChart, getMissingLineChart, getSimpleLineChart, getSteplineChart, getSyncingCharts, getSyncingCharts2, getZoomableTimeseriesChart } from './data';
const Page = () => {
