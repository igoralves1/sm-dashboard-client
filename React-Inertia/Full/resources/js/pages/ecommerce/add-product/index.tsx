...
import ProductInformation from '@/pages/ecommerce/add-product/components/ProductInformation'
import ProductImage from '@/pages/ecommerce/add-product/components/ProductImage'
import Pricing from '@/pages/ecommerce/add-product/components/Pricing'
import Organize from '@/pages/ecommerce/add-product/components/Organize'
