    ...
    <BCard no-body>
        ...
        <BCardBody>
            ...
            <BRow class="g-3 mb-3">
                ...
                <BCol lg="6">
                    <vue3-simple-typeahead class="form-control" placeholder="Enter states from USA" :items="US_STATES"
                        @selectItem="handleSelectBasic" @onInput="(e) => basicInput = e.input" :minInputLength="1" />
            ...
            <BRow class="g-3 mb-3">
                ...
                <BCol lg="6">
                    <vue3-simple-typeahead class="form-control" placeholder="Enter states from USA" :items="bloodhoundItems"
                        :minInputLength="1" @onInput="(evt) => debounceFilter(evt.input)"
                        @selectItem="(item) => basicSelection = item" />
            ...
            <BRow class="g-3 mb-3">
                ...
                <BCol lg="6">
                    <vue3-simple-typeahead class="form-control" placeholder="Enter states from USA" :items="prefetchItems"
                        :minInputLength="1" />
                </BCol>
            </BRow>
            ...
            <BRow class="g-3 mb-3">
                ...
                <BCol lg="6">
                    <vue3-simple-typeahead class="form-control" placeholder="Default Suggestions" :items="defaultSuggestions"
                        :minInputLength="0" :minItemLength="0" />
                </BCol>
            </BRow>
...
function handleSelectBasic(item: string) { basicSelection.value = item }
