    ...
    <BCard no-body>
        <BCardBody>
            <div class="d-flex mb-4">
                <div class="avatar-xl me-3">
                    <span class="avatar-title text-bg-light rounded">
                        <Icon :name="project.icon" :class="`fs-24 text-${project.variant}`" />
                    </span>
                </div>

                <div>
                    <h5 class="mb-1 d-flex align-items-center">
                        <NuxtLink to="/projects" class="link-reset">
                            {{ project.title }}
                        </NuxtLink>
                    </h5>
                ...
                <div class="ms-auto">
                    <BDropdown placement="bottom-end" variant="link" class="btn-icon btn-ghost-light text-muted drop-arrow-none px-2" no-caret>
                        <template #button-content>
                            <Icon name="tabler:dots-vertical" class="fs-xl" />
                        </template>
                        <BDropdownItem>
                            <Icon name="tabler:share" class="me-2" /> Share
                        </BDropdownItem>
                        <BDropdownItem>
                            <Icon name="tabler:edit" class="me-2" /> Edit
                        </BDropdownItem>
                        <BDropdownItem>
                            <Icon name="tabler:ban" class="me-2" /> Block
                        </BDropdownItem>
                        <BDropdownItem class="text-danger">
                            <Icon name="tabler:trash" class="me-2" /> Delete
                        </BDropdownItem>
                    </BDropdown>
                </div>
            </div>
            ...
            <BRow>
                <BCol sm="6">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <Icon name="tabler:list-check" class="text-muted fs-lg" />
                ...
                <BCol sm="6">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <Icon name="tabler:paperclip" class="text-muted fs-lg" />
            ...
            <BRow>
                <BCol sm="6">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <Icon name="tabler:message-2" class="text-muted fs-lg" />
                        <h5 class="fs-base mb-0 fw-medium">{{ project.comments }} Comments</h5>
                    </div>
                </BCol>
                <BCol sm="6">
                    <div class="d-flex align-items-center gap-2 mb-3">
                        <Icon name="tabler:calendar-time" class="text-muted fs-lg" />
            ...
            <div class="avatar-group avatar-group-xs mb-3">
                <div v-for="(member, idx) in project.members" :key="idx" class="avatar">
                    <NuxtImg :src="member" alt="" class="rounded-circle avatar-xs" />
                </div>
            </div>
