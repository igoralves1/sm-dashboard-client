                    ...
                    <BCardHeader class="border-light justify-content-between">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="app-search">
                                ...
                                <Icon name="lucide:globe" :size="18" class="app-search-icon text-muted" />
                            </div>
                            ...
                            <div class="app-search">
                                ...
                                <Icon name="lucide:layout" size="18" class="app-search-icon text-muted" />
                            </div>
                    ...
                    <BTable show-empty :filter="searchQuery" empty-text="Nothing found."
                        ...
                        <template #cell(name)="{ item }">
                            <div class="d-flex justify-content-start align-items-center gap-2">
                                <div class="avatar avatar-sm">
                                    <NuxtImg :src="item.image" alt="avatar-7" class="img-fluid rounded-circle" />
                                </div>
                                <div>
                        ...
                        <template #cell(country)="{ item }">
                            <span class="badge p-1 text-bg-light fs-sm">
                                <NuxtImg :src="item.flag" alt="" class="rounded-circle me-1" height="12"/>
                                    {{ item.countryCode }}
                            </span>
                        </template>
...
import { toPascalCase, toTitleCase } from '~/helpers/casing';
