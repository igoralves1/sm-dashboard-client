                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex align-items-center gap-2 mb-3">
                                    ...
                                    <img src="assets/images/flags/br.svg" alt="Brazil" class="avatar-xxs rounded">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <img src="assets/images/flags/it.svg" alt="Italy" class="avatar-xxs rounded">
                ...
                <div class="row">
                    <div class="col-xl-4">
                        <div class="card border-top-0">
                            <div class="position-relative card-side-img overflow-hidden rounded-top" style="height: 180px; background-image: url(assets/images/profile-bg.jpg);">
                                ...
                                <div class="d-flex justify-content-start gap-3">
                                    <div class="avatar avatar-xxl" style="margin-top: -60px;">
                                        <a href="pages-profile.php">
                                            <img src="assets/images/users/user-2.jpg" alt="User Profile" class="img-fluid img-thumbnail rounded-circle">
                                        </a>
                                    </div>
                                    <div>
                                        <h4 class="text-nowrap fw-bold mb-1">
                                            <a href="pages-profile.php" class="text-reset text-decoration-none">Damian D.</a>
                                        </h4>
                            ...
                            <div class="card-body">
                                <div class="pb-2 border-bottom border-light border-dashed">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="avatar-group avatar-group-xs">
                                            <div class="avatar">
                                                <img src="assets/images/users/user-5.jpg" alt="Liam Carter" class="avatar-xs rounded-circle">
                                            </div>
                                            <div class="avatar">
                                                <img src="assets/images/users/user-6.jpg" alt="Zoe Miles" class="avatar-xs rounded-circle">
                                            </div>
                                ...
                                <div class="py-2 border-bottom border-light border-dashed">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <div class="avatar-group avatar-group-xs">
                                            <div class="avatar">
                                                <img src="assets/images/users/user-7.jpg" alt="Ava Lee" class="avatar-xs rounded-circle">
                                            </div>
                                            <div class="avatar">
                                                <img src="assets/images/users/user-8.jpg" alt="Ethan King" class="avatar-xs rounded-circle">
                                            </div>
                                            <div class="avatar">
                                                <img src="assets/images/users/user-9.jpg" alt="Lucas White" class="avatar-xs rounded-circle">
                                            </div>
                                        </div>
                                        <button type="button" class="btn btn-sm btn-soft-secondary rounded-circle btn-icon">
