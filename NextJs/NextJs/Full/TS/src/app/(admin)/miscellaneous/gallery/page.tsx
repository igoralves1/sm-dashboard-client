...
const slides = [
  { asset: img1.src, width: 640, height: 427, category: 'beautiful' },
  { asset: img2.src, width: 640, height: 360, category: 'nature' },
  { asset: img3.src, width: 640, height: 854, category: 'beautiful' },
  { asset: img4.src, width: 640, height: 640, category: 'nature' },
  { asset: img5.src, width: 640, height: 960, category: 'travel' },
  { asset: img6.src, width: 640, height: 800, category: 'nature' },
  { asset: img7.src, width: 640, height: 425, category: 'city' },
  { asset: img8.src, width: 640, height: 480, category: 'city' },
  { asset: img9.src, width: 640, height: 960, category: 'travel' },
  { asset: img10.src, width: 640, height: 962, category: 'beautiful' },
  { asset: img11.src, width: 640, height: 427, category: 'nature' },
  { asset: img12.src, width: 640, height: 359, category: 'city' },
  { asset: img14.src, width: 640, height: 960, category: 'travel' },
