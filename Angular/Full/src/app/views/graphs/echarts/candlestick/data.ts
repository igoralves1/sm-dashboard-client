...
export const basicCandle = (): EChartsOption => ({
    tooltip: {
        trigger: "axis",
        padding: [8, 15],
    ...
    yAxis: {
        ...
        type: "candlestick", name: "Volume", data: data.map(d => d.slice(1)), itemStyle: {
        ...
        right: 5, left: 5, bottom: 5, top: 10, containLabel: true
    }
})
...
export const mixedCandle = (): EChartsOption => ({
    backgroundColor: 'transparent', tooltip: {
        ...
        data: ['getColor', 'MA5', 'MA10', 'MA20', 'MA30'], textStyle: {color: getColor("body-color")}
    }, grid: {
        ...
        borderColor: getColor("border-color"),
        fillerColor: getColor('primary-rgb', 0.25),
        dataBackground: {
            lineStyle: {
        ...
        handleSize: '100%',
        handleStyle: {
            color: getColor("primary"), borderColor: getColor("border-color")
        },
        textStyle: {
            color: getColor("body-color")
        },
        ...
        name: 'getColor', type: 'candlestick', data: mixedData.values, itemStyle: {
            color: getColor("primary"),
            color0: getColor("danger"),
            borderColor: getColor("primary"),
            borderColor0: getColor("danger")
        }, markPoint: {
            label: {
                ...
                name: 'Mark', coord: ['2025/5/31', 2300], value: 2300, itemStyle: {
                    color: 'rgb(41,60,85)'
                },
            }, {
            ...
            symbol: ['none', 'none'], data: [[{
                ...
                type: 'max', valueDim: 'highest', symbol: 'circle', symbolSize: 10, label: {
                    show: false
                }, emphasis: {
                    label: {
                        show: false
        ...
        name: 'MA5', type: 'line', data: calculateMA(5), smooth: true, itemStyle: {
            color: getColor("purple")
        }, lineStyle: {
            opacity: 0.9
        }
    }, {
        name: 'MA10', type: 'line', data: calculateMA(10), smooth: true, itemStyle: {
            color: getColor("secondary")
        }, lineStyle: {
            opacity: 0.5
        }
    }, {
        name: 'MA20', type: 'line', data: calculateMA(20), smooth: true, itemStyle: {
            color: getColor("warning")
        }, lineStyle: {
            opacity: 0.5
        }
    }, {
        name: 'MA30', type: 'line', data: calculateMA(30), smooth: true, itemStyle: {
