                    ...
                    <BCardHeader class="border-light justify-content-between">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="app-search">
                                ...
                                <Icon name="lucide:activity" size="18" class="app-search-icon text-muted" />
                            </div>
                        ...
                        <div class="d-flex gap-1">
                            <NuxtLink to="/projects" class="btn btn-soft-primary btn-icon">
                                <Icon name="lucide:layout-grid" class="fs-lg" />
                            </NuxtLink>
                            <NuxtLink to="/projects-list" class="btn btn-primary btn-icon">
                            ...
                            <div class="d-flex">
                                <div class="avatar-md me-3">
                                    <span class="avatar-title text-bg-light rounded">
                                        <Icon :name="item.icon" class="fs-24" :class="[`text-${item.variant}`]" />
                                    </span>
                                </div>
                                <div>
                                    <h5 class="mb-1 d-flex align-items-center">
                                        <NuxtLink :to="`/projects/${item.id}`" class="link-reset">{{ item.title }}
                                        </NuxtLink>
                                    </h5>
