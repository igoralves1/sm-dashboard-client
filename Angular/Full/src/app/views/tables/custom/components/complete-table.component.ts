...
@Component({
    ...
    imports: [RatingComponent, RouterLink, NgIcon, FormsModule, LucideAngularModule, NgbPagination, NgbPaginationNext, NgbPaginationPrevious, NgbdSortableHeader, UiCardComponent, AsyncPipe],
    template: `
