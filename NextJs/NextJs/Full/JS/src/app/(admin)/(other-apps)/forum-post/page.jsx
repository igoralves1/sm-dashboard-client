                ...
                <CardBody>
                  ...
                  <p className="d-flex flex-wrap gap-3 text-muted mt-3 mb-0 pb-3 align-items-center justify-content-between fs-sm">
                    <span className="d-flex align-items-center gap-2">
                      <Image src={user5} width={32} height={32} alt="avatar-5" className="img-fluid avatar-sm rounded" />
                  ...
                  <div className="d-flex mb-2 border border-dashed rounded p-3">
                    <div className="flex-shrink-0">
                      <Image height={32} width={32} src={user8} alt="" className="avatar-sm rounded-circle shadow-sm" />
                    </div>
                    <div className="flex-grow-1 ms-2">
                      ...
                      <div className="d-flex mt-4">
                        <div className="flex-shrink-0">
                          <Image height={32} width={32} src={user10} alt="" className="avatar-sm rounded-circle shadow-sm" />
                        </div>
                        <div className="flex-grow-1 ms-2">
                          <h5 className="mb-1">
                      ...
                      <div className="d-flex mt-4">
                        <div className="flex-shrink-0">
                          <Image height={32} width={32} src={user3} alt="" className="avatar-sm rounded-circle shadow-sm" />
                        </div>
                        <div className="flex-grow-1 ms-2">
                          <h5 className="mb-1">
                  ...
                  <div className="d-flex mb-2 border border-dashed rounded p-3">
                    <div className="flex-shrink-0">
                      <Image height={32} width={32} src={user6} alt="" className="avatar-sm rounded-circle shadow-sm" />
                    </div>
                    <div className="flex-grow-1 ms-2">
                      <h5 className="mb-1">
              ...
              <Card>
                ...
                <CardBody className="border-bottom border-dashed">
                  ...
                  <ul className="list-group list-group-flush fs-sm">
                    {categories.map((item, idx) => <li key={idx} className="list-group-item ps-0">
                        <Link href={item.url} className="link-reset fw-medium">
                          {item.title}
                        </Link>
                      </li>)}
                  </ul>
                ...
                <CardBody className="border-bottom border-dashed">
                  ...
                  <ul className="list-group list-group-flush fs-sm">
                    {questions.map((question, idx) => <li className="list-group-item ps-0" key={idx}>
                        <Link href={question.url} className="link-reset fw-medium">
                          {question.title}
                        </Link>
                      </li>)}
                  </ul>
                ...
                <CardBody>
                  ...
                  <div className="d-flex flex-wrap gap-1">
                    {tags.map((tag, idx) => <Button variant="light" size="sm" key={idx}>
                        {tag}
                      </Button>)}
                  </div>
                </CardBody>
