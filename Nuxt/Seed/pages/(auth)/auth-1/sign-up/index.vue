          ...
          <BCard no-body class="p-4 rounded-4">
            <form>
              ...
              <div class="mb-3">
                ...
                <div class="input-group">
                  <BFormInput type="password" v-model="password"  id="userPassword"
              ...
              <div class="d-grid">
                <BButton variant="primary" type="submit" class="fw-semibold py-2">Create Account</BButton>
              </div>
            </form>

            <p class="text-muted text-center mt-4 mb-0">
              Already have an account?
              <NuxtLink to="/auth-1/sign-in" class="text-decoration-underline link-offset-3 fw-semibold">
                Login
              </NuxtLink>
            </p>
          </BCard>
