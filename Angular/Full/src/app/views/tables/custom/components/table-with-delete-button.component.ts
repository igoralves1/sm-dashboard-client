...
@Component({
    ...
    template: `
        <app-ui-card title="Custom table with delete buttons" bodyClass="p-0">
...
export class TableWithDeleteButtonComponent implements OnInit {
    ...
    ngOnInit(): void {
        this.tableService.setItems(structuredClone(products).slice(0, 5), 5)
    }
