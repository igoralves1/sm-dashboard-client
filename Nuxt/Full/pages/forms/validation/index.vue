    ...
    <BContainer>
        <BRow>
            <BCol lg="12">
                <BCard no-body>
                    <BCardHeader>
                        <BCardTitle tag="h5" class="mb-1 anchor">Vue Bootstrap </BCardTitle>
                    </BCardHeader>
                    <BCardBody>
                        <VBForm />
                    </BCardBody>
                ...
                <BCard no-body>
                    <BCardHeader>
                        <BCardTitle tag="h5" class="mb-1 anchor"> Yup
                        </BCardTitle>
                    </BCardHeader>
                    <BCardBody>
                        <YupForm />
                ...
                <BCard no-body>
                    <BCardHeader>
                        <BCardTitle tag="h5" class="mb-1 anchor"> Vuelidate
                        </BCardTitle>
                    </BCardHeader>
                    <BCardBody>
                        <VuelidateForm />
                ...
                <BCard no-body>
                    <BCardHeader>
                        <BCardTitle tag="h5" class="mb-1 anchor"> Server Side </BCardTitle>
                    </BCardHeader>
                    <BCardBody>
                        <form class="row g-3">
                            <BCol md="4">
                ...
                <BCard no-body>
                    <BCardHeader>
                        <BCardTitle tag="h5" class="mb-1 anchor"> Supported
                            elements</BCardTitle>
                    </BCardHeader>
                    <BCardBody>
...
import VBForm from './components/VBForm.vue';

usePageTitle('Form Validation')
</script>
