    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "Ecommerce", "title" => "Order Details")) ?>
                                                ...
                                                <tbody>
                                                        ...
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="avatar-md me-3">
                                                                    <img src="/images/products/1.png" alt="Wireless Earbuds" class="img-fluid rounded">
                                                                </div>
                                                                <div>
                                                                    <h5 class="mb-1">
                                                                        <a href="ecommerce-product-details" class="link-reset">Wireless Earbuds</a>
                                                                    </h5>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="avatar-md me-3">
                                                                    <img src="/images/products/2.png" alt="Smart Watch" class="img-fluid rounded">
                                                                </div>
                                                                <div>
                                                                    <h5 class="mb-1">
                                                                        <a href="ecommerce-product-details" class="link-reset">Smart Watch</a>
                                                                    </h5>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <div class="d-flex">
                                                                <div class="avatar-md me-3">
                                                                    <img src="/images/products/3.png" alt="Gaming Mouse" class="img-fluid rounded">
                                                                </div>
                                                                <div>
                                                                    <h5 class="mb-1">
                                                                        <a href="ecommerce-product-details" class="link-reset">Gaming Mouse</a>
                                                                    </h5>
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center mb-4">
                                            <div class="me-2">
                                                <img src="/images/users/user-5.jpg" alt="avatar" class="rounded-circle avatar-lg">
                                            </div>
                                            <div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <div class="avatar-sm me-2">
                                                <img src="/images/cards/mastercard.svg" alt="Mastercard" class="img-fluid rounded">
                                            </div>
                                            <div>
