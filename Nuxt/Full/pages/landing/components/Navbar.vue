<template>
    <BAlert v-model="showDismissibleAlert" variant="primary" class="top-alert mb-0 rounded-0 w-100 position-relative"
        ...
        <div class="fst-italic fw-medium text-center">
            ...
            <NuxtLink
                ...
                target="_blank" class="fw-semibold fst-normal text-white text-decoration-underline link-offset-3 ms-2">
                Buy Now!
            </NuxtLink>
        </div>
        <button class="btn-close btn-close-white position-absolute end-0 me-3"
            style="top: 50%; transform: translateY(-50%);" @click="closeAlert" />
    </BAlert>
            ...
            <div class="container">
                <div class="auth-brand d-inline-block mb-0">
                    <NuxtLink to="/" class="logo-dark">
                        <NuxtImg src="/images/logo-black.png" alt="dark logo" height="32" />
                    </NuxtLink>
                    <NuxtLink to="/" class="logo-light">
                        <NuxtImg src="/images/logo.png" alt="logo" height="32" />
                    </NuxtLink>
                </div>
                ...
                <BCollapse id="nav-collapse" v-model="isCollapsed" is-nav>
                    <BNavbarNav class="fw-medium gap-2 fs-sm mx-auto mt-2 mt-lg-0">
                        <BNavItem v-for="item in navItems" :key="item" href="javascript:void(0)"
