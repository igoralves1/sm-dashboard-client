                ...
                <ul class="navbar-nav">
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-dashboards">
                            <a href="index" class="dropdown-item">Dashboard v.1</a>
                            <a href="dashboard-2" class="dropdown-item">Dashboard v.2</a>
                            <a href="dashboard-3" class="dropdown-item">Dashboard v.3</a>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-apps">
                            <a href="calendar" class="dropdown-item"><i class="ti ti-calendar"></i> Calendar</a>
                            <a href="chat" class="dropdown-item"><i class="ti ti-message"></i> Chat</a>
                            <a href="file-manager" class="dropdown-item"><i class="ti ti-folder"></i> File Manager</a>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-ecommerce">
                                    ...
                                    <a href="ecommerce-product-details" class="dropdown-item">Product Details</a>
                                    <a href="ecommerce-add-product" class="dropdown-item">Add Product</a>
                                    <a href="ecommerce-categories" class="dropdown-item">Categories</a>
                                    <a href="ecommerce-orders" class="dropdown-item">Orders</a>
                                    <a href="ecommerce-order-details" class="dropdown-item">Order Details</a>
                                    <a href="ecommerce-customers" class="dropdown-item">Customers</a>
                                    <a href="ecommerce-sellers" class="dropdown-item">Sellers</a>
                                    <a href="ecommerce-seller-details" class="dropdown-item">Sellers Details</a>
                                    <a href="ecommerce-reviews" class="dropdown-item">Reviews</a>
                                    <a href="ecommerce-product-views" class="dropdown-item">Product Views</a>
                                    <a href="ecommerce-sales" class="dropdown-item">Sales</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-email">
                                    <a href="email" class="dropdown-item">Inbox</a>
                                    <a href="email-details" class="dropdown-item">Details</a>
                                    <a href="email-compose" class="dropdown-item">Compose</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-projects">
                                    <a href="projects" class="dropdown-item">My Projects</a>
                                    <a href="projects-list" class="dropdown-item">Projects List</a>
                                    <a href="project-details" class="dropdown-item">View Project</a>
                                    <a href="project-kanban" class="dropdown-item">Kanban Board</a>
                                    <a href="project-team-board" class="dropdown-item">Team Board</a>
                                    <a href="project-activity" class="dropdown-item">Activity Stream</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-invoice">
                                    ...
                                    <a href="invoice-details" class="dropdown-item">Single Invoice</a>
                                    <a href="invoice-create" class="dropdown-item">New Invoice</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-otherapps">
                                    ...
                                    <a href="outlook" class="dropdown-item">Outlook View</a>
                                    <a href="vote-list" class="dropdown-item">Vote List</a>
                                    <a href="issue-tracker" class="dropdown-item">Issue Tracker</a>
                                    <a href="api-keys" class="dropdown-item">API Keys</a>
                                    <a href="blog" class="dropdown-item">Blog</a>
                                    <a href="article" class="dropdown-item">Article</a>
                                    <a href="pin-board" class="dropdown-item">Pin Board</a>
                                    <a href="forum-view" class="dropdown-item">Forum View</a>
                                    <a href="forum-post" class="dropdown-item">Forum Post</a>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-pages">
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-genr-pages">
                                    ...
                                    <a href="pages-empty" class="dropdown-item">Empty Page</a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-misc">
                                    <a href="misc-nestable" class="dropdown-item">Nestable List</a>
                                    <a href="misc-text-diff" class="dropdown-item">Text Diff</a>
                                    <a href="misc-pdf-viewer" class="dropdown-item">PDF Viewer</a>
                                    <a href="misc-i18" class="dropdown-item">i18 Support</a>
                                    <a href="misc-sweet-alerts" class="dropdown-item">Sweet Alerts</a>
                                    <a href="misc-idle-timer" class="dropdown-item">Idle Timer</a>
                                    <a href="misc-pass-meter" class="dropdown-item">Password Meter</a>
                                    <a href="misc-live-favicon" class="dropdown-item">Live Favicon</a>
                                    <a href="misc-clipboard" class="dropdown-item">Clipboard</a>
                                    <a href="misc-tree-view" class="dropdown-item">Tree View</a>
                                    <a href="misc-loading-buttons" class="dropdown-item">Loading Buttons</a>
                                    <a href="misc-gallery" class="dropdown-item">Gallery</a>
                                    <a href="misc-masonry" class="dropdown-item">Masonry</a>
                                    <a href="misc-tour" class="dropdown-item">Tour</a>
                                    <a href="misc-animation" class="dropdown-item">Animation</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-auth-v1">
                                    <a href="auth-sign-in" class="dropdown-item">Sign In</a>
                                    <a href="auth-sign-up" class="dropdown-item">Sign Up</a>
                                    <a href="auth-reset-pass" class="dropdown-item">Reset Password</a>
                                    <a href="auth-new-pass" class="dropdown-item">New Password</a>
                                    <a href="auth-two-factor" class="dropdown-item">Two Factor</a>
                                    <a href="auth-lock-screen" class="dropdown-item">Lock Screen</a>
                                    <a href="auth-success-mail" class="dropdown-item">Success Mail</a>
                                    <a href="auth-login-pin" class="dropdown-item">Login with PIN</a>
                                    <a href="auth-delete-account" class="dropdown-item">Delete Account</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-auth-v2">
                                    <a href="auth-2-sign-in" class="dropdown-item">Sign In</a>
                                    <a href="auth-2-sign-up" class="dropdown-item">Sign Up</a>
                                    <a href="auth-2-reset-pass" class="dropdown-item">Reset Password</a>
                                    <a href="auth-2-new-pass" class="dropdown-item">New Password</a>
                                    <a href="auth-2-two-factor" class="dropdown-item">Two Factor</a>
                                    <a href="auth-2-lock-screen" class="dropdown-item">Lock Screen</a>
                                    <a href="auth-2-success-mail" class="dropdown-item">Success Mail</a>
                                    <a href="auth-2-login-pin" class="dropdown-item">Login with PIN</a>
                                    <a href="auth-2-delete-account" class="dropdown-item">Delete Account</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-auth-v3">
                                    <a href="auth-3-sign-in" class="dropdown-item">Sign In</a>
                                    <a href="auth-3-sign-up" class="dropdown-item">Sign Up</a>
                                    <a href="auth-3-reset-pass" class="dropdown-item">Reset Password</a>
                                    <a href="auth-3-new-pass" class="dropdown-item">New Password</a>
                                    <a href="auth-3-two-factor" class="dropdown-item">Two Factor</a>
                                    <a href="auth-3-lock-screen" class="dropdown-item">Lock Screen</a>
                                    <a href="auth-3-success-mail" class="dropdown-item">Success Mail</a>
                                    <a href="auth-3-login-pin" class="dropdown-item">Login with PIN</a>
                                    <a href="auth-3-delete-account" class="dropdown-item">Delete Account</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu" aria-labelledby="topnav-error">
                                    ...
                                    <a href="error-408" class="dropdown-item">408 - Timeout</a>
                                    <a href="error-500" class="dropdown-item">500 - Server Error</a>
                                    <a href="maintenance" class="dropdown-item">Maintenance</a>
                                </div>
                            </div>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-components">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="topnav-baseui">
                                    ...
                                    <a href="ui-collapse" class="dropdown-item">Collapse</a>
                                    <a href="ui-colors" class="dropdown-item">Colors</a>
                                    <a href="ui-dropdowns" class="dropdown-item">Dropdowns</a>
                                    <a href="ui-videos" class="dropdown-item">Videos</a>
                                    <a href="ui-grid" class="dropdown-item">Grid Options</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="topnav-baseuiTwo">
                                    ...
                                    <a href="ui-scrollspy" class="dropdown-item">Scrollspy</a>
                            ...
                            <a href="widgets" class="dropdown-item"><i class="ti ti-category"></i> Widgets</a>
                            <a href="metrics" class="dropdown-item"><i class="ti ti-chart-histogram"></i> Metrics</a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="topnav-apexchartsTwo">
                                    ...
                                    <a href="charts-apex-range" class="dropdown-item">Range</a>
                                    <a href="charts-apex-funnel" class="dropdown-item">Funnel</a>
                                    <a href="charts-apex-slope" class="dropdown-item">Slope</a>
                                    <a href="charts-apextree" class="dropdown-item">Apex Tree</a>
                                    <a href="charts-apexsankey" class="dropdown-item">Apex Sankey</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="topnav-echarts">
                                    <a href="charts-echart-line" class="dropdown-item">Line</a>
                                    <a href="charts-echart-bar" class="dropdown-item">Bar</a>
                                    <a href="charts-echart-pie" class="dropdown-item">Pie</a>
                                    <a href="charts-echart-scatter" class="dropdown-item">Scatter</a>
                                    <a href="charts-echart-geo-map" class="dropdown-item">GEO Map</a>
                                    <a href="charts-echart-gauge" class="dropdown-item">Gauge</a>
                                    <a href="charts-echart-candlestick" class="dropdown-item">Candlestick</a>
                                    <a href="charts-echart-area" class="dropdown-item">Area</a>
                                    <a href="charts-echart-radar" class="dropdown-item">Radar</a>
                                    <a href="charts-echart-heatmap" class="dropdown-item">Heatmap</a>
                                    <a href="charts-echart-other" class="dropdown-item">Other</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="topnav-forms">
                                    ...
                                    <a href="form-pickers" class="dropdown-item">Pickers</a>
                                    ...
                                    <a href="form-text-editors" class="dropdown-item">Text Editors</a>
                                    <a href="form-range-slider" class="dropdown-item">Range Slider</a>
                                    <a href="form-layouts" class="dropdown-item">Layouts</a>
                                    <a href="form-other-plugins" class="dropdown-item">Other Plugins</a>
                                </div>
                            </div>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="topnav-icons">
                                    <a href="icons-tabler" class="dropdown-item">Tabler</a>
                                    <a href="icons-lucide" class="dropdown-item">Lucide</a>
                                    <a href="icons-flags" class="dropdown-item">Flags</a>
                                </div>
                            </div>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-tables">
                            <a href="tables-static" class="dropdown-item"><i class="ti ti-border-all"></i> Static Tables</a>
                            <a href="tables-custom" class="dropdown-item"><i class="ti ti-stack-forward"></i> Custom Tables</a>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="topnav-datatables">
                                    <a href="tables-datatables-basic" class="dropdown-item">Basic</a>
                                    <a href="tables-datatables-export-data" class="dropdown-item">Export Data</a>
                                    <a href="tables-datatables-select" class="dropdown-item">Select</a>
                                    <a href="tables-datatables-ajax" class="dropdown-item">Ajax</a>
                                    <a href="tables-datatables-javascript" class="dropdown-item">Javascript Source</a>
                                    <a href="tables-datatables-rendering" class="dropdown-item">Data Rendering</a>
                                    <a href="tables-datatables-scroll" class="dropdown-item">Scroll</a>
                                    <a href="tables-datatables-columns" class="dropdown-item">Show & Hide Column</a>
                                    <a href="tables-datatables-child-rows" class="dropdown-item">Child Rows</a>
                                    <a href="tables-datatables-column-searching" class="dropdown-item">Column Searching</a>
                                    <a href="tables-datatables-range-search" class="dropdown-item">Range Search</a>
                                    <a href="tables-datatables-fixed-header" class="dropdown-item">Fixed Header</a>
                                    <a href="tables-datatables-add-rows" class="dropdown-item">Add Rows</a>
                                    <a href="tables-datatables-checkbox-select" class="dropdown-item">Checkbox Select</a>
                                </div>
                            </div>
                        </div>
                    </li>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-layouts">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="topnav-layouts-one">
                                    <a href="layouts-scrollable" class="dropdown-item" target="_blank">Scrollable</a>
                                    <a href="layouts-compact" class="dropdown-item" target="_blank">Compact</a>
                                    <a href="layouts-boxed" class="dropdown-item" target="_blank">Boxed</a>
                                    <a href="layouts-horizontal" class="dropdown-item" target="_blank">Horizontal</a>
                                    <a href="layouts-preloader" class="dropdown-item" target="_blank">Preloader</a>
                                </div>
                            </div>
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="topnav-sidebars">
                                    <a href="sidebar-light" class="dropdown-item" target="_blank">Light Menu</a>
                                    <a href="sidebar-gradient" class="dropdown-item" target="_blank">Gradient Menu</a>
                                    <a href="sidebar-image" class="dropdown-item" target="_blank">Image Menu</a>
                                    <a href="sidebar-compact" class="dropdown-item" target="_blank">Compact Menu</a>
                                    <a href="sidebar-icon-view" class="dropdown-item" target="_blank">Icon View Menu</a>
                                    <a href="sidebar-on-hover" class="dropdown-item" target="_blank">On Hover Menu</a>
                                    <a href="sidebar-on-hover-active" class="dropdown-item" target="_blank">On Hover Active</a>
                                    <a href="sidebar-offcanvas" class="dropdown-item" target="_blank">Offcanvas Menu</a>
                                    <a href="sidebar-no-icons" class="dropdown-item" target="_blank">No Icons with Lines</a>
                                    <a href="sidebar-with-lines" class="dropdown-item" target="_blank">Sidebar with Lines</a>
                            ...
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="topnav-topbars">
                                    <a href="topbar-dark" class="dropdown-item" target="_blank">Dark Topbar</a>
                                    <a href="topbar-gray" class="dropdown-item" target="_blank">Gray Topbar</a>
                                    <a href="topbar-gradient" class="dropdown-item" target="_blank">Gradient Topbar</a>
                                    <a href="topbar-sub-items" class="dropdown-item">Topbar with Sub Items</a>
                                    <a href="topbar-tools" class="dropdown-item">Topbar with Tools</a>
                                </div>
                            </div>
                        </div>
                    </li>
