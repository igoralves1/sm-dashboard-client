...
import { companies } from '@/app/(admin)/(other-apps)/companies/data';
...
const CompanyCard = ({
  ...
  return <Card className="d-flex flex-row p-3">
      <img src={company.logo.src} alt="" className="avatar-xl me-3" />

      <div className="flex-grow-1">
        <div className="d-flex justify-content-between align-items-start">
          <div>
            <h4 className="mb-1 fw-bold">Amazon Inc.</h4>
            <Link href={company.website} className="text-muted text-decoration-none">
              {company.website}
            </Link>
          </div>
...
const Page = () => {
  return <Container fluid>
      ...
      <Row>
        {companies.map((company, idx) => <Col key={idx} xl={4} md={6}>
