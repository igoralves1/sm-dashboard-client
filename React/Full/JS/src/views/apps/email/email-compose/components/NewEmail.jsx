...
import { Button, Card, CardHeader, Collapse, Dropdown, DropdownDivider, DropdownItem, DropdownMenu, DropdownToggle, Offcanvas, OverlayTrigger, Tooltip } from 'react-bootstrap';
          ...
          <div className="bg-light-subtle p-2 border-light border-bottom">
            <div className="d-flex gap-1 align-items-center">
              <Dropdown className="btn-group">
                ...
                <DropdownToggle as="button" variant="primary" type="button" className="btn btn-primary dropdown-toggle dropdown-toggle-split drop-arrow-none" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  <TbChevronDown className="ti ti-chevron-down align-middle" />
                </DropdownToggle>
                <DropdownMenu>
                  <DropdownItem>Send &amp; Archive</DropdownItem>
                  <DropdownItem>Schedule Send</DropdownItem>
