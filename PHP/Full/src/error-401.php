...
<head>
    <?php $title = "401 Error"; include 'partials/title-meta.php' ?>
                                    ...
                                    <div class="card mb-0 border-0 rounded-4">
                                        <div class="card-body">
                                            ...
                                            <div class="p-2 text-center">
                                                ...
                                                <button class="btn btn-primary mt-3 rounded-pill" onclick="window.location.href='index.php'">Back to Safety</button>
                                            </div>
