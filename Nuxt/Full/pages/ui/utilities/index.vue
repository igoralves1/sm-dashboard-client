<template>
    <BContainer fluid>
        <PageBreadcrumb title="Utility" subtitle="UI" />
    </BContainer>

    <BContainer class="container-xl">
        <BRow>
            <BCol cols="12">
                <UICard title="Examples">
                    ...
                    <a class="btn btn-link p-0 fw-semibold"
                        href="https://getbootstrap.com/docs/5.3/utilities/background/" target="_blank">
            ...
            <BCol xl="4">
                <UICard title="Color & Background" isCollapsable>
                    <p class="text-muted">
                    ...
                    <div class="d-flex flex-column gap-2">
                        ...
                        <div class="text-bg-purple p-2">Purple with contrasting color</div>
                    </div>
                </UICard>
            </BCol>

            <BCol xl="4">
                <UICard title="Background Opacity" isCollapsable>
                    <p class="text-muted">
            ...
            <BCol xl="4">
                <UICard title="Text Opacity Color" isCollapsable>
            ...
            <BCol xl="4">
                <UICard title="Border Radius" isCollapsable>
                    <div class="d-flex align-items-start flex-wrap gap-2">
                        <NuxtImg src="/images/users/user-2.jpg" class="avatar-lg rounded" alt="rounded" />
                        <NuxtImg src="/images/users/user-2.jpg" class="avatar-lg rounded-top" alt="rounded-top" />
                        <NuxtImg src="/images/users/user-2.jpg" class="avatar-lg rounded-end" alt="rounded-end" />
                        <NuxtImg src="/images/users/user-2.jpg" class="avatar-lg rounded-bottom" alt="rounded-bottom" />
                        <NuxtImg src="/images/users/user-2.jpg" class="avatar-lg rounded-start" alt="rounded-start" />
                        <NuxtImg src="/images/users/user-2.jpg" class="avatar-lg rounded-circle" alt="rounded-circle" />
                        <NuxtImg src="/images/stock/small-3.jpg" class="rounded-pill" alt="rounded-pill" width="80" />
                    </div>
                </UICard>

                <UICard title="Pointer Events">
                    <p><a href="javascript:void(0);" class="pe-none" tabindex="-1">This link</a> cannot be clicked.
                    </p>
                    <p><a href="javascript:void(0);" class="pe-auto">This link</a> can be clicked.</p>
                </UICard>
            </BCol>

            <BCol xl="4">
                <UICard title="Border Radius Size" isCollapsable>
                    ...
                    <div class="d-flex align-items-start flex-wrap gap-2">
                        <NuxtImg src="/images/users/user-4.jpg" class="avatar-lg rounded-0" alt="rounded-0" />
                        <NuxtImg src="/images/users/user-4.jpg" class="avatar-lg rounded-1" alt="rounded-1" />
                        <NuxtImg src="/images/users/user-4.jpg" class="avatar-lg rounded-2" alt="rounded-2" />
                        <NuxtImg src="/images/users/user-4.jpg" class="avatar-lg rounded-3" alt="rounded-3" />
                        <NuxtImg src="/images/users/user-4.jpg" class="avatar-lg rounded-4" alt="rounded-4" />
                        <NuxtImg src="/images/users/user-4.jpg" class="avatar-lg rounded-5" alt="rounded-5" />
                    </div>
                </UICard>
            </BCol>

            <BCol xl="4">
                <UICard title="Text Selection" isCollapsable>
                    <div card-body>
            ...
            <BCol xl="12">
                <UICard title="Overflow" isCollapsable>
                    <div card-body>
            ...
            <BCol xl="4">
                <UICard title="Position in Arrange" isCollapsable>
                    <div card-body>
            ...
            <BCol xl="4">
                <UICard title="Position in Center" isCollapsable>
                    <div card-body>
            ...
            <BCol xl="4">
                <UICard title="Position in Axis" isCollapsable>
                    <div card-body>
            ...
            <BCol xl="4">
                <UICard title="Shadows" isCollapsable>
                    <div card-body>
            ...
            <BCol xl="4">
                <UICard title="Width" isCollapsable>
                    <div card-body>
            ...
            <BCol xl="6">
                <UICard title="Object Fit" isCollapsable>
                    <div card-body>
                        ...
                        <div class="d-flex align-items-start flex-wrap gap-3 text-center">
                            <div>
                                <NuxtImg src="/images/stock/small-1.jpg"
            ...
            <BCol xl="4">
                <UICard title="Z-index" isCollapsable>
                    <div card-body>
