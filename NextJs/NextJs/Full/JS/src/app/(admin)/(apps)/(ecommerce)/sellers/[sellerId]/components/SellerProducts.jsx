...
import { sellerProducts } from '@/app/(admin)/(apps)/(ecommerce)/sellers/[sellerId]/data';
...
const SellerProducts = () => {
  const columns = [{
    ...
    cell: ({
      row
    }) => <h5 className="fs-base mb-0 fw-medium">{row.original.stock}</h5>
  ...
  const [data, setData] = useState(() => [...sellerProducts]);
