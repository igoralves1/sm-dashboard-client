    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                <?php echo view("./partials/page-title", array("subtitle" => "UI", "title" => "Breadcrumb")) ?>
            </div>
            <!-- container -->
                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="code-body" id="simple-breadcrumb-code">
                                <pre>
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="code-body" id="icon-breadcrumb-code">
                                <pre>
                                    <code class="language-markup">
                                        &lt;nav aria-label=&quot;breadcrumb&quot;&gt;
