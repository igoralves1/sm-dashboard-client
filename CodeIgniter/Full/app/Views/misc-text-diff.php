...
<head>
    <?php echo view("partials/title-meta", array("title" => "Text Diff")) ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "Miscellaneous", "title" => "Text Diff")) ?>
    ...
    <!-- Diff Plugin Js-->
    <script src="/plugins/diff/diff.min.js"></script>

    <!-- Text Diff Page Js-->
    <script src="/js/pages/misc-text-diff.js"></script>
</body>
