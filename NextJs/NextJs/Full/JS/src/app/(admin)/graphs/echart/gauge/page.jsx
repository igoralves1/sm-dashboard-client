      ...
      <Row>
        <Col xl={6}>
          <ComponentCard title="Gauge Chart">
            <CardBody>
              <EChartClient extensions={[GaugeChart, CanvasRenderer]} getOptions={getGaugeChart} style={{
              height: '260px'
            }} />
            </CardBody>
          </ComponentCard>
        ...
        <Col xl={6}>
          <ComponentCard title="Speed Stage Gauge Chart">
            <EChartClient extensions={[GaugeChart, CanvasRenderer]} getOptions={getSpeedStageGaugeChart} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
        <Col xl={6}>
          <ComponentCard title="Ring Gauge Chart">
            <EChartClient extensions={[GaugeChart, CanvasRenderer]} getOptions={getRingGaugeChart} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
        ...
        <Col xl={6}>
          <ComponentCard title="Multi Ring Gauge Chart">
            <EChartClient extensions={[GaugeChart, CanvasRenderer]} getOptions={getMultiRingGaugeChart} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
