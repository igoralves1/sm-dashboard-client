...
const renderTrack = ({
  ...
  width: '100%'
    ...
    background: getTrackBackground({
      values,
      colors: values.length == 1 ? [getColor('primary'), '#252630'] : values.length == 2 ? ['#252630', getColor('primary'), '#252630'] : ['#000', getColor('primary'), getColor('secondary'), '#252630'],
      min: MIN,
      max: MAX,
      direction
    }),
          ...
          <CardBody className="p-0">
            ...
            <div className="p-3 border-bottom border-dashed">
              ...
              <Nav className="flex-column">
                {categories.map(category => <NavItem key={category.id} className="d-flex justify-content-between align-items-center py-1">
            ...
            <div className="p-3 border-bottom border-dashed">
              ...
              {brands.map(brand => <NavItem key={brand.id} className="d-flex justify-content-between align-items-center py-1">
            ...
            <div className="p-3">
              ...
              {ratings.map((rating, idx) => <div className="form-check py-1" key={idx}>
