                    ...
                    <BCardHeader class="border-light justify-content-between">
                        ...
                        <div class="d-flex align-items-center gap-1">
                            ...
                            <div class="app-search">
                                ...
                                <Icon name="lucide:circle" class="app-search-icon text-muted" />
                            </div>

                            <NuxtLink to="" class="btn btn-primary ms-1">
                                <Icon name="lucide:plus" class="fs-sm me-2" /> Add Category
                            </NuxtLink>
                        </div>
                    </BCardHeader>
                    ...
                    <BTable show-empty :filter="searchQuery" empty-text="Nothing found."
                        ...
                        <template #cell(name)="{ item }">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h5 class="mb-0">
                                        <NuxtLink to="/product-details/1" class="link-reset">{{ item.name }}</NuxtLink>
                                    </h5>
                                </div>
                            </div>
                        </template>
