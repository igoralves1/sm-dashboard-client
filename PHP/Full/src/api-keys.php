    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Apps"; $title = "Companies"; include 'partials/page-title.php' ?> {"subtitle": "Apps", "title":"API Keys"})
                                ...
                                <table class="table table-custom table-centered table-hover w-100 mb-0">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Apr 10, 2025</td>
                                            <td>Oct 10, 2025</td>
                                            <td><span class="badge p-1 text-bg-light fs-sm"><img src="assets/images/flags/us.svg" alt="" class="rounded-circle me-1" height="12"> US</span></td>
                                            <td>
                                                <div class="d-flex align-items-center justify-content-center gap-1">
                                                    <a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-eye fs-lg"></i></a>
                                                    <a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-edit fs-lg"></i></a>
                                        ...
                                        <tr>
                                            ...
                                            <td>Apr 01, 2025</td>
                                            <td>Jan 01, 2026</td>
                                            <td><span class="badge p-1 text-bg-light fs-sm"><img src="assets/images/flags/ca.svg" alt="" class="rounded-circle me-1" height="12"> CA</span></td>
                                            <td>
                                                <div class="d-flex align-items-center justify-content-center gap-1">
                                                    <a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-eye fs-lg"></i></a>
                                                    <a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-edit fs-lg"></i></a>
                                        ...
                                        <tr>
                                            ...
                                            <td>Jul 15, 2024</td>
                                            <td>Jan 15, 2025</td>
                                            <td><span class="badge p-1 text-bg-light fs-sm"><img src="assets/images/flags/fr.svg" alt="" class="rounded-circle me-1" height="12"> FR</span></td>
                                            <td>
                                                <div class="d-flex align-items-center justify-content-center gap-1">
                                                    <a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-eye fs-lg"></i></a>
                                                    <a href="#" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-edit fs-lg"></i></a>
