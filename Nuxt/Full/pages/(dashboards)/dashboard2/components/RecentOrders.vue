        ...
        <div class="d-flex align-items-center">
          ...
          <div>
            <h5 class="fs-base my-1">
              <NuxtLink :to="data.item.url" class="text-body">#{{ data.item.id }}</NuxtLink>
            </h5>
      ...
      <div class="align-items-center justify-content-between row text-center text-sm-start">
        <BCol class="col-sm">
           <span class="text-muted">Showing <span class="fw-semibold">{{ start }}</span> to <span
               class="fw-semibold">{{ end }}</span> of <span class="fw-semibold">{{ totalItems }}</span> orders</span>
        </BCol>
...
import type {OrderType} from "~/pages/(dashboards)/dashboard2/components/types";
import {orders as orderData} from "~/pages/(dashboards)/dashboard2/components/data";
