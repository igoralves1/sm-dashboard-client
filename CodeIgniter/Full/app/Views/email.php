...
<head>
    <?php echo view("partials/title-meta", array("title" => "Inbox (77)")) ?>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover table-select mb-0">
                                ...
                                <tr class="position-relative">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="/images/users/user-5.jpg" alt="user avatar"
                                    ...
                                    <td>
                                        <a href="email-details" class="link-reset fs-base fw-medium stretched-link">
                                ...
                                <tr class="position-relative">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="/images/users/user-2.jpg" alt="user avatar"
                                                 class="avatar-xs rounded-circle">
                                ...
                                <tr class="position-relative mark-as-read">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="/images/users/user-6.jpg" alt="user avatar"
                                                 class="avatar-xs rounded-circle">
                                ...
                                <tr class="position-relative mark-as-read">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="/images/users/user-7.jpg" alt="user avatar"
                                                 class="avatar-xs rounded-circle">
                                ...
                                <tr class="position-relative">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="/images/users/user-8.jpg" alt="user avatar"
                                                 class="avatar-xs rounded-circle">
                                ...
                                <tr class="position-relative mark-as-read">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="/images/users/user-10.jpg" alt="user avatar"
                                                 class="avatar-xs rounded-circle">
                                ...
                                <tr class="position-relative mark-as-read">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="/images/users/user-3.jpg" alt="user avatar"
                                                 class="avatar-xs rounded-circle">
                                ...
                                <tr class="position-relative mark-as-read">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="/images/users/user-9.jpg" alt="user avatar"
                                                 class="avatar-xs rounded-circle">
                                ...
                                <tr class="position-relative mark-as-read">
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <img src="/images/users/user-1.jpg" alt="user avatar"
                                                 class="avatar-xs rounded-circle">
