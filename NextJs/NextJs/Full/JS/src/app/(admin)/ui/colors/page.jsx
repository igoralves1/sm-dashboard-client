...
const ColorCard = ({
  ...
  return <Col md={4} xl={2}>
      <Card>
        <CardBody>
          <div className={`${className} rounded`} style={{
          height: 100
        }}></div>
...
const BackgroundColors = () => {
  return <ComponentCard title="Background Colors">
      <div className="table-responsive ">
        <Table className="table-bordered table-striped align-middle mb-0">
          ...
          <tbody>
            {colors.map((item, index) => <tr key={index}>
                <th>{item.label}</th>
                <td style={{
              width: 180
            }}>
...
const TextColorsAndLinkColors = () => {
  return <ComponentCard title="Text Colors & Link Colors">
      <div className=" table-responsive">
...
const AdditiveBorder = () => {
  return <ComponentCard title="Additive(Add) Border">
...
const SubtractiveBorder = () => {
  return <ComponentCard title="Subtractive(Remove) Border">
      <p className="text-muted">
...
const BorderColor = () => {
  return <ComponentCard title="Border Color">
...
const BorderWidthSize = () => {
  return <ComponentCard title="Border Width Size">
      <div className="d-flex align-items-start flex-wrap gap-2 ">
        <div className="text-center">
...
const BorderSubtleColor = () => {
  return <ComponentCard title="Border Subtle Color">
      <p className="text-muted">Change the border color using utilities built on our theme colors.</p>
      <div className="d-flex align-items-start flex-wrap gap-2">
        <div className="text-center">
...
const BorderOpacity = () => {
  return <ComponentCard title="Border Opacity">
      <p className="text-muted">
      ...
      <Container fluid>
        ...
        <Card>
          ...
          <CardBody>
            ...
            <Link className="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/utilities/colors/" target="_blank">
              Colors on Bootstrap
        ...
        <Row>
          {colors.map((color, index) => <ColorCard key={index} label={color.label} className={color.className} />)}
        </Row>
        <Row>
          <Col xs={12}>
            <BackgroundColors />
