...
const DefaultAccordions = () => {
  return <ComponentCard title="Default Accordions">
...
const FlushAccordions = () => {
  return <ComponentCard title="Flush Accordions">
...
const AlwaysOpenAccordions = () => {
  return <ComponentCard title="Always Open Accordions">
...
const WithoutArrowAccordion = () => {
  return <ComponentCard title="Accordion Without Arrow">
...
const BorderedAccordions = () => {
  return <ComponentCard title="Bordered Accordions">
...
const CustomIconAccordion = () => {
  return <ComponentCard title="Custom Icon Accordion">
            ...
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0 fw-semibold" href="https://react-bootstrap.netlify.app/docs/components/accordion/" target="_blank">
