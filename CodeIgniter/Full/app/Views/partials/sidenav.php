        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarDashboards">
                    <ul class="sub-menu">
                        ...
                        <li class="side-nav-item">
                            <a href="dashboard-2" class="side-nav-link">
                                <span class="menu-text" data-lang="dashboard-two">Dashboard v.2</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="dashboard-3" class="side-nav-link">
                    ...
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarProducts">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="ecommerce-products" class="side-nav-link">
                                            <span class="menu-text" data-lang="eco-pro-list">Products</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="ecommerce-products-grid" class="side-nav-link">
                                            <span class="menu-text" data-lang="eco-pro-grid">Products Grid</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="ecommerce-product-details" class="side-nav-link">
                                            <span class="menu-text" data-lang="eco-pro-details">Product Details</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="ecommerce-add-product" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="ecommerce-categories" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarOrders">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="ecommerce-orders" class="side-nav-link">
                                            <span class="menu-text" data-lang="eco-orders-list">Orders</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="ecommerce-order-details" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="ecommerce-customers" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarSellers">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="ecommerce-sellers" class="side-nav-link">
                                            <span class="menu-text" data-lang="eco-sellers-list">Sellers</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="ecommerce-seller-details" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            <a href="ecommerce-reviews" class="side-nav-link">
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarReports">
                                <ul class="sub-menu">
                                    <li class="side-nav-item">
                                        <a href="ecommerce-product-views" class="side-nav-link">
                                            <span class="menu-text" data-lang="eco-pro-views">Product Views</span>
                                        </a>
                                    </li>
                                    <li class="side-nav-item">
                                        <a href="ecommerce-sales" class="side-nav-link">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarEmail">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a href="email" class="side-nav-link">
                                <span class="menu-text" data-lang="email-inbox">Inbox</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="email-details" class="side-nav-link">
                                <span class="menu-text" data-lang="email-details">Details</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="email-compose" class="side-nav-link">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarUsers">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a href="contacts" class="side-nav-link">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarInvoice">
                    <ul class="sub-menu">
                        ...
                        <li class="side-nav-item">
                            <a href="invoice-details" class="side-nav-link">
                                <span class="menu-text" data-lang="invoice-details">Single Invoice</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="invoice-create" class="side-nav-link">
            ...
            <li class="side-nav-item">
                <a href="metrics" class="side-nav-link">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarCharts">
                    <ul class="sub-menu">
                        ...
                        <li class="side-nav-item">
                            <a href="charts-apextree" class="side-nav-link">
                                <span class="menu-text" data-lang="charts-apextree">Apex Tree</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="charts-apexsankey" class="side-nav-link">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarTables">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a href="tables-static" class="side-nav-link">
                                <span class="menu-text" data-lang="tables-static">Static Tables</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="tables-custom" class="side-nav-link">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarIcons">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a href="icons-tabler" class="side-nav-link">
                                <span class="menu-text" data-lang="icons-tabler">Tabler</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="icons-lucide" class="side-nav-link">
                                <span class="menu-text" data-lang="icons-lucide">Lucide</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="icons-flags" class="side-nav-link">
