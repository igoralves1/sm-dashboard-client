...
import { TbAlertTriangle, TbBell, TbBrandStripe, TbChevronRight, TbCreditCard, TbHandStop, TbMessageCircle, TbMicrophone, TbPlane, TbRocket, TbSettings, TbShare, TbStar, TbTools, TbTrash, TbUser } from 'react-icons/tb';
const DefaultButtons = () => {
  return <ComponentCard title="Default Buttons">
...
const ButtonRounded = () => {
  return <ComponentCard title="Button Rounded">
      <p className="text-muted">
...
const ButtonOutline = () => {
  return <ComponentCard title="Button Outline">
      <p className="text-muted">
...
const ButtonOutlineRounded = () => {
  return <ComponentCard title="Button Outline Rounded">
      <p className="text-muted">
...
const SoftButtons = () => {
  return <ComponentCard title="Soft Buttons">
      <p className="text-muted">
...
const SoftRoundedButtons = () => {
  return <ComponentCard title="Soft Rounded Buttons">
      <p className="text-muted">
...
const GhostButtons = () => {
  return <ComponentCard title="Ghost Buttons">
      <p className="text-muted">
...
const GhostRoundedButtons = () => {
  return <ComponentCard title="Ghost Rounded Buttons">
      <p className="text-muted">
...
const ButtonSizes = () => {
  return <ComponentCard title="Button Sizes">
      <p className="text-muted">
...
const DisabledSizes = () => {
  return <ComponentCard title="Disabled Sizes">
      <p className="text-muted">
...
const BlockButton = () => {
  return <ComponentCard title="Block Button">
...
const ToggleButton = () => {
  return <ComponentCard title="Toggle Button">
      <p className="text-muted">
...
const ButtonTags = () => {
  return <ComponentCard title="Button Tags">
      <p className="text-muted">
...
const FocusRingUtilities = () => {
  return <ComponentCard title="Focus Ring Utilities">
      <p className="text-muted">
...
const IconButtons = () => {
  return <ComponentCard title="Icon Buttons">
      <p className="text-muted">
...
const ButtonGroup = () => {
  return <ComponentCard title="Button Group">
      <p className="text-muted">
            ...
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0 fw-semibold" href="https://react-bootstrap.netlify.app/docs/components/buttons" target="_blank">
