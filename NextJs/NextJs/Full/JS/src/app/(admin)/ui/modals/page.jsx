...
import { Button, Card, CardBody, CardHeader, CardTitle, Col, Container, Form, FormControl, FormLabel, Modal, ModalBody, ModalFooter, ModalHeader, ModalTitle, Row } from 'react-bootstrap';
...
const BootstrapModals = () => {
  ...
  return <ComponentCard title="Bootstrap Modals">
...
const ModalPositions = () => {
  ...
  return <ComponentCard title="Modal Position">
...
const MultipleModal = () => {
  ...
  return <ComponentCard title="Multiple Modal">
...
const ToggleBetweenModals = () => {
  ...
  return <ComponentCard title="Toggle Between Modals">
      <p className="text-muted">
...
const FullscreenModal = () => {
  ...
  return <ComponentCard title="Fullscreen Modal">
      <p className="text-muted">
...
const StaticBackdropModal = () => {
  ...
  return <ComponentCard title="Static Backdrop">
      <p className="text-muted">
...
const VaryingModalContent = () => {
  ...
  return <ComponentCard title="Varying Modal Content">
      <p className="text-muted">
            ...
            <Col lg={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0" href="https://react-bootstrap.netlify.app/docs/components/modal" target="_blank">
