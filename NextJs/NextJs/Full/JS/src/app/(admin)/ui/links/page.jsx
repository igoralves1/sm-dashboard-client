...
const ColoredLinks = () => {
  return <ComponentCard title="Colored links">
...
const LinkUtilities = () => {
  return <ComponentCard title="Link utilities">
      <p className="text-muted">
...
const LinkOpacity = () => {
  return <ComponentCard title="Link opacity">
      <p className="text-muted">
...
const LinkHoverOpacity = () => {
  return <ComponentCard title="Link hover opacity">
...
const UnderlineColor = () => {
  return <ComponentCard title="Underline color">
...
const UnderlineOpacity = () => {
  return <ComponentCard title="Underline opacity">
      <p className="text-muted">
...
const UnderlineOffset = () => {
  return <ComponentCard title="Underline offset">
      <p className="text-muted">
        Change the underline’s opacity. Requires adding
        <code>.link-underline</code> to first set an <code>rgba()</code> color we use to then modify the alpha opacity.
      </p>
...
const HoverVariants = () => {
  return <ComponentCard title="Hover variants">
      <p className="text-muted">
            ...
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/helpers/colored-links/" target="_blank">
                    Links on Bootstrap
