...
<head>
    <?php echo view("partials/title-meta", array("title" => "Basic Datatables")) ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "Tables", "title" => "Basic")) ?>
                    ...
                    <div class="col-xxl-10">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <a href="https://datatables.net/examples/basic_init/zero_configuration.html" target="_blank" class="icon-link icon-link-hover link-primary fw-semibold">View Docs <i class="ti ti-arrow-right bi align-middle fs-lg"></i></a>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <a href="https://datatables.net/examples/advanced_init/complex_header.html" target="_blank" class="icon-link icon-link-hover link-primary fw-semibold">View Docs <i class="ti ti-arrow-right bi align-middle fs-lg"></i></a>
                            </div>
