        ...
        <BRow class="justify-content-center">
            <BCol xxl="10">
                <BRow class="g-0">
                    ...
                    <BCol xl="9">
                        <BCard no-body class="card-h-100 rounded-0 rounded-start">
                            <BCardHeader class="align-items-start p-4">
                                <div class="avatar-xxl me-3">
                                    <span class="avatar-title text-bg-light rounded">
                                        <NuxtImg src="/images/logos/starbucks.svg" height="48" alt="Brand-img" />
                                    </span>
                                </div>
                                <div>
                                    <h3 class="mb-1 d-flex fs-xl align-items-center">Starbucks - AI Analytics Dashboard
                                    </h3>
                                ...
                                <div class="ms-auto">
                                    <a href="javascript: void(0);" class="btn btn-light"><Icon name="tabler:pencil" class="me-1"/> Edit</a>
                                </div>
                            </BCardHeader>
                            <BCardBody class="px-4">
                                <div class="mb-4">
                                    <h5 class="fs-base mb-2">Project Description:</h5>
                                    <p class="text-muted">This dashboard provides AI-powered insights and analytics for
                                        Starbucks business data. It includes sales performance, customer behavior, and
                                        predictive trends to assist in data-driven decision-making.</p>
                                    <p class="text-muted">
                                        Customizable reports and role-based dashboards ensure relevant insights for
                                        marketing teams, financial analysts, and executive decision-makers. The system
                                        is built with scalability and responsiveness in mind, supporting both desktop
