<template>
    <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="flex-grow-1 d-inline-flex align-items-center justify-content-end fs-lg">
            <Icon name="tabler:star-filled" class="text-warning"/>
            <Icon name="tabler:star-filled" class="text-warning"/>
            <Icon name="tabler:star-filled" class="text-warning"/>
            <Icon name="tabler:star-filled" class="text-warning"/>
            <Icon name="tabler:star-filled" class="text-warning"/>
            <span class="ms-1 fs-base"><NuxtLink to="/reviews" class="link-reset fw-medium">(859 Reviews)</NuxtLink>
            </span>
        </div>
    </div>
    <div class="mt-3 mb-5">
    ...
    <NuxtLink to="" class="link-primary fw-semibold">Read More...</NuxtLink>
