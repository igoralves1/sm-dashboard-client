...
import { forumPosts } from '@/app/(admin)/(other-apps)/forum-view/data';
        ...
        <div className="d-flex gap-4 align-items-center">
          <div className="flex-grow-1">
            ...
            <h4 className="fs-lg mb-2">
              <Link href={item.url} className="link-reset">
                {item.title}
              </Link>
            </h4>
      ...
      <CardFooter>
        <p className="d-flex flex-wrap gap-3 text-muted mb-0 align-items-center justify-content-between fs-sm">
          <span className="d-flex align-items-center gap-2">
            <Image src={item.image.src} height={32} width={32} alt="" className="img-fluid avatar-sm rounded" />
            <span>
        ...
        <Col xxl={10}>
          <Row>
            <Col xl={9}>
              ...
              {forumPosts.map((item, idx) => <ForumCard key={item.id} item={item} className={idx !== forumPosts.length - 1 ? 'mb-1' : ''} />)}
