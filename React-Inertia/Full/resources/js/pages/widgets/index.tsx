...
import Widget1 from '@/pages/widgets/components/Widget1'
import SalesPerformanceOverview from '@/pages/widgets/components/SalesPerformanceOverview'
import TrafficSources from '@/pages/widgets/components/TrafficSources'
import TopCountries from '@/pages/widgets/components/TopCountries'
import ProfileCard from '@/pages/widgets/components/ProfileCard'
import CommentCard from '@/pages/widgets/components/CommentCard'
import ChatCard from '@/pages/widgets/components/ChatCard'
import FileManageCard from '@/pages/widgets/components/FileMangeCard'
import Widget3 from '@/pages/widgets/components/Widget3'
import Widget6 from '@/pages/widgets/components/Widget6'
import Widget7 from '@/pages/widgets/components/Widget7'
import Widget5 from '@/pages/widgets/components/Widget5'
import Widget4 from '@/pages/widgets/components/Widget4'
import TodaySchedule from '@/pages/widgets/components/TodaySchedule'
import { widget1Data, widget3Data, widget4Data, widget5Data, widget6Data, widget7Data } from '@/pages/widgets/data'
