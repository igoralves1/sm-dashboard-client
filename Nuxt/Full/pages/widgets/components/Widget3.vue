<template>
    <BCard no-body>
        <BCardBody>
            <NuxtLink to="#" class="text-muted float-end mt-n1 fs-xl">
            ...
            <div class="d-flex align-items-center gap-2 my-3">
                <div class="avatar-md flex-shrink-0">
                    <span
                        ...
                        <Icon v-if="item.icon" :name="item.icon" class="d-flex align-items-center" />
                    </span>
                </div>
            ...
            <p class="d-flex align-items-center gap-1 mb-0">
                <Icon name="tabler:point-filled" :class="`text-${item.variant}`" />
