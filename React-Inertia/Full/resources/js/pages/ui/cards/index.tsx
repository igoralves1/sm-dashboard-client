...
import small6 from '@/images/stock/small-6.jpg'
...
const CardWithBackgroundGradient = () => {
  return (
    <Card className="text-bg-purple bg-gradient">
      <CardBody>
        <CardTitle as={'h5'} className="mb-2">
      ...
      <Container fluid>
        ...
        <Card>
          ...
          <CardBody>
            ...
            <Link className="btn btn-link p-0 fw-semibold" href="https://react-bootstrap.netlify.app/docs/components/cards" target="_blank">
