<template>
  <div class="topbar-item">
    ...
    <BDropdown placement="bottom-end" :variant="null" no-caret toggle-class="topbar-link py-0 px-1"
               menu-class="dropdown-menu-lg p-0" offset="22">

      <template #button-content>
        <client-only>
          <Icon name="lucide:bell" class="fs-xxl"/>
        </client-only>
            ...
            <span class="d-flex gap-2">
              <span class="avatar-md flex-shrink-0">
                <span
                  ...
                  <client-only>
                    <Icon :name="notification.icon" :class="`fs-xl fill-${notification.variant}`"/>
                  </client-only>
                </span>
              </span>
