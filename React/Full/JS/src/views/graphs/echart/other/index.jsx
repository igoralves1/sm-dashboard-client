      ...
      <Row>
        <Col xl={6}>
          <ComponentCard title="Pictorialbar Dotted Chart">
            <CustomEChart extensions={[PictorialBarChart, CanvasRenderer]} getOptions={getPictorialbarDottedChart} style={{
            height: '400px'
          }} />
          </ComponentCard>
        </Col>
        <Col xl={6}>
          <ComponentCard title="Basic Sunburst Chart">
            <CustomEChart extensions={[SunburstChart, CanvasRenderer]} getOptions={getBasicSunburstChart} style={{
            height: '400px'
          }} />
          </ComponentCard>
        </Col>
        <Col xl={12}>
          <ComponentCard title="Nested Pie Chart">
            <CustomEChart extensions={[SunburstChart, CanvasRenderer]} getOptions={getNestedPieChart} style={{
            height: '600px'
          }} />
          </ComponentCard>
        </Col>
