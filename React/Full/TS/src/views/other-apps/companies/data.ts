...
import { TbBuildingStore, TbCoffee, TbDeviceMobile, TbGasStation, TbHome, TbMusic, TbNetwork, TbShoppingCart, TbWorld } from 'react-icons/tb'
...
export const companies: CompanyProfileType[] = [
  {
    ...
    location: 'Seattle, WA',
    category: { label: 'eCommerce', icon: TbShoppingCart },
  ...
  },
  {
    ...
    category: { label: 'Tech', icon: TbDeviceMobile },
  ...
  },
  {
    ...
    category: { label: 'Retail', icon: TbBuildingStore },
  ...
  },
  {
    ...
    location: 'Seattle, WA',
    category: { label: 'Food & Beverage', icon: TbCoffee },
  ...
  },
  {
    ...
    category: { label: 'Tech', icon: TbNetwork },
  ...
  },
  {
    ...
    category: { label: 'Entertainment', icon: TbMusic },
  ...
  },
  {
    ...
    category: { label: 'Tech', icon: TbWorld },
  ...
  },
  {
    ...
    category: { label: 'Hospitality', icon: TbHome },
  ...
  },
  {
    ...
    location: 'London, UK',
    category: { label: 'Energy', icon: TbGasStation },
