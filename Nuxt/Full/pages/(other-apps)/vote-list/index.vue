        ...
        <BCard no-body>
          <BCardHeader class="border-light justify-content-between d-flex flex-wrap gap-2">
            <div class="app-search">
              ...
              <Icon name="lucide:search" class="app-search-icon text-muted" size="18"/>
            </div>
            ...
            <div class="d-flex align-items-center gap-2 flex-wrap">
              ...
              <div class="app-search">
                ...
                <Icon name="lucide:list-filter" size="18" class="app-search-icon text-muted" />
              </div>
