...
import { Button, Card, CardBody, CardHeader, CardTitle, Col, Container, ProgressBar, Row } from 'react-bootstrap';
import { TbChevronRight } from 'react-icons/tb';
const Example = () => {
  return <ComponentCard title="Examples">
...
const MultipleBars = () => {
  return <ComponentCard title="Multiple bars">
...
const AnimatedStripes = () => {
  return <ComponentCard title="Animated stripes">
      <p className="text-muted">
...
const LabelsBar = () => {
  return <ComponentCard title="Labels">
      <p className="text-muted">
...
const BackgroundBar = () => {
  return <ComponentCard title="Backgrounds">
...
const StripedBar = () => {
  return <ComponentCard title="Striped">
      <p className="text-muted">
...
const StepsProgressBar = () => {
  return <ComponentCard title="Steps">
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted mb-2">
                    Documentation and examples for using Bootstrap custom progress bars featuring support for stacked bars, animated backgrounds, and
                    text labels.
                  </p>
                  <Link className="btn btn-link p-0 fw-semibold" href="https://react-bootstrap.netlify.app/docs/components/progress" target="_blank">
                    Progress on React Bootstrap
