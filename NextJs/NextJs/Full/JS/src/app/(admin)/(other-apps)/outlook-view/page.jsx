...
import SideBar from '@/app/(admin)/(other-apps)/outlook-view/components/SideBar';
import { messages } from '@/app/(admin)/(other-apps)/outlook-view/data';
...
const Page = () => {
  const [message, setMessages] = useState(messages[0]);
  ...
  return <Container fluid>
      ...
      <div className="outlook-box outlook-box-full">
        ...
        <SimplebarClient className="card h-100 mb-0 rounded-0 border-0 flex-grow-1" data-simplebar-md>
