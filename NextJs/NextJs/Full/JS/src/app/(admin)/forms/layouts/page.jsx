...
import { Button, Col, Container, FloatingLabel, Form, FormCheck, FormControl, FormGroup, FormLabel, FormSelect, FormText, InputGroup, Modal, ModalBody, Row } from 'react-bootstrap';
import InputGroupText from 'react-bootstrap/InputGroupText';
import { TbUserShield } from 'react-icons/tb';
const BasicForm = () => {
  return <ComponentCard title="Basic Form">
...
const ModalForm = () => {
  ...
  return <ComponentCard title="Modal Form">
...
const HorizontalForm = () => {
  return <ComponentCard title="Horizontal Form">
...
const HorizontalFormLabelSize = () => {
  return <ComponentCard title="Horizontal Form Label Sizing">
      <Form>
        <Row className="mb-2">
...
const InlineForm = () => {
  return <ComponentCard title="Inline Form">
      <div>
        <Form>
...
const FormRow = () => {
  return <ComponentCard title="Form Row">
      <Form>
        <Row className="g-2">
        ...
        <Row className="g-3">
          ...
          <Col lg={6}>
            <FloatingLabel label="Short Bio">
              <FormControl as="textarea" placeholder="Tell us about yourself" style={{
              height: '100px'
            }} />
            </FloatingLabel>
          </Col>
