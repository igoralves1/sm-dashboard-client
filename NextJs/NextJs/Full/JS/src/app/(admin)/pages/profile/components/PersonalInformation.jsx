...
const personalInfo = [{
  ...
  info: <>
        Email
        <Link href="mailto:hello@example.com" className="text-primary fw-semibold">
          hello@example.com
        </Link>
      </>
}, {
  ...
  info: <>
        Website
        <Link href="https://www.example.dev" className="text-primary fw-semibold">
          www.example.dev
        </Link>
      </>
}, {
...
const PersonalInformation = () => {
  return <ComponentCard title="Personal Information">
      <div className="">
        {personalInfo.map((item, idx) => <div className={`d-flex align-items-center gap-2 ${idx != personalInfo.length - 1 ? 'mb-2' : ''}`} key={idx}>
