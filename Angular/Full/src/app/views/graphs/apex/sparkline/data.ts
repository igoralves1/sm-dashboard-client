...
export interface SparkChartItem {
    total?: string;
    percent?: string;
    last10Options: () => ApexOptions;
    volumeOptions: () => ApexOptions;
}

export const spark1Options: () => ApexOptions = () => ({
    chart: {
        type: 'area',
        height: 160,
        sparkline: {
...
export const spark2Options: () => ApexOptions = () => ({
    chart: {
        type: 'area',
        height: 160,
        sparkline: {
...
export const spark3Options: () => ApexOptions = () => ({
    chart: {
        type: 'area',
        height: 160,
        sparkline: {
...
export const tableChartData: SparkChartItem[] = [
    {
        total: "$32,554",
        percent: '15%',
        last10Options: () => ({
