'use client'
import { StatisticsWithChartType } from '@/app/(admin)/metrics/types'
        ...
        <div className="d-flex justify-content-between align-items-center">
          <div className="text-start">
            <h3 className="mb-1 fw-normal">
              <CountUpClient end={count.value} prefix={count.prefix} suffix={count.suffix} start={0} duration={1} />
            </h3>
          ...
          {chartOptions() && (
            <EChartClient extensions={getExtensions(ChartType)} getOptions={chartOptions} style={{ height: chartHeight, width: chartWidth }} />
          )}
        </div>
      </CardBody>
    </Card>
