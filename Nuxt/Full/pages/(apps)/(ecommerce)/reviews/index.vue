                                ...
                                <BRow class="align-items-center g-0">
                                    <BCol xl="7">
                                        <div class="d-flex align-items-center gap-4 p-4">
                                            <NuxtImg src="/images/ratings.svg" alt="Product" height="80" />
                                            <div>
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <BDropdown toggle-class="btn btn-default drop-arrow-none"
                                ...
                                <template #button-content>
                                    <Icon name="lucide:download" class="me-1" /> Export
                    ...
                    <BTable show-empty :filter="searchQuery" empty-text="Nothing found."
                        ...
                        <template #cell(name)="{ item }">
                            <div class="d-flex align-items-center">
                                ...
                                <div>
                                    <h5 class="mb-0">
                                        <NuxtLink to="/products/1" class="link-reset">{{ item.productName }}</NuxtLink>
                                    </h5>
                                </div>
                            </div>
                        </template>
                        <template #cell(reviewer)="{ item }">
                            <div class="d-flex justify-content-start align-items-center gap-2">
                                <div class="avatar avatar-sm">
                                    <NuxtImg :src="item.avatar" alt="avatar-8" class="img-fluid rounded-circle" />
                                </div>
                                <div>
                                    <h5 data-sort="reviewer" class="text-nowrap fs-sm mb-0 lh-base">{{ item.name }}</h5>
