...
Route::middleware(['auth'])->group(function () {
   ...
   Route::prefix('graphs')->group(function () {
    ...
    Route::prefix('tables')->group(function () {
        ...
        Route::prefix('tanstack')->group(function () {
            Route::get('/table-with-checkbox', [TablesController::class, 'tanstackCheckbox']);
            Route::get('/table-with-delete-button', [TablesController::class, 'tanstackWithDeleteButton']);
            Route::get('/table-with-filters', [TablesController::class, 'tanstackWithFilters']);
            Route::get('/table-with-pagination', [TablesController::class, 'tanstackWithPagination']);
            Route::get('/table-with-search', [TablesController::class, 'tanstackWithSearch']);
            Route::get('/table-with-sort', [TablesController::class, 'tanstackWithSort']);
        });
