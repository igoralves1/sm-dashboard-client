<template>
  <section class="section-custom bg-light bg-opacity-30 border-top border-light border-bottom" id="features">
    <BContainer>
      <BRow class="align-items-center pb-5">
        <BCol lg="6" xl="5" class="py-3">
          <div class="position-relative">
            <figure class="position-absolute top-0 start-0 translate-middle mt-5 opacity-25">
              <svg width="111" height="170" viewBox="0 0 111 170" fill="#1ab394"
            ...
            <img src="/images/chat.png" alt="Chat App"
                 class="rounded-3 shadow-lg img-fluid mt-5 z-1 position-relative"/>
        ...
        <BCol lg="5" class="ms-auto py-3">
          <h2 class="mb-4 lh-base">Connecting conversations across the world</h2>
          <p class="mb-2 lead">Fast, secure, and intuitive—our chat platform empowers teams and communities to
            communicate effortlessly.</p>
          <p class="text-muted fs-sm mb-4">Experience seamless messaging with built-in privacy features and unmatched
            reliability.</p>
          <BButton variant="primary" class="mb-4">Check Chat App</BButton>

          <div class="d-flex flex-wrap justify-content-between gap-4 mt-4">
            <div v-for="(stat, index) in stats1" :key="index">
              <h3 class="mb-2">
                <client-only>
                  <CountUp :endVal="stat.value" :options="{duration: 2, decimalPlaces: 1,suffix:stat.suffix, enableScrollSpy: true,
                scrollSpyOnce: true,}"/>
                </client-only>
              </h3>
      ...
      <BRow class="align-items-center py-5">
        <BCol lg="5" class="py-5 order-2 order-lg-1">
          <h2 class="mb-4 lh-base">Manage your files seamlessly from anywhere</h2>
          <p class="mb-2 lead">A powerful, secure, and intuitive file manager built for individuals and teams.</p>
          <p class="text-muted fs-sm mb-4">Access files instantly and enjoy peace of mind with encrypted storage.</p>
          <BButton variant="primary" class="mb-4">Explore File Manager</BButton>

          <div class="d-flex flex-wrap justify-content-between gap-4 mt-4">
            <div v-for="(stat, index) in stats2" :key="index">
              <h3 class="mb-2">
                <client-only>
                  <CountUp :endVal="stat.value" :options="{duration: 2, decimalPlaces: 1,suffix:stat.suffix, enableScrollSpy: true,
                scrollSpyOnce: true}"/>
        ...
        <BCol lg="6" xl="5" class="ms-auto py-5 order-1 order-lg-2">
          <div class="position-relative">
            <figure class="position-absolute top-0 start-0 translate-middle mt-5 opacity-25">
              <svg width="111" height="170" viewBox="0 0 111 170" fill="#1c84c6"
                   xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M99.2319 7.37436C100.054 7.30936 101.638 15.7474 102.856 26.059C104.147 36.3089 105.01 48.3589 105.287 55.3911C105.778 69.3822 104.459 80.6992 102.753 80.7559C100.986 80.7391 99.5737 69.5262 99.0765 55.6027C98.7941 48.638 98.612 36.5788 98.4807 26.2931C98.3494 16.0074 98.3422 7.43353 99.2319 7.37436Z"/>
                <path
            ...
            <NuxtImg src="/images/file-manager.png" class="rounded-3 shadow-lg img-fluid mt-5 z-1 position-relative"
                     alt="File Manager"/>
            <figure class="position-absolute bottom-0 end-0 me-n5 mb-n5 opacity-25">
              <svg width="120" height="120" xmlns="http://www.w3.org/2000/svg">
                <g fill="#f8ac59">
      ...
      <BRow class="align-items-center py-5">
        <BCol lg="6" xl="5" class="py-3">
          <div class="position-relative">
            <figure class="position-absolute top-0 start-0 translate-middle mt-5 opacity-25">
              <svg width="111" height="170" viewBox="0 0 111 170" fill="#7b70ef"
                   xmlns="http://www.w3.org/2000/svg">
                <path
                    d="M99.2319 7.37436C100.054 7.30936 101.638 15.7474 102.856 26.059C104.147 36.3089 105.01 48.3589 105.287 55.3911C105.778 69.3822 104.459 80.6992 102.753 80.7559C100.986 80.7391 99.5737 69.5262 99.0765 55.6027C98.7941 48.638 98.612 36.5788 98.4807 26.2931C98.3494 16.0074 98.3422 7.43353 99.2319 7.37436Z"/>
                <path
            ...
            <NuxtImg src="/images/team.png" class="rounded-3 shadow-lg img-fluid mt-5 z-1 position-relative"
                     alt="Team"/>
            <figure class="position-absolute bottom-0 end-0 me-n5 mb-n5 opacity-25">
              <svg width="120" height="120" xmlns="http://www.w3.org/2000/svg">
                <g fill="#ed5565">
        ...
        <BCol lg="5" class="ms-auto py-3">
          ...
          <p class="mb-2 lead">Our smart contacts app keeps all your relationships organized and accessible across
            devices.</p>
          <p class="text-muted fs-sm mb-4">Effortlessly import, categorize, and interact with contacts securely.</p>
          <BButton variant="primary" class="mb-4">Check Contacts App</BButton>

          <div class="d-flex flex-wrap justify-content-between gap-4 mt-4">
            <div v-for="(stat, index) in stats3" :key="index">
              <h3 class="mb-2">
                <client-only>
                  <CountUp :endVal="stat.value" :options="{duration: 2, decimalPlaces: 1,suffix:stat.suffix, enableScrollSpy: true,
                scrollSpyOnce: true,}"/>
