...
import { data1, data2 } from '@/app/(admin)/graphs/apex-tree/data';
...
const Page = () => {
  useEffect(() => {
    ...
    const basicNodeTemplate = content => `
    ...
    const verticalNodeTemplate = content => `
    ...
    const renderTree = (id, options, data) => {
    ...
    renderTree('right-to-left', {
      ...sharedOptions,
      direction: 'right'
    }, data1);
    renderTree('bottom-tree', {
      ...sharedOptions,
      direction: 'bottom'
    }, data1);
    renderTree('top-tree', {
