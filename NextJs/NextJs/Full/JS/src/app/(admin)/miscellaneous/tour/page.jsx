...
const Page = () => {
  ...
  return <Container fluid>
            ...
            <CardBody>
              <div>
                  ...
                  <Col lg={5}>
                    <div className="text-center mt-4 mb-5">
                      ...
                      <div className="d-flex justify-content-center mt-4 flex-wrap gap-2">
                        ...
                        <Link ref={step2Ref} href="https://wrapbootstrap.com/theme/inspinia-multipurpose-admin-dashboard-template-WB0R5L90S?ref=inspinia" target="_blank" className="btn btn-danger">
                ...
                <Container ref={step3Ref}>
                  ...
                  <Row>
                    {features.map((feature, idx) => <Col xl={3} key={idx}>
      ...
      <Tour defaultCurrent={1} open={openTour} onClose={() => setOpenTour(false)} animated mask steps={[{
