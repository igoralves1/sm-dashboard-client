...
<head>
    <?php echo view("partials/title-meta", array("title" => "Reviews")) ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "Ecommerce", "title" => "Reviews")) ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="product" href="ecommerce-product-details" class="link-reset">Wireless Earbuds</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="product" href="ecommerce-product-details" class="link-reset">Smart Watch</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="product" href="ecommerce-product-details" class="link-reset">4K Ultra HD TV</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="product" href="ecommerce-product-details" class="link-reset">Smartphone X</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a data-sort="product" href="ecommerce-product-details" class="link-reset">Gaming Laptop</a>
                                                        </h5>
                                                    </div>
                                                </div>
                                            </td>
    ...
    <script src="/js/pages/ecommerce-reviews.js"></script>
