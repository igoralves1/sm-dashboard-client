                ...
                <BCol lg="8">
                    ...
                    <BCard no-body>
                        ...
                        <BCardBody>
                            ...
                            <a class="btn btn-link p-0 fw-semibold" href="https://vue-multiselect.js.org/"
                                target="_blank">
                        ...
                        <BCardBody>
                            ...
                            <BRow class="g-4">
                                <BCol lg="6">
                                    ...
                                    <p class="text-muted mb-0">An example of a select dropdown with an appended button
                                        using
                                        Select2.</p>
                                </BCol>
                                <BCol lg="6">
                                    <MultiSelect :modelValue="selectedValue" :options="basicOptions"
                            ...
                            <BRow class="g-4">
                                <BCol lg="6">
                                    ...
                                    <p class="text-muted mb-0">Select2 can take a regular select box with optgroup
                                        support
                                        for better organization.</p>
                                </BCol>
                                <BCol lg="6">
                                    <MultiSelect :modelValue="selectedGroupValue" :options="groupedOptions"
                                        group-values="states" group-label="country"   :object="true" />
                            ...
                            <BRow class="g-4">
                                <BCol lg="6">
                                    ...
                                    <p class="text-muted mb-0">Select2 multiple select with grouped options and
                                        placeholder.
                                    </p>
                                </BCol>
                                <BCol lg="6">
                                    <MultiSelect :modelValue="selectedMutiGroupValue" :options="groupedOptions"
...
const selectedValue:any = ref<string | number | Array<string | number>>('Alaska');
const selectedGroupValue = ref<string | number | Array<string | number>>([]);
const selectedMutiGroupValue: any = ref<string | number | Array<string | number>>([]);
