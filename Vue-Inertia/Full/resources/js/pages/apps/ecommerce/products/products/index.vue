                            ...
                            <BCard no-body>
                                <BCardHeader class="border-light justify-content-between">
                                    ...
                                    <div class="d-flex gap-1">
                                        <Link href="/products-grid" class="btn btn-soft-primary btn-icon">
                                            <Icon icon="lucide:layout-grid" class="fs-lg" />
                                        </Link>
                                        <Link href="/products" class="btn btn-primary btn-icon">
                                            <Icon icon="lucide:list" class="fs-lg" />
                                        </Link>
                                        <Link href="/add-product" class="btn btn-danger ms-1">
                                ...
                                <BTable show-empty :filter="searchQuery" empty-text="No products found."
                                    ...
                                    <template #cell(name)="data">
                                        <div class="d-flex">
                                            ...
                                            <div>
                                                <h5 class="mb-1">
                                                    <Link href="/ecommerce/product-details" class="link-reset">{{
                                                        data.item.name
                                                        }}
                                                    </Link>
                                                </h5>
                                    ...
                                    <template #cell(rating)="data">
                                        ...
                                        <Link href="/ecommerce/reviews" class="link-reset ms-1 fw-semibold">
                                            ({{ data.item.reviews }})</Link>
