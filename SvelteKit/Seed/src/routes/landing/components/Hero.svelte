<script lang="ts">
	...
	import bgPattern from '$lib/assets/images/bg-pattern.png';
	import dashboard1 from '$lib/assets/images/dashboard-1.png';

	import user7 from '$lib/assets/images/users/user-7.jpg';
	import user8 from '$lib/assets/images/users/user-8.jpg';
	import user9 from '$lib/assets/images/users/user-9.jpg';
	import user1 from '$lib/assets/images/users/user-1.jpg';
	import user2 from '$lib/assets/images/users/user-2.jpg';
	import { Col, Container, Row } from '@sveltestrap/sveltestrap';

	const avatars: string[] = [user7, user8, user9, user1, user2];
</script>

<section class="bg-light bg-opacity-50 border-top border-light position-relative" id="home">
	<div class="position-absolute top-0 start-50 translate-middle-x mt-5">
		<img src={bgPattern} alt="bg pattern" />
	</div>

	<Container class="pt-5 position-relative">
		<Row>
			<Col lg="8" class="mx-auto text-center">
				...
				<div class="avatar-group avatar-group-sm justify-content-center mt-2">
					{#each avatars as img, idx (idx)}
						<div class="avatar">
							<img src={img} alt="user" class="avatar-sm rounded-circle" />
						</div>
					{/each}
				</div>
				...
				<p class="mb-4 fs-sm text-muted lh-lg">
					...
					Designed for performance, flexibility, and ease of customization, it’s the perfect
					solution for startups, agencies, and enterprise teams.
				</p>

				<div class="d-flex gap-1 gap-sm-2 flex-wrap justify-content-center">
					<a href="/" class="btn btn-secondary py-2 fw-semibold">
						<Icon icon="tabler:basket" class="fs-xl me-2" />
						Buy Now!
					</a>
					<a
						href="https://wrapbootstrap.com/user/WebAppLayers/message"
						class="btn btn-light py-2 fw-semibold"
						target="_blank"
					>
						<Icon icon="tabler:confetti" class="fs-xl me-2" />
						Contact Us
					</a>
				</div>
			</Col>
		...
		<Row>
			<Col md="10" class="mx-auto position-relative">
				...
				<img src={dashboard1} alt="SaaS Preview" class="rounded-top-4 shadow-lg img-fluid mt-5" />
			</Col>
		</Row>
	</Container>
</section>
