...
<head>
    <?php $title = "Activity Stream"; include 'partials/title-meta.php' ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Projects"; $title = "Activity Stream"; include 'partials/page-title.php' ?>
                        ...
                        <div class="card card-h-100">
                            ...
                            <div class="card-body">
                                <div class="py-1 d-flex gap-3 align-items-center">
                                    ...
                                    <a href="pages-profile.php" class="link-reset fw-semibold">
                                        <img src="assets/images/users/user-1.jpg" alt="" class="rounded-circle avatar-xxs"> Olivia Lee
                                ...
                                <div class="py-1 d-flex gap-3 align-items-center">
                                    ...
                                    <a href="pages-profile.php" class="link-reset fw-semibold">
                                        <img src="assets/images/users/user-2.jpg" alt="" class="rounded-circle avatar-xxs"> Ethan Wong
                                ...
                                <div class="py-1 d-flex gap-3 align-items-center">
                                    ...
                                    <a href="pages-profile.php" class="link-reset fw-semibold">
                                        <img src="assets/images/users/user-3.jpg" alt="" class="rounded-circle avatar-xxs"> Grace Kim
                                ...
                                <div class="py-1 d-flex gap-3 align-items-center">
                                    ...
                                    <a href="pages-profile.php" class="link-reset fw-semibold">
                                        <img src="assets/images/users/user-4.jpg" alt="" class="rounded-circle avatar-xxs"> Noah Smith
                                ...
                                <div class="py-1 d-flex gap-3 align-items-center">
                                    ...
                                    <a href="pages-profile.php" class="link-reset fw-semibold">
                                        <img src="assets/images/users/user-5.jpg" alt="" class="rounded-circle avatar-xxs"> Mia Johnson
                                ...
                                <div class="py-1 d-flex gap-3 align-items-center">
                                    ...
                                    <a href="pages-profile.php" class="link-reset fw-semibold">
                                        <img src="assets/images/users/user-6.jpg" alt="" class="rounded-circle avatar-xxs"> Liam Davis
                                ...
                                <div class="py-1 d-flex gap-3 align-items-center">
                                    ...
                                    <a href="pages-profile.php" class="link-reset fw-semibold">
                                        <img src="assets/images/users/user-7.jpg" alt="" class="rounded-circle avatar-xxs"> Sophia Martinez
                                ...
                                <div class="py-1 d-flex gap-3 align-items-center">
                                    ...
                                    <a href="pages-profile.php" class="link-reset fw-semibold">
                                        <img src="assets/images/users/user-8.jpg" alt="" class="rounded-circle avatar-xxs"> Jack Wilson
                                ...
                                <div class="py-1 d-flex gap-3 align-items-center">
                                    ...
                                    <a href="pages-profile.php" class="link-reset fw-semibold">
                                        <img src="assets/images/users/user-9.jpg" alt="" class="rounded-circle avatar-xxs"> Ella Moore
                                ...
                                <div class="py-1 d-flex gap-3 align-items-center">
                                    ...
                                    <a href="pages-profile.php" class="link-reset fw-semibold">
                                        <img src="assets/images/users/user-10.jpg" alt="" class="rounded-circle avatar-xxs"> Benjamin Taylor
                                ...
                                <div class="timeline timeline-icon-bordered">
                                    ...
                                    <div class="timeline-item d-flex align-items-stretch">
                                        ...
                                        <div class="timeline-content ps-3 pb-3">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="pages-profile.php" class="fw-semibold link-reset">Natalie Brooks</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="timeline-item d-flex align-items-stretch">
                                        ...
                                        <div class="timeline-content ps-3 pb-3">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="pages-profile.php" class="fw-semibold link-reset">Oliver Grant</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="timeline-item d-flex align-items-stretch">
                                        ...
                                        <div class="timeline-content ps-3 pb-3">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="pages-profile.php" class="fw-semibold link-reset">Clara Jensen</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="timeline-item d-flex align-items-stretch">
                                        ...
                                        <div class="timeline-content ps-3 pb-3">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="pages-profile.php" class="fw-semibold link-reset">Leo Armstrong</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="timeline-item d-flex align-items-stretch">
                                        ...
                                        <div class="timeline-content ps-3 pb-3">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="pages-profile.php" class="fw-semibold link-reset">Liam Carter</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="timeline-item d-flex align-items-stretch">
                                        ...
                                        <div class="timeline-content ps-3 pb-3">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                ...
                                                <a href="pages-profile.php" class="fw-semibold link-reset">Emma Davis</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="timeline-item d-flex align-items-stretch">
                                        ...
                                        <div class="timeline-content ps-3 pb-3">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="assets/images/users/user-7.jpg" alt="Sophia Reed" class="rounded-circle avatar-xxs">
                                                <a href="pages-profile.php" class="fw-semibold link-reset">Sophia Reed</a>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="timeline-item d-flex align-items-stretch">
                                        ...
                                        <div class="timeline-content ps-3">
                                            ...
                                            <div class="d-flex align-items-center gap-2">
                                                <img src="assets/images/users/user-5.jpg" alt="Daniel Chen" class="rounded-circle avatar-xxs">
                                                <a href="pages-profile.php" class="fw-semibold link-reset">Daniel Chen</a>
                                            </div>
                                        </div>
                                    </div>
