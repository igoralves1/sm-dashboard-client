          ...
          <tbody>
              ...
              <td>
                <div className="d-flex">
                  <div className="avatar-md me-3">
                    <Image src={product1} width={36} height={36} alt="Wireless Earbuds" className="img-fluid rounded" />
                  </div>
                  <div>
                    <h5 className="mb-1">
            ...
            <tr>
              <td>
                <div className="d-flex">
                  <div className="avatar-md me-3">
                    <Image src={product2} width={36} height={36} alt="Smart Watch" className="img-fluid rounded" />
                  </div>
                  <div>
                    <h5 className="mb-1">
                      <Link href="" className="link-reset">
            ...
            <tr>
              <td>
                <div className="d-flex">
                  <div className="avatar-md me-3">
                    <Image src={product3} width={36} height={36} alt="Gaming Mouse" className="img-fluid rounded" />
                  </div>
                  <div>
                    <h5 className="mb-1">
                      <Link href="" className="link-reset">
