                    ...
                    <BCardHeader class="border-light justify-content-between">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="app-search">
                                ...
                                <Icon size="18" name="lucide:credit-card" class="app-search-icon text-muted" />
                            </div>
                            ...
                            <div class="app-search">
                                ...
                                <Icon size="18" name="lucide:truck" class="app-search-icon text-muted" />
                            </div>
                            ...
                            <div class="app-search">
                                ...
                                <Icon size="18" name="lucide:calendar" class="app-search-icon text-muted" />
                            </div>
                        ...
                        <div class="d-flex gap-1">
                            <NuxtLink to="" class="btn btn-danger ms-1">
                                <Icon name="lucide:plus" class="fs-sm me-2" /> Add Order
                            </NuxtLink>
                        </div>
                    </BCardHeader>
                    ...
                    <BTable show-empty :filter="searchQuery" empty-text="Nothing found."
                        ...
                        <template #cell(id)="{ item }">
                            <h5 class="fs-sm mb-0 fw-medium">
                                <NuxtLink to="/orders/{{ item.id }}" class="link-reset">#{{ item.id }}</NuxtLink>
                            </h5>
                        </template>
                        ...
                        <template #cell(customer)="{ item }">
                            <div class="d-flex justify-content-start align-items-center gap-2">
                                <div class="avatar avatar-sm">
                                    <NuxtImg :src="item.customer.avatar" alt="avatar-2"
                        ...
                        <template #cell(paymentStatus)="{ item }">
                            <span class="fw-semibold"
                                ...
                                <Icon name="tabler:point-filled" class="fs-sm" /> {{ toPascalCase(item.paymentStatus) }}
                            </span>
                        </template>
                        ...
                        <template #cell(paymentMethod)="{ item }">
                            <Nuxtimg :src="item.paymentMethod.image" alt="" class="me-2" height="28" />
