                        ...
                        <div class="card card-top-sticky">
                            <div class="card-body pt-0">
                                <article class="card card-out-of-container border-top-0">
                                    <div class="position-relative card-side-img overflow-hidden rounded-top" style="height: 180px; background-image: url(assets/images/seller-profile.jpg);">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center rounded border-light p-3 bg-light-subtle border">
                                            <div class="d-flex justify-content-start align-items-center gap-3">
                                                <div class="avatar avatar-xxl">
                                                    <img src="assets/images/sellers/4.png" alt="avatar-2" class="img-fluid img-thumbnail rounded-circle">
                                                </div>
                                                <div>
