...
const generateRandomData = year => countries.map(country => [Math.floor(Math.random() * 50000 + 5000), Math.floor(Math.random() * 30 + 60), Math.floor(Math.random() * 1000000000 + 5000000), country, year]);
