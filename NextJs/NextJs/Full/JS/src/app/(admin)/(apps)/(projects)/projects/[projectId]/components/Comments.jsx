...
const Comments = () => {
  return <>
      ...
      {commentsData.map((comment, idx) => <div key={idx} className={`d-flex ${idx === commentsData.length - 1 ? 'mb-3' : 'mb-2'} border border-dashed rounded p-3`}>
          <div className="flex-shrink-0">
            <Image src={comment.avatar} alt="" className="avatar-sm rounded-circle shadow-sm" />
          </div>
          <div className="flex-grow-1 ms-2">
            ...
            {comment.reply && comment.reply.map((reply, i) => <div className="d-flex mt-4" key={i}>
                  <div className="flex-shrink-0">
