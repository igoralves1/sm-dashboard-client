...
<article class="card rounded-3 border-0 shadow-sm">
	...
	<div class="card-body">
		<h6 class="card-title fs-lg lh-base mb-2">
			<a href={blog.url} class="link-reset">{blog.title}</a>
		</h6>
		...
		<p class="d-flex flex-wrap gap-3 text-muted mb-0 mt-3 align-items-center fs-base">
			...
			<span class="d-flex align-items-center gap-1">
				...
				<a href={null} class="link-reset">{blog.comments}</a>
			</span>
			<span class="d-flex align-items-center gap-1">
		...
		<div class="d-flex justify-content-start align-items-center gap-2">
			...
			<div>
				<h5 class="text-nowrap fs-sm mb-0 lh-base">
					<a href={null} class="link-reset">{blog.author.name}</a>
				</h5>
			</div>
		</div>
		<a href={blog.url} class="link-primary fw-semibold d-flex align-items-center gap-1">
			Read more
