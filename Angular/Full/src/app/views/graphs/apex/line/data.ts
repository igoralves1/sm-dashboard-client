...
export const lineWithDataLabelChart: () => ApexOptions = () => ({
    chart: {
        height: 380,
        type: 'line',
        zoom: {enabled: false},
...
export const zoomableLineChart: () => ApexOptions = () => ({
    chart: {
        type: 'area',
        stacked: false,
        height: 380,
...
export const lineWithAnnotationsChart: () => ApexOptions = () => ({
    annotations: {
        yaxis: [{
            y: 4200,
...
export const syncChartPrimary: () => ApexOptions = () => ({
    chart: {
        type: 'line',
        height: 160,
        id: 'fb',
...
export const syncChartSecondary: () => ApexOptions = () => ({
    chart: {
        height: 200,
        type: 'line',
        id: 'yt',
...
export const gradientLineChart: () => ApexOptions = () => ({
    chart: {
        height: 374,
        type: 'line',
        toolbar: {show: false},
...
export const missingDataLineChart: () => ApexOptions = () => ({
    chart: {
        height: 380,
        type: 'line',
        zoom: {
...
export const dashedLineChart: () => ApexOptions = () => ({
    chart: {
        height: 380,
        type: 'line',
        zoom: {
        ...
        y: {
            title: {
                formatter: function (seriesName) {
                    if (seriesName === 'Charging Time') return 'Charging Time (mgetColor)';
...
export const stepLineChart: () => ApexOptions = () => ({
    chart: {
        type: 'line',
        height: 360,
        toolbar: {show: false},
...
export const brushChartMain: () => ApexOptions = () => ({
    series: [{
        data: common
    }],
    chart: {
...
export const brushChartOverview: () => ApexOptions = () => ({
    series: [{
        data: common
    }],
    chart: {
