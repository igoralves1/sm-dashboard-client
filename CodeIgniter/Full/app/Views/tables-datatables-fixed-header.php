...
<head>
    <?php echo view("partials/title-meta", array("title" => "Fixed Header Datatables")) ?>

    <!-- Datatables css -->
    <link href="/plugins/datatables/responsive.bootstrap5.min.css" rel="stylesheet" type="text/css">
    <link href="/plugins/datatables/fixedHeader.bootstrap5.min.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "DataTables", "title" => "Fixed Header")) ?>
    ...
    <script src="/plugins/datatables/fixedHeader.bootstrap5.min.js"></script>

    <!-- Page js -->
    <script src="/js/pages/datatables-fixed-header.js"></script>
