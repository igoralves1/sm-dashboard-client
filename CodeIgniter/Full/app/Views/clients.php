...
<head>
    <?php echo view("partials/title-meta", array("title" => "Clients")) ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile" class="link-reset">Emily
                                                                Parker</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile" class="link-reset">Liam
                                                                Scott</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile" class="link-reset">Sofia
                                                                Müller</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile" class="link-reset">Carlos
                                                                Méndez</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile" class="link-reset">Nina
                                                                Patel</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile" class="link-reset">Oliver
                                                                Chen</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile" class="link-reset">Maya
                                                                Tanaka</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile" class="link-reset">Lucas
                                                                Ferreira</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile" class="link-reset">Anna
                                                                Schmidt</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile" class="link-reset">Jason
                                                                Lee</a></h5>
