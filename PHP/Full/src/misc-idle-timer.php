...
<head>
    <?php $title = "Idle Timer"; include 'partials/title-meta.php' ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Miscellaneous"; $title = "Idle Timer"; include 'partials/page-title.php' ?>
                                ...
                                <div class="toast-container position-fixed top-0 end-0 p-3">
                                    ...
                                    <div id="liveToast" class="toast shadow-lg text-bg-warning border-warning" role="alert" aria-live="assertive" aria-atomic="true">
                                        <div class="toast-header text-bg-warning border-warning">
                                            <img src="assets/images/logo-sm.png" class="rounded me-2" height="20" alt="...">
    ...
    <script src="assets/js/pages/misc-idle-timer.js"></script>
