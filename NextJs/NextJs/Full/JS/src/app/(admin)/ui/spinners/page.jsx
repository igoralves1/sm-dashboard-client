...
const ButtonsSpinner = () => {
  return <ComponentCard title="Buttons Spinner">
      <Row className="g-3">
        <Col lg={6}>
...
const GrowingSpinners = () => {
  return <ComponentCard title="Growing Spinner">
      <p className="text-muted">
...
const ColorGrowingSpinners = () => {
  return <ComponentCard title="Color Growing Spinner">
      <p className="text-muted">
...
const SpinnersSizes = () => {
  ...
  return <ComponentCard title="Size">
      <Row>
        {(sizes || []).map((size, idx) => {
...
const SpinKitCSSBasedPlugin = () => {
  return <ComponentCard title="SpinKit">
      <Row className="mb-5">
        <Col>
            ...
            <Col xs={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0 fw-semibold" href="https://react-bootstrap.netlify.app/docs/components/spinners" target="_blank">
