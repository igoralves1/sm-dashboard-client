...
const DefaultCollapse = () => {
  ...
  return <ComponentCard title="Collapse">
      <p>
...
const MultipleTargets = () => {
  ...
  return <ComponentCard title="Multiple Targets">
...
const CollapseHorizontal = () => {
  ...
  return <ComponentCard title="Collapse Horizontal">
      <p>
        <Button variant="primary" onClick={toggle}>
            ...
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0 fw-semibold" href="https://react-bootstrap.netlify.app/docs/components/collapse/" target="_blank" rel="noopener noreferrer">
