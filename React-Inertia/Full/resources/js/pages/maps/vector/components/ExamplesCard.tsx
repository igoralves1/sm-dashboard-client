...
import WorldMapMarkerLine from '@/pages/maps/vector/components/WorldMapMarkerLine'
import USAVectorMap from '@/pages/maps/vector/components/USAVectorMap'
import CanadaVectorMap from '@/pages/maps/vector/components/CanadaVectorMap'
import RussiaVectorMap from '@/pages/maps/vector/components/RussiaVectorMap'
import IraqVectorMap from '@/pages/maps/vector/components/IraqVectorMap'
import SpainVectorMap from '@/pages/maps/vector/components/SpainVectorMap'
import { getWorldMapOptions } from '@/pages/maps/vector/data'
