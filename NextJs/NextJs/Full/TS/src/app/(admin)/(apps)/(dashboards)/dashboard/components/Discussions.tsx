...
import { Badge, Button, Card, CardBody, CardHeader, ListGroup, ListGroupItem } from 'react-bootstrap'
          ...
          {discussionMessages.map((msg) => (
            <ListGroupItem key={msg.id} className="px-0 border-light">
              <div className="d-flex gap-2">
                <div className="me-2 flex-shrink-0">
                  {msg.hasAvatar ? (
                    <Image src={msg.userImage} className="avatar-md rounded-circle" alt={msg.userName} />
                  ) : (
