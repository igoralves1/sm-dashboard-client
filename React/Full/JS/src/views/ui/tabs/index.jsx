...
const DefaultTabs = () => {
  return <ComponentCard title="Default Tabs">
...
const TabsJustified = () => {
  return <ComponentCard title="Tabs Justified">
...
const TabsVerticalLeft = () => {
  return <ComponentCard title="Tabs Vertical Left">
      <p className="text-muted">
...
const TabsVerticalRight = () => {
  return <ComponentCard title="Tabs with Colored Navs">
      <p className="text-muted">
...
const BorderedTabswithColoredBorder = () => {
  return <ComponentCard title="Bordered Tabs with Colored Border">
      <p className="text-muted">
...
const IconsTabs = () => {
  return <ComponentCard title="Icons Tabs">
      <p className="text-muted">
        The navigation item can have a simple bottom border as well. Just specify the class
        <code>.nav-bordered</code>.
      </p>
...
const CardWithTabs = () => {
  return <TabContainer defaultActiveKey={'Summary'}>
      <Card>
            ...
            <Col xs={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0 fw-semibold" to="https://react-bootstrap.netlify.app/docs/components/tabs" target="_blank">
