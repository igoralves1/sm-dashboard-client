                ...
                <BCard no-body>
                    <BCardHeader class="border-light justify-content-between">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="app-search">
                                ...
                                <Icon name="lucide:trending-up" class="app-search-icon text-muted"/>
                            </div>
                    ...
                    <BTable show-empty :filter="searchQuery" empty-text="Nothing found."
                        ...
                        <template #cell(rating)="{ item }">
                            ...
                            <span class="ms-1">
                                <NuxtLink to="/reviews" class="link-reset fw-semibold">({{ item.views }})</NuxtLink>
                            </span>
                        </template>
                        <template #cell(report)="{ item }">
                            <CustomApexChart :get-Options="() => getReportsChartOptions(item.chartType)"
