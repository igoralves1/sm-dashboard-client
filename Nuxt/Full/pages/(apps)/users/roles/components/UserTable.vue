    ...
    <BCard no-body>
        <BCardHeader class="border-light justify-content-between">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="app-search">
                    ...
                    <Icon size="18" name="lucide:shield" class="app-search-icon text-muted" />
                </div>
        ...
        <BTable show-empty :filter="searchQuery" empty-text="Nothing found." v-model:selected-rows="selected"
            ...
            <template #cell(id)="{ item }">
                <h5 class="m-0">
                    <NuxtLink to="" class="link-reset">{{ item.id }}</NuxtLink>
                </h5>
            </template>
            <template #cell(user)="{ item }">
                <div class="d-flex align-items-center gap-2">
                    <div class="avatar avatar-sm">
                        <NuxtImg :src="item.avatar" class="img-fluid rounded-circle" alt="" />
                    </div>
                    <div>
                        <h5 class="fs-base mb-0">
                            <NuxtLink to="" class="link-reset">{{ item.name }}</NuxtLink>
                        </h5>
