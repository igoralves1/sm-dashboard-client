...
const StatisticWidgetChartRight = ({
  item
}) => {
  const {
    count,
  ...
  return <Card>
      ...
      <CardBody>
        <div className="d-flex justify-content-between align-items-center">
          ...
          {chartOptions() && <EChartClient extensions={getExtensions(ChartType)} getOptions={chartOptions} style={{
          height: chartHeight,
          width: chartWidth
        }} />}
        </div>
