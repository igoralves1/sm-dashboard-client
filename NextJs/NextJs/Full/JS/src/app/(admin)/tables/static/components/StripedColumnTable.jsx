...
const StripedColumnTable = () => {
  return <Card>
      <CardHeader className="justify-content-between">
        ...
        <a href="https://react-bootstrap.netlify.app/docs/components/table#striped-columns" target="_blank" className="icon-link icon-link-hover link-secondary link-underline-secondarlink-secondary link-underline-opacity-25 fw-semibold">
