<script lang="ts">
	...
	import deleteImg from '$lib/assets/images/delete.png';
</script>

<PageMeta title="Delete Account" />
...
<div class="auth-box p-0 w-100">
	<Row class="w-100 g-0">
		...
		<Col xl="auto">
			<Card class="card auth-box-form border-0 mb-0">
					...
					<div class="mt-auto text-center">
						<div class="mb-4">
							<div class="avatar-xxl mx-auto mt-2">
								...
								>
									<img src={deleteImg} alt="icon" height="64" />
								</div>
							</div>
						</div>
						...
						<p class="text-muted text-center mb-4">
							Your account is currently inactive. Reactivate now to regain access to all features
							and opportunities.
						</p>

						<div class="d-grid">
							<Button color="primary" type="submit" class="fw-semibold py-2">Reactivate Now</Button>
						</div>
					</div>
