...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "Miscellaneous", "title" => "Animation")) ?>
                                        ...
                                        <div class="card card-top-sticky overflow-hidden">
                                            <div class="card-body">
                                                <div id="animation_box" class="animate__animated">
                                                    <img src="/images/blog/blog-1.jpg" class="img-fluid rounded" alt="user">
                                                </div>
    ...
    <script src="/js/pages/misc-animation.js"></script>
