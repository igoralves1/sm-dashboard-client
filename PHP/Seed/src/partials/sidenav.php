        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="sidebarLayouts">
                    <ul class="sub-menu">
                        ...
                        <li class="side-nav-item">
                            <a href="layouts-outlook.php" target="_blank" class="side-nav-link">
            ...
            <li class="side-nav-item">
                ...
                <div class="collapse" id="themeSkin">
                    <ul class="sub-menu">
                        <li class="side-nav-item">
                            <a href="skin-classic.php" target="_blank" class="side-nav-link">
                                <span class="menu-text">Classic (Default)</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="skin-saas.php" target="_blank" class="side-nav-link">
                                <span class="menu-text">SaaS</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="skin-material.php" target="_blank" class="side-nav-link">
                                <span class="menu-text">Material</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="skin-modern.php" target="_blank" class="side-nav-link">
                                <span class="menu-text">Modern</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="skin-minimal.php" target="_blank" class="side-nav-link">
                                <span class="menu-text">Minimal</span>
                            </a>
                        </li>
                        <li class="side-nav-item">
                            <a href="skin-flat.php" target="_blank" class="side-nav-link">
