      ...
      <BCol cols="12">
        <BCard no-body>
          <BCardHeader class="d-block">
            <div class="text-center w-md-75 w-xl-50 mx-auto py-3">
              ...
              <div class="d-flex justify-content-center align-items-center gap-1">
                ...
                <NuxtLink
                  v-for="(item, idx) in ['Analytics','SaaS','Ecommerce','CRM']"
                  :key="idx"
                  to="#"
          ...
          <BCardHeader class="border-light justify-content-between d-flex">
            ...
            <div class="d-flex flex-wrap align-items-center gap-3">
              ...
              <div class="app-search">
                ...
                <Icon name="lucide:layers" size="18" class="app-search-icon text-muted" />
              </div>
              ...
              <div class="app-search">
                ...
                <Icon name="lucide:circle-dollar-sign" size="18" class="app-search-icon text-muted" />
              </div>
            </div>
          </BCardHeader>
          ...
          <BCardBody class="p-0">
            ...
            >
              <h4 class="fs-md mb-1">
                <NuxtLink :to="item.url" target="_blank" class="text-reset">
                  {{ item.title }}
                </NuxtLink>
              </h4>
              ...
              <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                <span class="d-flex align-items-center gap-1">
                  ...
                  />
                  <NuxtLink to="#" class="link-reset fw-semibold">{{ item.author }}</NuxtLink>
                </span>
                ...
                <span class="d-flex align-items-center gap-1">
                  ...
                  <NuxtLink to="#" class="link-reset">Comments: {{ item.comments }}</NuxtLink>
                </span>
            ...
            <div class="border-bottom border-dashed px-4 py-3">
              ...
              <div class="d-flex gap-2">
                <div v-for="(img, idx) in users" :key="idx" class="avatar">
                  <NuxtImg :src="img" alt="" height="48" width="48" class="rounded avatar-xl" />
                </div>
              </div>
            </div>
            ...
            <div class="border-bottom border-dashed px-4 py-3">
              ...
              <div class="d-flex gap-2 flex-wrap">
                <div
                  ...
                  :key="idx"
                  class="px-3 py-2 bg-light bg-opacity-50 rounded"
                >
                  <NuxtLink to="#" class="text-reset fs-md fw-semibold">
                    {{ item }} <Icon name="tabler:search" class="ms-2" />
                  </NuxtLink>
                </div>
              </div>
            </div>
            ...
            <BPagination
              class="pagination-rounded pagination-boxed justify-content-center mb-0 py-3"
              v-model="page"
              :total-rows="80"
              :per-page="10"
              last-number
