...
import { Button, Card, CardBody, CardHeader, CardTitle, Col, Container, Offcanvas, OffcanvasBody, OffcanvasHeader, OffcanvasTitle, Row } from 'react-bootstrap';
...
const DefaultOffcanvas = () => {
  ...
  return <ComponentCard title="Offcanvas">
...
const OffcanvasBackdrop = () => {
  ...
  return <ComponentCard title="Offcanvas Backdrop">
      <p className="text-muted fs-base">
...
const OffcanvasPlacement = () => {
  ...
  return <ComponentCard title="Offcanvas Placement">
...
const DarkOffcanvas = () => {
  ...
  return <ComponentCard title="Dark Offcanvas">
      <p className="text-muted fs-sm">
            ...
            <Col xs={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0 fw-semibold" href="https://react-bootstrap.netlify.app/docs/components/offcanvas" target="_blank">
