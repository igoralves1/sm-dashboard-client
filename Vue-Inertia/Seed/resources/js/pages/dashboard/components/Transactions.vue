    ...
    <BRow class="align-items-center">
      <BCol xl="6">
        ...
        <div class="text-center mt-3">
          <Link to="#" class="link-reset text-decoration-underline fw-semibold link-offset-3">
...
import type { TransactionsType } from '@/pages/dashboard/components/types'
import {
  transactions as transactionsData,
  worldTransactionMapOptions,
} from '@/pages/dashboard/components/data'
