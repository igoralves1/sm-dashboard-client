                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-sm btn-primary" @click="copyFromElement(copytext)">
                                            <Icon name="tabler:copy" class="me-1" /> Copy Text
                                        </button>
                                    </td>
                                </tr>
...
This content will be cut and removed from this textarea.</textarea>
                                        <button class="btn btn-sm btn-primary mt-3" @click="cutFromInput(cutArea)">
                                            <Icon name="tabler:scissors" class="me-1" /> Cut Content
                                        </button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-sm btn-primary mt-2" @click="copyFromElement(copyEmail)">
                                            <Icon name="tabler:copy" class="me-1" /> Copy Email
                                        </button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-sm btn-danger mt-2" @click="cutFromInput(cutInput)">
                                            <Icon name="tabler:scissors" class="me-1" /> Cut Token
                                        </button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-sm btn-success" @click="copyFromElement(codeSnippet)">
                                            <Icon name="tabler:copy" class="me-1" /> Copy Command
                                        </button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-sm btn-primary mt-2"
                                            ...
                                            <Icon name="tabler:copy" class="me-1" /> Copy Username
                                        </button>
                                    </td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="input-group">
                                            <input ref="discountCode" type="text" class="form-control" value="SAVE20NOW"
                                                readonly />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-sm btn-info" @click="copyFromElement(htmlTemplate)">
                                            <Icon name="tabler:copy" class="me-1" /> Copy HTML
                                        </button>
                                    </td>
                                </tr>
                            </tbody>
