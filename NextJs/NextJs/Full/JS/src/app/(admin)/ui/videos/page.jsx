...
const ResponsiveEmbedVideo219 = () => {
  return <ComponentCard title="Responsive embed video 21:9">
...
const ResponsiveEmbedVideo11 = () => {
  return <ComponentCard title="Responsive embed video 1:1">
...
const ResponsiveEmbedVideo169 = () => {
  return <ComponentCard title="Responsive embed video 16:9">
...
const ResponsiveEmbedVideo43 = () => {
  return <ComponentCard title="Responsive embed video 43">
            ...
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/helpers/ratio/" target="_blank">
                    Ratios on Bootstrap
