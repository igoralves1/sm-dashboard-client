...
<head>
    <?php $title = "Live Favicon"; include 'partials/title-meta.php' ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Miscellaneous"; $title = "Live Favicon"; include 'partials/page-title.php' ?>
    ...
    <script src="assets/plugins/tinycon/tinycon.min.js"></script>

    <script src="assets/js/pages/misc-tinycon.js"></script>
