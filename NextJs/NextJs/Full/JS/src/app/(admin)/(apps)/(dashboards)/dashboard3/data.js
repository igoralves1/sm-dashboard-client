import { TbActivity, TbArrowDownLeft, TbBrandFacebook, TbBroadcast, TbClock, TbEye, TbMailFast, TbRepeatOnce, TbRocket, TbSpeakerphone, TbTrendingUp, TbUser, TbUsers } from 'react-icons/tb';
...
const {
  sessions,
  pageViews
} = generateSessionAndPageViewData(19);
...
export const getAnalyticsOverViewOptions = () => ({
  chart: {
    height: 326,
    type: 'area',
    toolbar: {
...
export const getSessionsDevicesOptions = () => ({
  chart: {
    height: 208,
    type: 'bubble',
    toolbar: {
