...
const ProfileCard = () => {
  return <div className="card border-top-0">
        ...
        <div className="d-flex justify-content-start gap-3">
          ...
          marginTop: '-60px'
            ...
            <Link href="/pages/profile">
              <Image src={user2} alt="User Profile" className="img-fluid img-thumbnail rounded-circle" />
            </Link>
          </div>
          <div>
            <h4 className="text-nowrap fw-bold mb-1">
              <Link href="/pages/profile" className="text-reset text-decoration-none">
                Damian D.
              </Link>
            </h4>
