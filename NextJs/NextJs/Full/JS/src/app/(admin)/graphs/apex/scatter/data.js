...
export const getBasicScatter = () => ({
  ...
  series: [{
    name: 'Device A',
    data: [[5, 3], [10, 15], [15, 7], [18, 5], [12, 8], [20, 12], [25, 6], [30, 10], [35, 4], [40, 13], [22, 9], [26, 7]]
  }, {
    name: 'Device B',
    data: [[6, 20], [12, 18], [14, 16], [17, 15], [19, 14], [21, 13], [23, 12], [25, 11], [28, 10], [30, 9], [32, 8], [34, 7]]
  }, {
    name: 'Device C',
    data: [[5, 8], [9, 7], [12, 6], [16, 5], [18, 4], [22, 3], [26, 2], [30, 1], [34, 0.5], [38, 0.2], [40, 0]]
  }],
...
export const getImageScatterChart = () => ({
  ...
  series: [{
    name: 'Microsoft',
    data: [[5, 10], [10, 14], [15, 11], [18, 16], [20, 9], [25, 18], [30, 12], [35, 14], [38, 17], [40, 13]]
  }, {
    name: 'Google',
    data: [[4, 6], [9, 10], [13, 12], [17, 9], [21, 13], [26, 11], [29, 15], [33, 8], [37, 16], [39, 14]]
  }],
  xaxis: {
    tickAmount: 10,
    min: 0,
