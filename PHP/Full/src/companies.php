...
<head>
    <?php $title = "Companies"; include 'partials/title-meta.php' ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Apps"; $title = "Companies"; include 'partials/page-title.php' ?>
                ...
                <div class="row">
                    <div class="col-xl-4 col-md-6">
                        <div class="card d-flex flex-row p-3">
                            <img src="assets/images/logos/amazon.svg" alt="Amazon Logo" class="avatar-xl me-3">
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card d-flex flex-row p-3">
                            <img src="assets/images/logos/apple.svg" alt="Apple Logo" class="avatar-xl me-3">
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card d-flex flex-row p-3">
                            <img src="assets/images/logos/walmart.svg" alt="Walmart Logo" class="avatar-xl me-3">
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card d-flex flex-row align-items-center p-3">
                            <img src="assets/images/logos/starbucks.svg" alt="Starbucks Logo" class="avatar-xl me-3">
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card d-flex flex-row align-items-center p-3">
                            <img src="assets/images/logos/meta.svg" alt="Meta Logo" class="avatar-xl me-3">
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card d-flex flex-row align-items-center p-3">
                            <img src="assets/images/logos/spotify.svg" alt="Spotify Logo" class="avatar-xl me-3">
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card d-flex flex-row align-items-center p-3">
                            <img src="assets/images/logos/google.svg" alt="Google Logo" class="avatar-xl me-3">
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card d-flex flex-row align-items-center p-3">
                            <img src="assets/images/logos/airbnb.svg" alt="Airbnb Logo" class="avatar-xl me-3">
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
                    ...
                    <div class="col-xl-4 col-md-6">
                        <div class="card d-flex flex-row align-items-center p-3">
                            <img src="assets/images/logos/shell.svg" alt="Shell Logo" class="avatar-xl me-3">
                            <div class="flex-grow-1">
                                <div class="d-flex justify-content-between align-items-start">
                                    <div>
