                                ...
                                <BCardBody class="p-4">
                                    <div class="d-flex justify-content-between align-items-center mb-4">
                                        ...
                                        <div class="border rounded position-relative d-flex text-center align-items-center justify-content-between px-2"
                                            ...
                                            <NuxtImg id="preview" src="/images/logo-black.png" alt="Company Logo"
                                                height="28" />
                                            <Icon name="tabler:upload" class="fs-xxl text-muted" role="button" />
                                        </div>
                                        ...
                                        <div class="text-end">
                                            <BRow class="g-2 align-items-center">
                                                <div class="col-auto">
                                                    <label for="invoiceNumber" class="form-label fw-semibold">Invoice
                                                        #</label>
                                    ...
                                    <BRow>
                                        <BCol md="4">
                                            ...
                                            <FlatPickr type="text" id="invoiceDate" class="form-control"
                                                placeholder="Select Date"/>
                                        </BCol>
                                        <BCol md="4">
                                            <label for="dueDate" class="form-label">Due Date</label>
                                            <FlatPickr type="text" id="dueDate" class="form-control"
                                                 placeholder="Select Date"/>
                                        </BCol>
                                        <BCol md="4" >
                                        ...
                                        <table class="table table-bordered table-nowrap text-center align-middle">
                                            ...
                                            <tbody id="invoice-items">
                                                <tr>
                                                    ...
                                                    <td><button type="button" class="btn btn-sm btn-danger">×</button>
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
                            ...
                            <BCardBody>
                                <div class="justify-content-center d-flex flex-column gap-2">
                                    <BButton variant="light">
                                        <Icon name="tabler:eye" class="me-1" />
                                        Preview
                                    </BButton>
                                    <BButton variant="light">
