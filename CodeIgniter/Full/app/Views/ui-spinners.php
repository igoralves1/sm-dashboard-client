...
<head>
    ...
    <link rel="stylesheet" href="plugins/spinkit/spinkit.min.css">
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                <?php echo view("./partials/page-title", array("subtitle" => "UI", "title" => "Spinners")) ?>
            </div>
            <!-- container -->
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a class="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/components/spinners/" target="_blank">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <div class="flex-grow-1">
                                    <h4 class="card-title">SpinKit <span class="badge badge-soft-warning">CSS Based Plugin</span></h4>
                                </div>
                                <div class="card-action">
                                    <a href="https://tobiasahlin.com/spinkit/" target="_blank" class="card-action-item"><i class="ti ti-external-link"></i></a>
                                    <a href="#!" class="card-action-item" data-action="card-toggle"><i class="ti ti-chevron-up"></i></a>
                                    <a href="#!" class="card-action-item" data-action="code-collapse"><i class="ti ti-code"></i></a>
                                </div>
                            </div>
