...
const ImagesShapes = () => {
  return <ComponentCard title="Images Shapes">
...
const AvatarSizes = () => {
  return <ComponentCard title="Avatar Sizes">
...
const AvatarSizeswithRounded = () => {
  return <ComponentCard title="Avatar Sizes with Rounded">
      <Row className="text-center">
        <Col>
...
const AvatarGroups = () => {
  return <ComponentCard title="Avatar Groups">
      <Row className="">
        <Col xl={3}>
