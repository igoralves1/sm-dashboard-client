...
const StripedRowTable = () => {
  return <Card>
      <CardHeader className="justify-content-between">
        ...
        <Link href="https://react-bootstrap.netlify.app/docs/components/table#striped-rows" target="_blank" className="icon-link icon-link-hover link-secondary link-underline-secondarlink-secondary link-underline-opacity-25 fw-semibold">
