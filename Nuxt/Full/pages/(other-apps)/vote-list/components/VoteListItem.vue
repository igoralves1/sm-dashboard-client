<template>
    <div class="d-flex gap-4 align-items-center">
            ...
            <div class="vstack gap-1 text-center">
                <div>
                    <button class="btn p-0" :class="props.item.userVote === 'up' ? 'text-danger' : 'btn-link'"
                        ...
                        <Icon name="tabler:chevron-up" class="fs-xxl" />
                    </button>
                </div>
                ...
                <div>
                    <button class="btn p-0" :class="props.item.userVote === 'down' ? 'text-danger' : 'btn-link'"
                        :disabled="!item.canVote">
                        <Icon name="tabler:chevron-down" class="fs-xxl" />
                    </button>
                </div>
            </div>
        </div>
        ...
        <div class="flex-grow-1">
            <h4 class="fs-md mb-1">
                <NuxtLink to="" class="link-reset">{{ item.title }}</NuxtLink>
            </h4>
            ...
            <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                <span class="d-flex align-items-center gap-1">
                    <NuxtImg :src="item.image" height="24" width="24" alt=""
                ...
                <span class="d-flex align-items-center gap-1">
                    ...
                    <NuxtLink href="" class="link-reset">Comments: {{ item.comments }}</NuxtLink>
                </span>
        ...
        <div v-if="props.item.userVote">
            <BTooltip placement="top">
                ...
                <template #target>
                    <Icon name="tabler:checks" class="ms-auto fs-36 text-success text-opacity-25" />
                </template>
            </BTooltip>
        </div>
    </div>
