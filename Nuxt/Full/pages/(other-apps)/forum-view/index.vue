            ...
            <BCol xxl="10">
                <BRow>
                    <BCol xl="9">
                        ...
                        <BPagination v-model="currentPage" :total-rows="100" :per-page="10"
                          first-number last-number  class="pagination-rounded pagination-boxed justify-content-center mt-3">
                            <template #prev-text>
                            ...
                            <BCardBody class="border-bottom border-dashed">
                                ...
                                <ul class="list-group list-group-flush fs-sm">
                                    <li v-for="(item, idx) in categories" :key="idx" class="list-group-item ps-0">
                                        <NuxtLink :to="item.url" class="link-reset fw-medium">
                                            {{ item.title }}
                                        </NuxtLink>
                                    </li>
                                </ul>
                            ...
                            <BCardBody class="border-bottom border-dashed">
                                ...
                                <ul class="list-group list-group-flush fs-sm">
                                    <li v-for="(question, idx) in questions" :key="idx" class="list-group-item ps-0">
                                        <NuxtLink :to="question.url" class="link-reset fw-medium">
                                            {{ question.title }}
                                        </NuxtLink>
                                    </li>
                                </ul>
