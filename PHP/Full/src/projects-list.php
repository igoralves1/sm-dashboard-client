...
<head>
    <?php $title = "Projects List"; include 'partials/title-meta.php' ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Apps"; $title = "Projects List"; include 'partials/page-title.php' ?>
                        ...
                        <div data-table data-table-rows-per-page="8" class="card">
                            <div class="card-header border-light justify-content-between">
                                ...
                                <div class="d-flex gap-1">
                                    <a href="projects.php" class="btn btn-soft-primary btn-icon">
                                        <i data-lucide="layout-grid" class="fs-lg"></i>
                                    </a>
                                    <a href="projects-list.php" class="btn btn-primary btn-icon">
                                        ...
                                        <tr>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1 d-flex align-items-center">
                                                            <a data-sort="project" href="project-details.php" class="link-reset">AI Analytics
                                                                Dashboard</a>
                                                        </h5>
                                            ...
                                            <td>
                                                <div class="avatar-group avatar-group-xs">
                                                    ...
                                                    <div class="avatar">
                                                        <img src="assets/images/users/user-5.jpg" alt="" class="rounded-circle avatar-xs">
                                                    </div>
                                                    <div class="avatar">
                                                        <img src="assets/images/users/user-1.jpg" alt="" class="rounded-circle avatar-xs">
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1 d-flex align-items-center">
                                                            <a data-sort="project" href="project-details.php" class="link-reset">E-commerce
                                                                Platform</a>
                                                        </h5>
                                            ...
                                            <td>
                                                <div class="avatar-group avatar-group-xs">
                                                    <div class="avatar"><img src="assets/images/users/user-6.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-8.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-7.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1 d-flex align-items-center">
                                                            <a data-sort="project" href="project-details.php" class="link-reset">UI Kit Design</a>
                                                        </h5>
                                            ...
                                            <td>
                                                <div class="avatar-group avatar-group-xs">
                                                    <div class="avatar"><img src="assets/images/users/user-4.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1 d-flex align-items-center">
                                                            <a data-sort="project" href="project-details.php" class="link-reset">Website
                                                                Redesign</a>
                                                        </h5>
                                            ...
                                            <td>
                                                <div class="avatar-group avatar-group-xs">
                                                    <div class="avatar"><img src="assets/images/users/user-2.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-7.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-9.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1 d-flex align-items-center">
                                                            <a data-sort="project" href="project-details.php" class="link-reset">Marketing
                                                                Report</a>
                                                        </h5>
                                            ...
                                            <td>
                                                <div class="avatar-group avatar-group-xs">
                                                    <div class="avatar"><img src="assets/images/users/user-5.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-10.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-8.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-2.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1 d-flex align-items-center">
                                                            <a data-sort="project" href="project-details.php" class="link-reset">Sales Pitch
                                                                Deck</a>
                                                        </h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1 d-flex align-items-center">
                                                            <a data-sort="project" href="project-details.php" class="link-reset">Mobile UI
                                                                Mockups</a>
                                                        </h5>
                                            ...
                                            <td>
                                                <div class="avatar-group avatar-group-xs">
                                                    ...
                                                    <div class="avatar"><img src="assets/images/users/user-4.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-5.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                    <div class="avatar"><img src="assets/images/users/user-1.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                </div>
                                            </td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1 d-flex align-items-center">
                                                            <a data-sort="project" href="project-details.php" class="link-reset">Server
                                                                Maintenance</a>
                                                        </h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1 d-flex align-items-center">
                                                            <a data-sort="project" href="project-details.php" class="link-reset">Security Audit</a>
                                                        </h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-1 d-flex align-items-center">
                                                            <a data-sort="project" href="project-details.php" class="link-reset">Plugin
                                                                Development</a>
                                                        </h5>
                                            ...
                                            <td>
                                                <div class="avatar-group avatar-group-xs">
                                                    <div class="avatar"><img src="assets/images/users/user-3.jpg" class="rounded-circle avatar-xs" alt="user-img"></div>
                                                </div>
                                            </td>
