...
<head>
    <?php echo view("partials/title-meta", array("title" => "404 Error")) ?>
            ...
            <div class="row justify-content-center">
                <div class="col-xxl-4 col-md-6 col-sm-8">
                    ...
                    <div class="p-2 text-center">
                        ...
                        <button class="btn btn-primary mt-3 rounded-pill" onclick="window.location.href='index'">Go Home</button>
