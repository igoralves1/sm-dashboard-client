<template>
    <UICard title="Complete Table" body-class="p-0">
        ...
        <BCardHeader class="border-light justify-content-between">
            ...
            <div class="d-flex align-items-center gap-2">
                ...
                <div class="app-search">
                    ...
                    <Icon name="lucide:box" class="app-search-icon text-muted" />
                </div>
                ...
                <div class="app-search">
                    ...
                    <Icon name="lucide:dollar-sign" class="app-search-icon text-muted" />
                </div>
        ...
        <BTable show-empty :filter="searchQuery" empty-text="Nothing found." v-model:selected-rows="selected"
            ...
            <template #cell(name)="{ item }">
                <div class="d-flex">
                    <div class="avatar-md me-3">
                        <NuxtImg :src="item.image" alt="Product" class="img-fluid rounded" />
                    </div>
                    <div>
                        <h5 class="mb-1">
                            <NuxtLink :to="`/products/${item.id}`" class="link-reset">{{ item.name }}</NuxtLink>
                        </h5>
            ...
            <template #cell(rating)="{ item }">
                ...
                <span class="ms-1">
                    <NuxtLink to="/reviews" class="link-reset fw-semibold">({{ item.reviews }})</NuxtLink>
                </span>
            </template>
