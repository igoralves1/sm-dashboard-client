...
export const statisticCardData = [{
  title: 'Total Sales',
  badgeColor: 'success',
  badgeText: 'Monthly',
  count: {
...
export const getStatisticChartOptions = () => {
...
export const statisticsData = [{
  ...
  chartOptions: () => ({
    ...
    xAxis: {
      type: 'category',
      data: generateBarData().map(d => d.name),
      show: false
    },
    yAxis: {
      type: 'value',
  ...
  chartOptions: () => ({
    ...
    xAxis: {
      type: 'category',
      data: generateAreaData().map((_, index) => `Label ${index + 1}`),
      // Use dynamic labels
      show: false
    },
    yAxis: {
...
export const getOrderChartOptions = () => ({
  legend: {
    show: false
  },
  tooltip: {
...
export const getProductsChartOptions = () => {
  return {
    tooltip: {
      trigger: 'axis',
      padding: [5, 0],
