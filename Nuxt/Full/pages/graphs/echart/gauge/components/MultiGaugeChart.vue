<template>
  <ClientOnly>
    <VChart
      ...
      :extensions="[GaugeChart, CanvasRenderer, TooltipComponent]"
...
import { getMultiGaugeChart, setTemperatureChartInstance } from '../data'
...
const value = ref(options.value.series[0].data[0].value)
