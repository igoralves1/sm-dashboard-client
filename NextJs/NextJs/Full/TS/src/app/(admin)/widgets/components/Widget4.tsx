import { Widget4Type } from '@/app/(admin)/widgets/types'
        ...
        <div className="d-flex justify-content-between align-items-center">
          ...
          <div className="text-end">
            <h3 className="mb-2 fw-normal">
              <CountUpClient end={count.value} prefix={count.prefix} suffix={count.suffix} duration={1} enableScrollSpy scrollSpyOnce />
            </h3>
