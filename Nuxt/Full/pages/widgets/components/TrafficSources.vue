<template>
  <UICard title="Traffic Sources" isCloseable isCollapsable isReloadable>
    <BRow class="mb-2">
      ...
      <BCol lg="auto" class="align-self-center">
        <ul class="list-unstyled mb-0 lh-lg">
          <li>
            <Icon name="tabler:caret-right-filled" class="align-middle text-primary me-1" />
            <span class="text-muted">Organic</span>
          </li>
          <li>
            <Icon name="tabler:caret-right-filled" class="align-middle text-success me-1" />
            <span class="text-muted">Direct</span>
          </li>
          <li>
            <Icon name="tabler:caret-right-filled" class="align-middle me-1" />
    ...
    <div class="table-responsive">
      <BTableSimple small hover striped responsive class="table-custom table-nowrap table-centered mb-0">
    ...
    <div class="text-end mt-3">
      <NuxtLink to="/chat" class="link-reset text-decoration-underline fw-semibold link-offset-3">
        View all Links <Icon name="tabler:link" width="13" />
      </NuxtLink>
    </div>
  </UICard>
</template>
...
import { BRow, BCol, BProgress, BTable, BTableSimple, BProgressBar } from 'bootstrap-vue-next'
