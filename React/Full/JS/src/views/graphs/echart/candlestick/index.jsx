      ...
      <Row>
        <Col xl={12}>
          <ComponentCard title="Basic Candlestick Chart">
            <CustomEChart extensions={[CandlestickChart, CanvasRenderer]} getOptions={getBasicCandlestickChart} style={{
            height: '400px'
          }} />
          </ComponentCard>
        </Col>
        ...
        <Col xl={12}>
          <ComponentCard title="Mixed Candlestick Chart">
            <CustomEChart extensions={[CandlestickChart, CanvasRenderer]} getOptions={getMixedCandlestickChart} style={{
            height: '400px'
          }} />
          </ComponentCard>
        </Col>
