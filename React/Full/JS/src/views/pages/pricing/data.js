...
export const pricingPlans = [{
  ...
  features: [{
    ...
    icon: TbCheck,
    name: 'Access to basic components',
    variant: 'success'
  }, {
    icon: TbCheck,
  ...
  features: [{
    icon: TbCheck,
    name: '3 user licenses',
    variant: 'success'
  }, {
    icon: TbCheck,
    name: 'Full component access',
    variant: 'success'
  }, {
    icon: TbCheck,
    name: 'Commercial project rights',
    variant: 'success'
  }, {
    icon: TbCheck,
    name: 'Email support',
  ...
  features: [{
    ...
    icon: TbCheck,
    name: 'All premium components & layouts',
    variant: 'success'
  }, {
    icon: TbCheck,
    name: 'Commercial & SaaS usage rights',
    variant: 'success'
  }, {
    icon: TbCheck,
    name: 'Dedicated support & onboarding',
    variant: 'success'
  }, {
    icon: TbCheck,
    name: 'Custom Figma UI kits',
    variant: 'success'
  }, {
    icon: TbCheck,
