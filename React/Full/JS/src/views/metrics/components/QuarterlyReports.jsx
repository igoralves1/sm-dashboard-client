...
import { quarterlyReports } from '@/views/metrics/data';
import CustomEChart from '@/components/CustomEChart';
import { getPieEchartOptions } from '@/views/dashboards/dashboard/data';
          ...
          <tbody>
            {quarterlyReports.map(report => <tr key={report.id}>
              ...
              width: 60
                  ...
                  <div dir="ltr">
                    <CustomEChart extensions={[PieChart, TooltipComponent, CanvasRenderer]} getOptions={getPieEchartOptions} style={{
                  height: 30,
                  width: 30
                }} />
                  </div>
