import { expandedActivities } from '@/app/(admin)/(apps)/(projects)/activity-stream/data';
  ...
  return <Card className="card-h-100">
      ...
      <CardBody>
        <div className="timeline timeline-icon-bordered">
          ...
          return <div className="timeline-item d-flex align-items-stretch" key={idx}>
                ...
                <div className="timeline-content ps-3 pb-3">
                  ...
                  <div className="d-flex align-items-center gap-2">
                    <Image src={event.avatar} alt={event.name} className="rounded-circle avatar-xxs" />
                    <Link href={event.profileUrl} className="fw-semibold link-reset">
                      {event.name}
                    </Link>
                  </div>
                </div>
