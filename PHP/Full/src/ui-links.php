...
<head>
    <?php $title = "Links"; include 'partials/title-meta.php' ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                <?php $subtitle = "UI"; $title = "Links"; include 'partials/page-title.php';?>
            </div>
            <!-- container -->
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <a class="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/helpers/colored-links/" target="_blank">
                                    Links on Bootstrap
