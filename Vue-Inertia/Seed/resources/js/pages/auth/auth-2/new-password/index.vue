                ...
                <div class="card-body">
                  ...
                  <form>
                    <div class="mb-3">
                      ...
                      <div class="input-group">
                        <span class="input-group-text bg-light">
                          <Icon icon="tabler:mail" class="text-muted fs-xl" />
                        </span>
                        <BFormInput
                          type="email"
                          id="userEmail"
                      ...
                      <div class="input-group">
                        <span class="input-group-text bg-light">
                          <Icon
                            ...
                            class="ti ti-lock text-muted fs-xl"
                          ></Icon>
                        </span>
                        <BFormInput
                          type="password"
                    ...
                    <div class="mb-3">
                      ...
                      <div class="input-group">
                        <span class="input-group-text bg-light">
                          <Icon icon="tabler:lock-password" class="text-muted fs-xl" />
                        </span>
                        <BFormInput
                          type="password"
                          id="confirmPassword"
                    ...
                    <div class="d-grid">
                      <BButton type="submit" variant="primary" class="fw-semibold py-2"
                        >Update Password</BButton
                      >
                    </div>
                  </form>
                  ...
                  <p class="mt-4 text-muted text-center mb-4">
                    Don’t have a code?
                    <Link to="" class="text-decoration-underline link-offset-2 fw-semibold"
                      >Resend</Link
                    >
                    or
                    <Link href="" class="text-decoration-underline link-offset-2 fw-semibold"
                      >Call Us</Link
                    >
                  </p>
