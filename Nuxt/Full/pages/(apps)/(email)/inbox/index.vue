                                ...
                                <tr v-for="email in filteredEmails" :key="email.id"
                                    ...
                                    <td class="ps-3" style="width: 1%">
                                        <div class="d-flex gap-3">
                                            ...
                                            <button class="btn p-0 fs-xl">
                                                <Icon name="tabler:star-filled" v-if="email.isStarred"
                                                    class="text-warning" />
                                                <Icon name="tabler:star" v-else class="text-muted" />
                                            </button>
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex align-items-center gap-2">
                                            <NuxtImg v-if="email.avatar" :src="email.avatar" alt="user avatar"
