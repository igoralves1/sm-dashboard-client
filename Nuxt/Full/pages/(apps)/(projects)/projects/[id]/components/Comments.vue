    ...
    <div>
        ...
        <div v-for="(comment, idx) in comments" :key="idx" class="d-flex border border-dashed rounded p-3"
            ...
            <div class="flex-shrink-0">
                <NuxtImg :src="comment.avatar" alt="comment-avatar" class="avatar-sm rounded-circle shadow-sm" />
            </div>
            ...
            <div class="flex-grow-1 ms-2">
                ...
                <NuxtLink to="#" class="badge bg-light text-muted d-inline-flex align-items-center gap-1">
                ...
                <div v-if="comment.reply">
                    <div v-for="(reply, i) in comment.reply" :key="i" class="d-flex mt-4">
                        <div class="flex-shrink-0">
                            <NuxtImg :src="reply.avatar" alt="reply-avatar"
