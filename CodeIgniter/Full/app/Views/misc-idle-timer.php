...
<head>
    <?php echo view("partials/title-meta", array("title" => "Idle Timer")) ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "Miscellaneous", "title" => "Idle Timer")) ?>
    ...
    <script src="/js/pages/misc-idle-timer.js"></script>
