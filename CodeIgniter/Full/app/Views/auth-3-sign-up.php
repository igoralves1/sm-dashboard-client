...
<head>
    <?php echo view("partials/title-meta", array("title" => "Create New Account")) ?>
                ...
                <div class="card auth-box-form border-0 mb-0">
                    <div class="card-body min-vh-100 d-flex flex-column justify-content-center">
                        ...
                        <p class="text-muted text-center mt-4 mb-0">
                            Already have an account? <a href="auth-3-sign-in" class="text-decoration-underline link-offset-3 fw-semibold">Login</a>
                        </p>
