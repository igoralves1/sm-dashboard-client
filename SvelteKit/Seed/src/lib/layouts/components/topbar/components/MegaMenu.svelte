<script lang="ts">
	...
	import { Col, Dropdown, DropdownMenu, DropdownToggle, Row } from '@sveltestrap/sveltestrap';
...
<div class="topbar-item d-none d-md-flex">
	<Dropdown>
		<DropdownToggle nav class="topbar-link btn fw-medium btn-link">
			Boom Boom! 😍
			<Icon icon="tabler:chevron-down" class="ms-1" />
		</DropdownToggle>

		<DropdownMenu class="dropdown-menu-xxl p-0">
			<div class="h-100" style="max-height: 380px" data-simplebar>
				...
				<Row class="g-0">
					{#each megaMenuItems as item, idx (idx)}
						<Col md="4">
							<div class="p-3">
