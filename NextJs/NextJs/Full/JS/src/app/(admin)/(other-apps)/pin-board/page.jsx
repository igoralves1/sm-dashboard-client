          ...
          <Card className="bg-transparent">
            ...
            <CardBody>
              <div className="pin-board d-flex flex-wrap">
                {notes.map(note => <div key={note.id} className={`pin-board-item bg-${note.variant}-subtle`}>
