    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "Projects", "title" => "Project Overview")) ?>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="d-flex align-items-center gap-3 justify-content-md-end">
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="text-nowrap mb-0 lh-base"><a href="pages-profile" class="link-reset">Liam James</a></h5>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="d-flex align-items-center gap-3 justify-content-md-end">
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="text-nowrap mb-0 lh-base"><a href="pages-profile" class="link-reset">Sophia Lee</a></h5>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="d-flex align-items-center gap-3 justify-content-md-end">
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="text-nowrap mb-0 lh-base"><a href="pages-profile" class="link-reset">Noah Carter</a></h5>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="d-flex align-items-center gap-3 justify-content-md-end">
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="text-nowrap mb-0 lh-base"><a href="pages-profile" class="link-reset">Emily Davis</a></h5>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="d-flex align-items-center gap-3 justify-content-md-end">
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="text-nowrap mb-0 lh-base"><a href="pages-profile" class="link-reset">Lucas White</a></h5>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="d-flex align-items-center gap-3 justify-content-md-end">
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="text-nowrap mb-0 lh-base"><a href="pages-profile" class="link-reset">Olivia Martin</a></h5>
                                                                        </div>
                                                                    </div>
                                                            ...
                                                            <div class="col-md-6">
                                                                <div class="d-flex align-items-center gap-3 justify-content-md-end">
                                                                    <div class="d-flex align-items-center gap-1">
                                                                        ...
                                                                        <div>
                                                                            <h5 class="text-nowrap mb-0 lh-base"><a href="pages-profile" class="link-reset">Ethan Moore</a></h5>
                                                                        </div>
                                                                    </div>
                                        ...
                                        <div class="p-3 border-bottom border-dashed">
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <div class="d-flex align-items-center py-1 gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base"><a href="pages-profile" class="link-reset">Ava Brooks</a></h5>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <div class="d-flex align-items-center py-1 gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base"><a href="pages-profile" class="link-reset">Liam Carter</a></h5>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <div class="d-flex align-items-center py-1 gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base"><a href="pages-profile" class="link-reset">Noah Kim</a></h5>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <div class="d-flex align-items-center py-1 gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base"><a href="pages-profile" class="link-reset">Emma Watson</a></h5>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <div class="d-flex align-items-center py-1 gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base"><a href="pages-profile" class="link-reset">James Nolan</a></h5>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center pb-2">
                                                <div class="d-flex align-items-center py-1 gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base"><a href="pages-profile" class="link-reset">Olivia Reed</a></h5>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div class="d-flex align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base"><a href="pages-profile" class="link-reset">Daniel Craig</a></h5>
