...
import Activity from '@/app/(admin)/(apps)/(projects)/projects/[projectId]/components/Activity';
import Comments from '@/app/(admin)/(apps)/(projects)/projects/[projectId]/components/Comments';
import TaskList from '@/app/(admin)/(apps)/(projects)/projects/[projectId]/components/TaskList';
const ProjectTabs = () => {
  return <TabContainer defaultActiveKey="0">
