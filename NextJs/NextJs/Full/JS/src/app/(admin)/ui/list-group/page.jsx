...
import { TbBrandFigma, TbBrandGithub, TbBrandNotion, TbBrandSlack, TbBrandStripe, TbBrandTrello, TbBrandWindows, TbChevronRight, TbCloud, TbDeviceDesktopAnalytics } from 'react-icons/tb';
const BasicExample = () => {
  return <ComponentCard title="Basic Example">
...
const ActiveItems = () => {
  return <ComponentCard title="Active Items">
      <p className="text-muted">
...
const LinksAndButtons = () => {
  return <ComponentCard title="Links and Buttons">
      <p className="text-muted">
...
const Flush = () => {
  return <ComponentCard title="Flush">
      <p className="text-muted">
...
const Horizontal = () => {
  return <ComponentCard title="Horizontal">
      <p className="text-muted">
...
const ContextualClasses = () => {
  return <ComponentCard title="Contextual classes">
...
const ContextualClassesWithLink = () => {
  return <ComponentCard title="Contextual classes with Link">
      <p className="text-muted">Use contextual classes to style list items with a stateful background and color.</p>
      <ListGroup>
...
const CustomContent = () => {
  return <ComponentCard title="Custom content">
...
const WithBadges = () => {
  return <ComponentCard title="With badges">
...
const CheckboxesAndRadios = () => {
  return <ComponentCard title="Checkboxes and radios">
      <p className="text-muted">
...
const Numbered = () => {
  return <ComponentCard title="Numbered">
      <p className="text-muted">
      ...
      <ListGroup numbered as={'ol'}>
        <ListGroupItem className="d-flex justify-content-between align-items-start">
          <div className="ms-2 me-auto">
            <div className="fw-bold">INSPINIA Admin</div>
            INSPINIA Admin
          </div>
        ...
        <ListGroupItem className="d-flex justify-content-between align-items-start">
          <div className="ms-2 me-auto">
            <div className="fw-bold">INSPINIA React Admin</div>
              ...
              <Card>
                ...
                <CardBody>
                  <p className="text-muted mb-2">
                    List groups are a flexible and powerful component for displaying a series of content. Modify and extend them to support just about
                    any content within.
                  </p>
                  <Link className="btn btn-link p-0 fw-semibold" href="https://react-bootstrap.netlify.app/docs/components/list-group" target="_blank">
