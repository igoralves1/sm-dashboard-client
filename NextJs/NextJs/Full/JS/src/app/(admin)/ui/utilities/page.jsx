...
const ColorAndBackground = () => {
  return <ComponentCard title="Color & Background">
      ...
      <div className="d-flex flex-column gap-2">
        ...
        <div className="text-bg-purple p-2">Purple with contrasting color (.text-bg-purple)</div>
      </div>
    </ComponentCard>;
};
const BackgroundOpacity = () => {
  return <ComponentCard title="Background Opacity">
      <p className="text-muted">
...
const TextOpacityColor = () => {
  return <ComponentCard title="Text Opacity Color">
      <p className="text-muted">
...
const Opacity = () => {
  return <ComponentCard title="Opacity">
      <p className="text-muted">
...
const BorderRadius = () => {
  return <ComponentCard title="Border Radius">
...
const PointerEvents = () => {
  return <ComponentCard title="Pointer Events">
      <p className="text-muted">
...
const BorderRadiusSize = () => {
  return <ComponentCard title="Border Radius Siz">
      <p className="text-muted">
...
const TextSelection = () => {
  return <ComponentCard title="Text Selection">
      <p className="text-muted">
...
const Overflow = () => {
  return <ComponentCard title="Overflow">
      <p className="text-muted">
      ...
      <div className="d-flex flex-wrap gap-4">
        ...
        maxHeight: 100
          ...
          This is an example of using <code>.overflow-visible</code> on an element with set width and height add more text dimensions inspinia admin
          dashboard template.
        </div>
...
const PositionInArrange = () => {
  return <ComponentCard title="Position in Arrange">
      <p className="text-muted">
...
const PositionInCenter = () => {
  return <ComponentCard title="Position in Center">
      <p className="text-muted">
...
const PositionInAxis = () => {
  return <ComponentCard title="Position in Axis">
      <p className="text-muted">
...
const Shadows = () => {
  return <ComponentCard title="Shadows">
      <p className="text-muted">
...
const Width = () => {
  return <ComponentCard title="Width">
      <p className="text-muted">
...
const Height = () => {
  return <ComponentCard title="Height">
      <p className="text-muted">
...
const ObjectFit = () => {
  return <ComponentCard title="Object Fit">
      <p className="text-muted">
...
const Zindex = () => {
  return <ComponentCard title="Z-index">
      <p className="text-muted">
          ...
          <Row>
            <Col xs={12}>
              <Card>
                ...
                <CardBody>
                  <p className="text-muted mb-2">The utility API is a Sass-based tool to generate utility classes.</p>
                  <Link className="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/utilities/background/" target="_blank">
