...
import { datetimeData, getAreaChartDateTimeChart } from '@/app/(admin)/graphs/apex/area/data';
...
const DatetimeChart = () => {
  ...
  return <ComponentCard title="Area Chart - Datetime X-axis">
      ...
      <ApexChartClient getOptions={() => getAreaChartDateTimeChart(filteredData)} series={[{
      name: 'Inspinia',
      data: filteredData
