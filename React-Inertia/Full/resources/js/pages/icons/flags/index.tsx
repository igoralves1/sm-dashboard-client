...
import { countries, type CountryType } from '@/pages/icons/flags/data'
...
const Page = () => {
  const columns = [
    columnHelper.accessor('flag', {
      header: 'Flag',
      cell: ({ row }) => <img src={row.original.flag} alt={row.original.code} height={18} width={18} className="rounded" />,
    }),
    ...
    {
      header: 'Path',
      cell: ({ row }: { row: TableRow<CountryType> }) => <>@/images/flags/{row.original.code}.svg</>,
    },
