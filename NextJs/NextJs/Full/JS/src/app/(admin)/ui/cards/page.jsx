...
const CardWithBackgroundGradient = () => {
  return <Card className="text-bg-purple bg-gradient">
      <CardBody>
        <CardTitle as={'h5'} className="mb-2">
...
const CardWithStartBorder = () => {
  return <Card className="card-bordered">
      <CardBody>
        <CardTitle as={'h5'} className="mb-2">
          Card with Double Border
        </CardTitle>
...
const CardWithColored = () => {
  return <Card className="border-primary card-bordered">
      <CardBody>
...
const CardColoredBorder = () => {
  return <Card className="border-info card-bordered">
      <CardBody>
        <CardTitle as={'h5'} className="mb-2">
          Card with Colored Border
        </CardTitle>
