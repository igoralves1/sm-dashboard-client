                ...
                <BCard no-body>
                    <BCardHeader class="border-light d-flex align-items-center justify-content-between flex-wrap gap-2">
                        ...
                        <div class="d-flex align-items-center gap-5">
                            ...
                            <NuxtLink href="" class="btn btn-primary">
                                <Icon name="lucide:plus" class="fs-sm me-1" /> Add Customer
                            </NuxtLink>
                        </div>
                    </BCardHeader>
                        ...
                        <template #cell(name)="{ item }">
                            <div class="d-flex align-items-center gap-2">
                                <div class="avatar avatar-sm">
                                    <NuxtImg :src="item.avatar" alt="avatar-7" class="img-fluid rounded-circle" />
                                </div>
                                <div>
                                    <h5 class="mb-0">
                                        <NuxtLink href="/pages/profilez" class="link-reset">{{ item.name }}</NuxtLink>
                                    </h5>
                                </div>
                            </div>
                        </template>
                        <template #cell(country)="{ item }">
                            <NuxtImg :src="item.countryFlag" alt="" class="rounded-circle me-1" height="16" />
                            {{ item.country }}
                        </template>
