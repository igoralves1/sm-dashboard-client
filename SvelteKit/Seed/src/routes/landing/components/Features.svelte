<script lang="ts">
	...
	import chat from '$lib/assets/images/chat.png';
	import file from '$lib/assets/images/file-manager.png';
	import team from '$lib/assets/images/team.png';
...
<section
	class="section-custom bg-light bg-opacity-30 border-top border-light border-bottom"
	id="features"
>
	<Container>
		<Row class="align-items-center pb-5">
			<Col lg="6" xl="5" class="py-3">
			...
			<Col lg="5" class="ms-auto py-3">
				<h2 class="mb-4 lh-base">Connecting conversations across the world</h2>
				<p class="mb-2 lead">
					Fast, secure, and intuitive—our chat platform empowers teams and communities to
					communicate effortlessly.
				</p>
				<p class="text-muted fs-sm mb-4">
					Experience seamless messaging with built-in privacy features and unmatched reliability.
				</p>
				<Button color="primary" class="mb-4">Check Chat App</Button>

				<div class="d-flex flex-wrap justify-content-between gap-4 mt-4">
					{#each stats1 as stat, idx (idx)}
						<div>
							<h3 class="mb-2">
								<CustomCounter
									end={stat.value}
		...
		<Row class="align-items-center py-5">
			<Col lg="5" class="py-5 order-2 order-lg-1">
				<h2 class="mb-4 lh-base">Manage your files seamlessly from anywhere</h2>
				<p class="mb-2 lead">
					A powerful, secure, and intuitive file manager built for individuals and teams.
				</p>
				<p class="text-muted fs-sm mb-4">
					Access files instantly and enjoy peace of mind with encrypted storage.
				</p>
				<Button color="primary" class="mb-4">Explore File Manager</Button>

				<div class="d-flex flex-wrap justify-content-between gap-4 mt-4">
					{#each stats2 as stat, idx (idx)}
						<div>
							<h3 class="mb-2">
								<CustomCounter
									end={stat.value}
			...
			<Col lg="6" xl="5" class="ms-auto py-5 order-1 order-lg-2">
				<div class="position-relative">
					<figure class="position-absolute top-0 start-0 translate-middle mt-5 opacity-25">
						<svg
							width="111"
		...
		<Row class="align-items-center py-5">
			...
			<Col lg="5" class="ms-auto py-3">
				...
				<p class="mb-2 lead">
					Our smart contacts app keeps all your relationships organized and accessible across
					devices.
				</p>
				<p class="text-muted fs-sm mb-4">
					Effortlessly import, categorize, and interact with contacts securely.
				</p>
				<Button color="primary" class="mb-4">Check Contacts App</Button>
