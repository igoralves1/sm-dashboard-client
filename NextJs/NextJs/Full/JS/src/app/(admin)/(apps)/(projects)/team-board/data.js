...
import { TbActivity, TbAward, TbBrush, TbCalculator, TbChartArcs, TbChartBar, TbCode, TbCurrencyBitcoin, TbCurrencyEuro, TbLayoutKanban, TbPhoto, TbSettings, TbShieldCheck, TbSpeakerphone, TbTrendingUp, TbWallet } from 'react-icons/tb';
export const teams = [{
  id: 1,
  name: 'Design Team',
