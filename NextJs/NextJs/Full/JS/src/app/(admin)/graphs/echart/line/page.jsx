      ...
      <Row>
        <Col xl={6}>
          <ComponentCard title="Line Chart">
            <EChartClient extensions={[LinesChart, CanvasRenderer]} getOptions={getLineChart} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
        <Col xl={6}>
          <ComponentCard title="Line Stacked Chart">
            <EChartClient extensions={[LinesChart, CanvasRenderer]} getOptions={getStackedLineChart} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
        <Col xl={6}>
          <ComponentCard title="Line Marker">
            <EChartClient extensions={[LinesChart, CanvasRenderer]} getOptions={getLineMarkerChart} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
        ...
        <Col xl={6}>
          <ComponentCard title="Step Line">
            <EChartClient extensions={[LinesChart, CanvasRenderer]} getOptions={getStepLine} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
        ...
        <Col xl={6}>
          <ComponentCard title="Line Y Category">
            <EChartClient extensions={[LinesChart, CanvasRenderer]} getOptions={getLineYCategory} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
