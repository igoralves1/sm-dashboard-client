      ...
      <Row>
        <Col xl={6}>
          <ComponentCard title="Area Chart">
            <EChartClient extensions={[LineChart, CanvasRenderer]} getOptions={getAreaChart} style={{ height: '300px' }} />
          </ComponentCard>
        </Col>
        <Col xl={6}>
          <ComponentCard title="Stacked Area Chart">
            <EChartClient extensions={[LineChart, CanvasRenderer]} getOptions={getStackedAreaChart} style={{ height: '300px' }} />
          </ComponentCard>
        </Col>
        <Col xl={6}>
          <ComponentCard title="Area with Marker">
            <EChartClient extensions={[LineChart, CanvasRenderer]} getOptions={getAreawithMarkerChart} style={{ height: '300px' }} />
          </ComponentCard>
        </Col>
        <Col xl={6}>
          <DynamicAreaChart />
        ...
        <Col xl={6}>
          <ComponentCard title="Step Area">
            <EChartClient extensions={[LineChart, CanvasRenderer]} getOptions={getStepAreaChart} style={{ height: '300px' }} />
          </ComponentCard>
        </Col>
      </Row>
    </Container>
