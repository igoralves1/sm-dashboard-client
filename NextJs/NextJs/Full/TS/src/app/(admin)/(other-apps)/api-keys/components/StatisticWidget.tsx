import { StatisticsWidgetType } from '@/app/(admin)/(other-apps)/api-keys/data'
  ...
  return (
    <Card>
      <CardBody>
        ...
        {item.chartOptions && (
          <div className="mt-3">
            <ApexChartClient getOptions={item.chartOptions} series={item.chartOptions().series} type="area" height={60} />
          </div>
        )}
      </CardBody>
    </Card>
