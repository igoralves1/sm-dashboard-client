...
const ProductViews = () => {
  const columns = [{
    ...
    cell: ({
      row
    }) => <CustomApexChart getOptions={() => getReportsChartOptions(row.original.chartType)} series={getReportsChartOptions(row.original.chartType).series} type={row.original.chartType} width={100} height={30} />
  })];
