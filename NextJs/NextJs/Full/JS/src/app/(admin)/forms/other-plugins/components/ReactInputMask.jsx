...
const ReactInputMask = () => {
  return <Card>
      ...
      <CardBody>
        ...
        <Link className="btn btn-link p-0 fw-semibold" href="https://s-yadav.github.io/react-number-format/" target="_blank">
          React Number Format
      ...
      <CardBody>
        ...
        <Row className="g-3">
          ...
          <Col lg={6}>
            <NumericFormatClient className="form-control" thousandSeparator="." decimalSeparator="," decimalScale={2} fixedDecimalScale allowNegative={false} />
          </Col>
        </Row>
        ...
        <Row className="g-3">
          ...
          <Col lg={6}>
            <NumericFormatClient className="form-control" thousandSeparator="." decimalSeparator="," decimalScale={2} fixedDecimalScale prefix={currency} allowNegative={false} />
          </Col>
        </Row>
