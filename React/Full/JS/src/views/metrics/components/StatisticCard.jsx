...
import { getStatisticChartOptions } from '@/views/metrics/data';
      ...
      <CardBody>
        <div className="d-flex justify-content-between align-items-center text-nowrap">
          <div className="flex-grow-1">
            <CustomEChart extensions={[PieChart, TooltipComponent, CanvasRenderer]} getOptions={getStatisticChartOptions} style={{
            height: 60,
            width: 60
          }} />
          </div>
