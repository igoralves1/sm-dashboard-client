...
import { profitChartOptions } from '@/views/metrics/data';
const ProfitOverviewChart = () => {
  return <Card>
      <CardBody>
        ...
        <CustomEChart extensions={[LineChart, TooltipComponent, CanvasRenderer]} getOptions={profitChartOptions} style={{
        height: 120
      }} />
      </CardBody>
    </Card>;
