...
<head>
    <?php $title = "Dashboard 3"; include 'partials/title-meta.php' ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $title = "Dashboard 3"; include 'partials/page-title.php' ?>
                ...
                <div class="d-block">
                    <div class="p-3 border-bottom">
                        ...
                        <a href="#" class="d-block py-2">
                            ...
                            <span class="d-flex align-items-center">
                                <span class="flex-shrink-0">
                                    <img src="assets/images/users/user-3.jpg" alt="Lucas Miller" class="avatar-sm rounded-circle">
                                </span>
                        ...
                        <a href="#" class="d-block py-2">
                            ...
                            <span class="d-flex align-items-center">
                                <span class="flex-shrink-0">
                                    <img src="assets/images/users/user-4.jpg" alt="Amelia Green" class="avatar-sm rounded-circle">
                                </span>
                                <span class="flex-grow-1 ms-2 text-truncate">
                        ...
                        <a href="#" class="d-block py-2">
                            ...
                            <span class="d-flex align-items-center">
                                <span class="flex-shrink-0">
                                    <img src="assets/images/users/user-6.jpg" alt="Noah Smith" class="avatar-sm rounded-circle">
                                </span>
                                <span class="flex-grow-1 ms-2 text-truncate">
                        ...
                        <a href="#" class="d-block py-2">
                            ...
                            <span class="d-flex align-items-center">
                                <span class="flex-shrink-0">
                                    <img src="assets/images/users/user-7.jpg" alt="Emma Johnson" class="avatar-sm rounded-circle">
                                </span>
                                <span class="flex-grow-1 ms-2 text-truncate">
