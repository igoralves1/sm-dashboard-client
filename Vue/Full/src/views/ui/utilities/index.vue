            ...
            <BRow>
                ...
                <BCol xl="4">
                    <UICard title="Border Radius" isCollapsable>
                        <div class="d-flex align-items-start flex-wrap gap-2">
                            <img :src="user2" class="avatar-lg rounded" alt="rounded" />
                            <img :src="user2" class="avatar-lg rounded-top" alt="rounded-top" />
                            <img :src="user2" class="avatar-lg rounded-end" alt="rounded-end" />
                            <img :src="user2" class="avatar-lg rounded-bottom" alt="rounded-bottom" />
                            <img :src="user2" class="avatar-lg rounded-start" alt="rounded-start" />
                            <img :src="user2" class="avatar-lg rounded-circle" alt="rounded-circle" />
                            <img :src="small3" class="rounded-pill" alt="rounded-pill" width="80" />
                        </div>
                    </UICard>
                ...
                <BCol xl="4">
                    <UICard title="Border Radius Size" isCollapsable>
                        ...
                        <div class="d-flex align-items-start flex-wrap gap-2">
                            <img :src="user4" class="avatar-lg rounded-0" alt="rounded-0" />
                            <img :src="user4" class="avatar-lg rounded-1" alt="rounded-1" />
                            <img :src="user4" class="avatar-lg rounded-2" alt="rounded-2" />
                            <img :src="user4" class="avatar-lg rounded-3" alt="rounded-3" />
                            <img :src="user4" class="avatar-lg rounded-4" alt="rounded-4" />
                            <img :src="user4" class="avatar-lg rounded-5" alt="rounded-5" />
                        </div>
                    </UICard>
                </BCol>
                        ...
                        <div card-body>
                            ...
                            <div class="d-flex flex-wrap gap-4">
                                ...
                                <div class="overflow-visible p-3 bg-light" style="max-width: 260px; max-height: 100px;">
                                    ...
                                    with set width and height add more text dimensions inspinia admin dashboard
                                    template.
                                </div>
