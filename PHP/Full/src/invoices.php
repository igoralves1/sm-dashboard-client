                        ...
                        <div data-table data-table-rows-per-page="8" class="card">
                            <div class="card-header border-light justify-content-between">
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="invoice-create.php" class="btn btn-purple rounded-circle btn-icon"><i class="ti ti-plus fs-lg"></i></a>
                                </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="m-0">
                                                    ...
                                                    <a href="invoice-details.php" class="link-reset fw-semibold">#INS-0120010</a>
                                                </h5>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Emily
                                                                Parker</a>
                                                        </h5>
                                            ...
                                            <td>
                                                <div class="d-flex align-items-center justify-content-center gap-1">
                                                    <a href="invoice-details.php" class="btn btn-light btn-icon btn-sm rounded-circle"><i class="ti ti-eye fs-lg"></i></a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="m-0">
                                                    ...
                                                    <a href="invoice-details.php" class="link-reset fw-semibold">#INS-0120009</a>
                                                </h5>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Michael
                                                                Scott</a>
                                                        </h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="m-0">
                                                    ...
                                                    <a href="invoice-details.php" class="link-reset fw-semibold">#INS-0120008</a>
                                                </h5>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Samantha
                                                                Reed</a>
                                                        </h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="m-0">
                                                    ...
                                                    <a href="invoice-details.php" class="link-reset fw-semibold">#INS-0120007</a>
                                                </h5>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Jonathan
                                                                Lee</a>
                                                        </h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="m-0">
                                                    <span class="ti ti-file-invoice text-success fs-lg"></span>
                                                    <a href="invoice-details.php" class="link-reset fw-semibold">#INS-0120006</a>
                                                </h5>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Carlos
                                                                Diaz</a>
                                                        </h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="m-0">
                                                    <span class="ti ti-file-invoice text-warning fs-lg"></span>
                                                    <a href="invoice-details.php" class="link-reset fw-semibold">#INS-0120005</a>
                                                </h5>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Lisa
                                                                Brown</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="m-0">
                                                    <span class="ti ti-file-invoice text-primary fs-lg"></span>
                                                    <a href="invoice-details.php" class="link-reset fw-semibold">#INS-0120004</a>
                                                </h5>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Ryan
                                                                Mitchell</a>
                                                        </h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="m-0">
                                                    <span class="ti ti-file-invoice text-success fs-lg"></span>
                                                    <a href="invoice-details.php" class="link-reset fw-semibold">#INS-0120003</a>
                                                </h5>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Nina
                                                                Hughes</a>
                                                        </h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="m-0">
                                                    <span class="ti ti-file-invoice text-warning fs-lg"></span>
                                                    <a href="invoice-details.php" class="link-reset fw-semibold">#INS-0120002</a>
                                                </h5>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Oliver
                                                                Grant</a>
                                                        </h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <h5 class="m-0">
                                                    <span class="ti ti-file-invoice text-danger fs-lg"></span>
                                                    <a href="invoice-details.php" class="link-reset fw-semibold">#INS-0120001</a>
                                                </h5>
                                            </td>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap fs-base mb-0 lh-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Sophia
                                                                Kim</a></h5>
