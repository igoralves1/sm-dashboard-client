...
const MapWithMarker = () => {
  return <Row className="g-3">
      ...
      <Col lg={8}>
        <APIProvider apiKey={import.meta.env.GOOGLE_MAPS_API_KEY ?? ''}>
          <Map mapId={'bf51a910020fa25b'} style={{
          width: '100%',
          height: '360px'
        }} defaultCenter={{
          lat: 37.8,
  ...
  return <Row className="g-3">
      ...
      <Col lg={8}>
        <APIProvider apiKey={import.meta.env.GOOGLE_MAPS_API_KEY ?? ''}>
          ...
          lat: 37.8,
          lng: -122.4
        }} defaultZoom={14} mapId={'49ae42fed52588c3'} mapTypeId={'hybrid'} gestureHandling={'greedy'} disableDefaultUI={true} style={{
          width: '100%',
          height: '360px'
        }} />
        </APIProvider>
