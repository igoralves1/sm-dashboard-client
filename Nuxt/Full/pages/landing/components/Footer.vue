<template>
  <footer class="section-custom section-footer pb-2">
    <BContainer>
      <BRow class="g-4 justify-content-between">
        <BCol lg="3">
          <NuxtImg src="/images/logo-white.png" alt="logo" height="30" />
          <p class="mt-3 fs-sm">
            INSPINIA is the top-selling admin dashboard template on WrapBootstrap, known for
            its sleek design, flexibility, and powerful features. Build modern web applications
            with ease using the best in class!
          </p>
          ...
          <div class="d-flex gap-2 mt-4 mb-2">
            <NuxtLink
                ...
                :key="i"
                :to="link.url"
                class="btn btn-sm btn-icon rounded-circle btn-dark"
                :title="link.title"
            >
              <Icon :name="link.icon" class="fs-lg" />
            </NuxtLink>
          </div>
        </BCol>
        ...
        <BCol lg="8" xxl="7" >
          <BRow class="g-4">
            <BCol cols="6" md="4"
                ...
                :key="i"
            >
              <h5 class="text-white mb-4 ps-2">{{ section.title }}</h5>
                ...
                >
                  ...
                  >
                    ...
                    <span
                        v-if="link.badge"
                        class="ms-2"
                        :class="`badge text-bg-${link.badge.variant}`"
                    >
                      {{ link.badge.title }}
                    </span>
                  </NuxtLink>
