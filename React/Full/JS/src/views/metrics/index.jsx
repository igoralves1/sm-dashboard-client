...
import QuarterlyReports from '@/views/metrics/components/QuarterlyReports';
import OrdersCard from '@/views/metrics/components/OrdersCard';
import ProductsChart from '@/views/metrics/components/ProductsChart';
import ProfitOverviewChart from '@/views/metrics/components/ProfitOverviewChart';
