...
const NamingASource = () => {
  return (
    <ComponentCard title="Naming a Source">
...
const Blockquotes = () => {
  return (
    <ComponentCard title="Blockquotes">
      <p className="text-muted">
...
const DescriptionListAlignment = () => {
  return (
    <ComponentCard title="Description List Alignment">
      <p className="text-muted">
