                            ...
                            <div class="table-responsive">
                                ...
                                <BTable show-empty :filter="searchQuery" empty-text="Nothing found."
                                    ...
                                    <template #cell(issue)="{ item }">
                                        <Link href="" class="link-reset text-uppercase fw-semibold">{{ item.issueID
                                            }}
                                        </Link>
                                    ...
                                    <template #cell(role)="{ item }">
                                        <Link href="" v-for="(tag, idx) in item.tags" :key="idx"
                                            class="badge badge-label badge-default me-1">{{ tag }}</Link>
                                    </template>
