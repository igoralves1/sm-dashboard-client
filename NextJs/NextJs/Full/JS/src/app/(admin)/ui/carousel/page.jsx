...
const SlidesOnly = () => {
  return <ComponentCard title="Slides Only">
...
const SlidesWithControls = () => {
  return <ComponentCard title="With Controls">
...
const SlidesWithIndicators = () => {
  return <ComponentCard title="With Indicators">
...
const CrossFade = () => {
  return <ComponentCard title="Crossfade">
...
const IndividualInterval = () => {
  return <ComponentCard title="Individual Interval">
...
const DarkVariant = () => {
  return <ComponentCard title="Dark Variant">
            ...
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0 fw-semibold" href="https://react-bootstrap.netlify.app/docs/components/carousel/" target="_blank">
