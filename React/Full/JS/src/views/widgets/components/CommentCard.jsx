...
import { comments } from '@/views/widgets/data';
import { Link } from 'react-router';
const CommentCard = () => {
  return <div className="card">
      <div className="card-body">
        {comments.map((item, idx) => <div className="d-flex border border-dashed rounded p-3" key={idx}>
            ...
            <div className="flex-grow-1 ms-2">
              ...
              {item.reply && item.reply.map((reply, rIdx) => <div className="d-flex mt-4" key={rIdx}>
                    <div className="flex-shrink-0">
