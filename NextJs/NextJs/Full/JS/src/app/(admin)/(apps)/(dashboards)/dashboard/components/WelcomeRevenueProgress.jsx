...
const RevenueChart = dynamic(() => import('./charts').then(mod => mod.RevenueChart));
          ...
          <Col xxl={3} xl={6} className="order-xl-1 order-xxl-0">
            <div className="p-4 border-end border-dashed">
              ...
              <ListGroup variant="flush" className="mt-3">
                {activityItems.map(item => <ListGroupItem key={item.id} className="d-flex justify-content-between align-items-center border-0 px-0">
                    <div>
                ...
                <Col>
                  <div className="bg-light bg-opacity-50 p-2">
                    <h5 className="m-0">
                      ...
                      &nbsp;
                      <CountUpClient end={40} prefix="$" suffix="M" enableScrollSpy scrollSpyOnce />
                    </h5>
                  </div>
                </Col>
                <Col>
                  <div className="bg-light bg-opacity-50 p-2">
                    <h5 className="m-0">
                      ...
                      &nbsp;
                      <CountUpClient end={50.90} decimals={2} suffix="k" enableScrollSpy scrollSpyOnce />
                    </h5>
                  </div>
                </Col>
              </Row>
              <div dir="ltr" className="position-relative">
                <div className="py-2 px-3 rounded-3 bg-light-subtle border text-primary z-1 position-absolute" style={{
                top: '4.5%',
                left: '12%'
              }}>
