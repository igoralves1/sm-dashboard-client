...
const MorphingMapBarChart = () => {
  ...
  return <ComponentCard title="Morphing between Map and Bar Chart">
      {loaded && <CustomEChart extensions={[MapChart, BarChart, TooltipComponent, VisualMapComponent, GridComponent, GeoComponent, CanvasRenderer]} getOptions={getOptions} style={{
      height: '400px'
    }} />}
    </ComponentCard>;
};
