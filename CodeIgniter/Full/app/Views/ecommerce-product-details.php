...
<div class="wrapper">
    ...
    <div class="content-page">
        ...
        <div class="container-fluid">
            ...
            <?php echo view("./partials/page-title", array("subtitle" => "Ecommerce", "title" => "Product Details")) ?>
                                    ...
                                    <div class="card card-top-sticky border-0">
                                        <div class="card-body p-0">
                                            ...
                                            <div class="text-center my-3">
                                                <a href="ecommerce-add-products" class="btn btn-light me-1"><i
                                                        class="ti ti-pencil fs-lg me-1"></i> Edit</a>
                                                <a href="ecommerce-add-products" class="btn btn-danger"><i
