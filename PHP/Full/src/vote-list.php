...
<head>
    <?php $title = "Vote List"; include 'partials/title-meta.php' ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Apps"; $title = "Vote List"; include 'partials/page-title.php';?>
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                                <span class="d-flex align-items-center gap-1">
                                                    <img src="assets/images/users/user-7.jpg" alt="avatar-7" class="img-fluid avatar-xs rounded-circle">
                                ...
                                <div class="border-bottom border-dashed px-4 py-3">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                                <span class="d-flex align-items-center gap-1">
                                                    <img src="assets/images/users/user-8.jpg" alt="avatar-8" class="img-fluid avatar-xs rounded-circle">
                                ...
                                <div class="border-bottom border-dashed px-4 py-3">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                                <span class="d-flex align-items-center gap-1">
                                                    <img src="assets/images/users/user-9.jpg" alt="avatar-9" class="img-fluid avatar-xs rounded-circle">
                                ...
                                <div class="border-bottom border-dashed px-4 py-3">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                                <span class="d-flex align-items-center gap-1">
                                                    <img src="assets/images/users/user-10.jpg" alt="avatar-10" class="img-fluid avatar-xs rounded-circle">
                                ...
                                <div class="px-4 py-3">
                                    <div class="d-flex gap-4 align-items-center">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                                <span class="d-flex align-items-center gap-1">
                                                    <img src="assets/images/users/user-3.jpg" alt="avatar-3" class="img-fluid avatar-xs rounded-circle">
