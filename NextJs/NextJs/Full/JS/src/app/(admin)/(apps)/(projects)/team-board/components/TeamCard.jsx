  ...
  return <Card className="card-h-100">
      <CardHeader>
        ...
        <Dropdown className="ms-auto">
          <DropdownToggle as={'a'} className="text-muted fs-xl drop-arrow-none" style={{
          cursor: 'pointer'
        }}>
            <TbDotsVertical />
          </DropdownToggle>
      ...
      <CardBody className="d-flex flex-column justify-content-between">
        ...
        <div className="avatar-group avatar-group-sm mb-3">
          {team.members.map((member, i) => <div className="avatar" key={i}>
              <Image src={member} alt="" className="rounded-circle avatar-sm" />
            </div>)}
        </div>
