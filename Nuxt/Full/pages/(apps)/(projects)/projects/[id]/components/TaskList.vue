                        ...
                        <div class="d-flex align-items-center gap-3 justify-content-md-end">
                            <div class="d-flex align-items-center gap-1">
                                <div class="avatar avatar-xs">
                                    <NuxtImg :src="task.avatar" :alt="task.name" class="img-fluid rounded-circle" />
                                </div>
                                <div>
                            ...
                            <ul class="list-inline fs-base text-end flex-shrink-0 mb-0">
                                <li class="list-inline-item">
                                    <div class="d-flex align-items-center gap-1">
                                        <Icon name="tabler:calendar" class="text-muted fs-lg me-1" />
                                        <span class="fw-semibold">{{ task.time }}</span>
                                    </div>
                                </li>
                                <li class="list-inline-item ms-1">
                                    <div class="d-flex align-items-center gap-1">
                                        <Icon name="tabler:list-details" class="text-muted fs-lg me-1" />
                                ...
                                <li class="list-inline-item ms-1">
                                    <div class="d-flex align-items-center gap-1">
                                        <Icon name="tabler:message" class="text-muted fs-lg me-1" />
