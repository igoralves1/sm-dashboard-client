                    ...
                    <BCard no-body>
                        <BCardHeader class="border-light justify-content-between">
                            ...
                            <div class="d-flex gap-1">
                                <Link href="/projects" class="btn btn-soft-primary btn-icon">
                                    <Icon icon="lucide:layout-grid" class="fs-lg" />
                                </Link>
                                <Link href="/projects-list" class="btn btn-primary btn-icon">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <Link :href="`/projects/${item.id}`" class="link-reset">{{ item.title }}
                                            </Link>
                                        </h5>
