    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "Pages", "title" => "Timeline")) ?>
                            ...
                            <div class="card-body">
                                ...
                                <div class="timeline timeline-icon-based">
                                    ...
                                    <div class="timeline-item d-flex align-items-stretch">
                                        ...
                                        <div class="timeline-dot text-bg-purple">
                                ...
                                <div class="timeline timeline-users">
                                    ...
                                    <div class="timeline-item d-flex align-items-stretch">
                                        ...
                                        <div class="timeline-content ps-3 pb-4">
                                            ...
                                            <p class="mb-1 text-muted">Reduced page load time by optimizing image  and scripts.</p>
