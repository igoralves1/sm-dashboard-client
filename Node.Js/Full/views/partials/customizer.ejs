                ...
                <div class="col-6">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="demo-skin-classic">
                            <img src="/images/layouts/themes/theme-classic.png" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                ...
                <div class="col-6">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="demo-skin-material">
                            <img src="/images/layouts/themes/theme-material.png" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                ...
                <div class="col-6">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="demo-skin-modern">
                            <img src="/images/layouts/themes/theme-modern.png" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                ...
                <div class="col-6">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="demo-skin-saas">
                            <img src="/images/layouts/themes/theme-saas.png" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                ...
                <div class="col-6">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="demo-skin-flat">
                            <img src="/images/layouts/themes/theme-flat.png" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                ...
                <div class="col-6">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="demo-skin-minimal">
                            <img src="/images/layouts/themes/theme-minimal.png" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                ...
                <div class="col-6">
                    <div class="form-check card-radio pe-none">
                        ...
                        <label class="form-check-label p-0 w-100" for="demo-skin-galaxy">
                            <img src="/images/layouts/themes/theme-galaxy.png" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="layout-color-dark">
                            <img src="/images/layouts/dark.svg" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="layout-color-system">
                            <img src="/images/layouts/system.svg" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="topbar-color-gray">
                            <img src="/images/layouts/topbar-gray.svg" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="topbar-color-gradient">
                            <img src="/images/layouts/topbar-gradient.svg" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check sidebar-setting card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="sidenav-color-dark">
                            <img src="/images/layouts/side-dark.svg" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                    <h5 class="fs-sm text-center text-muted mt-2 mb-0">Dark</h5>
                </div>
                ...
                <div class="col-4">
                    <div class="form-check sidebar-setting card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="sidenav-color-gray">
                            <img src="/images/layouts/side-gray.svg" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                    <h5 class="fs-sm text-center text-muted mt-2 mb-0">Gray</h5>
                </div>
                ...
                <div class="col-4">
                    <div class="form-check sidebar-setting card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="sidenav-color-gradient">
                            <img src="/images/layouts/side-gradient.svg" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                    <h5 class="fs-sm text-center text-muted mt-2 mb-0">Gradient</h5>
                </div>
                <div class="col-4">
                    <div class="form-check sidebar-setting card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="sidenav-color-image">
                            <img src="/images/layouts/side-image.svg" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check sidebar-setting card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="sidenav-size-compact">
                            <img src="/images/layouts/sidebar-compact.svg" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check sidebar-setting card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="sidenav-size-small">
                            <img src="/images/layouts/sidebar-sm.svg" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
                ...
                <div class="col-4">
                    <div class="form-check sidebar-setting card-radio">
                        ...
                        <label class="form-check-label p-0 w-100" for="sidenav-size-offcanvas">
                            <img src="/images/layouts/sidebar-full.svg" alt="layout-img" class="img-fluid">
                        </label>
                    </div>
