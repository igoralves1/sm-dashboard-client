...
import { contacts, currentUser, messageThreads } from './data';
  ...
  return <Container fluid>
      ...
      <div className="outlook-box">
        ...
        <Card className="h-100 mb-0 rounded-start-0 flex-grow-1">
          ...
          <SimpleBar className="card-body pt-0 mb-5 pb-2" style={{
          maxHeight: 'calc(100vh - 317px)'
            ...
            {currentThread ? currentThread.messages.map(message => <Fragment key={message.id}>
                  {currentContact.id === message.senderId && <div className="d-flex align-items-start gap-2 my-3 chat-item">
                      {currentContact.avatar ? <img src={currentContact.avatar} width={36} height={36} className="avatar-md rounded-circle" alt="User" /> : <span className="avatar-sm flex-shrink-0">
                  ...
                  {currentUser.id === message.senderId && <div className="d-flex align-items-start gap-2 my-3 text-end chat-item justify-content-end">
                      ...
                      {currentUser.avatar ? <img src={currentUser.avatar} width={36} height={36} className="avatar-md rounded-circle" alt="User" /> : <span className="avatar-sm flex-shrink-0">
