  ...
  series: [
    {
      ...
      center: ['50%', '50%'],
      data: [
        { value: 1200, name: 'Facebook', itemStyle: { color: getColor('primary') } },
        {
          value: 1000,
          name: 'Youtube',
        ...
        { value: 400, name: 'Github', itemStyle: { color: getColor('warning') } },
      ],
      emphasis: {
        itemStyle: {
          shadowBlur: 10,
          shadowOffsetX: 0,
          shadowColor: getColor('tertiary-color', 0.5),
        },
      },
    },
  ],
  ...
  series: [
    {
      ...
      data: [
        { value: 1200, name: 'FB', itemStyle: { color: getColor('primary') } },
        {
          value: 1000,
          name: 'YT',
          itemStyle: { color: getColor('danger') },
  ...
  series: [
    {
      ...
      data: [
        { value: 1200, name: 'Starter', itemStyle: { color: getColor('primary') } },
        {
          value: 1000,
          name: 'Basic',
          itemStyle: { color: getColor('danger') },
...
const leftChartData = [
  { value: 1048, name: 'Starter', itemStyle: { color: getColor('danger') } },
  {
    value: 735,
    name: 'Basic',
...
const rightChartData = [
  { value: 1048, name: 'Facebook', itemStyle: { color: getColor('primary') } },
  {
    value: 735,
    name: 'Youtube',
    itemStyle: { color: getColor('danger') },
