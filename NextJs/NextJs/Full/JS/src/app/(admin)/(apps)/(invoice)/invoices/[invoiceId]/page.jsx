                ...
                <CardBody className="px-4">
                  <div className="d-flex align-items-center justify-content-between mb-3 border-bottom pb-3">
                    <div className="auth-brand mb-0">
                      <Link href="/" className="logo-dark">
                        <Image src={logoDark} alt="dark logo" height={36} width={127.8} />
                      </Link>
                      <Link href="/" className="logo-light">
                        <Image src={logoLight} alt="logo" height={36} width={127.8} />
                      </Link>
                    </div>
                  ...
                  <Row>
                    ...
                    <Col cols={4} className="text-end">
                      <Image src={qrImg} alt="Barcode" className="img-fluid" height={80} width={80} style={{
                      maxHeight: '80px'
                    }} />
                    </Col>
                  </Row>
                  ...
                  <div className="mt-4">
                    ...
                    <Image src={sign} alt="Company Logo" height={42} width={176.14} />
