...
<head>
    <?php $title = "Dark Topbar"; include 'partials/title-meta.php' ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            <div class="container-fluid">
                <?php $title = "Dark Topbar"; include 'partials/page-title.php';?> 
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-product-details.php" class="text-body">Smart Watch</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-product-details.php" class="text-body">Bluetooth Speaker</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <h5 class="fs-base mt-1 fw-normal">
                                                        ...
                                                        <span class="ms-1"><a href="ecommerce-reviews.php" class="link-reset fw-semibold">(20)</a></span>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <span class="text-muted fs-xs">Status</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-product-details.php" class="text-body">Gaming Mouse</a></h5>
                                                ...
                                                <td>
                                                    ...
                                                    <h5 class="fs-base mt-1 fw-normal">
                                                        ...
                                                        <span class="ms-1"><a href="ecommerce-reviews.php" class="link-reset fw-semibold">(14)</a></span>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <span class="text-muted fs-xs">Status</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-product-details.php" class="text-body">4K Action Camera</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <h5 class="fs-base mt-1 fw-normal">
                                                        ...
                                                        <span class="ms-1"><a href="ecommerce-reviews.php" class="link-reset fw-semibold">(31)</a></span>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <span class="text-muted fs-xs">Status</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-product-details.php" class="text-body">Fitness Tracker Band</a>
                                                            </h5>
                                                            <span class="text-muted fs-xs">Wearables</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <td>
                                                    ...
                                                    <h5 class="fs-base mt-1 fw-normal">
                                                        ...
                                                        <span class="ms-1"><a href="ecommerce-reviews.php" class="link-reset fw-semibold">(18)</a></span>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <span class="text-muted fs-xs">Status</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-order-details.php" class="text-body">#ORD-1001</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-order-details.php" class="text-body">#ORD-1002</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-order-details.php" class="text-body">#ORD-1003</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-order-details.php" class="text-body">#ORD-1004</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-order-details.php" class="text-body">#ORD-1005</a></h5>
                                            ...
                                            <table class="table table-custom table-nowrap table-hover table-centered mb-0">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="assets/images/cards/mastercard.svg" alt="" class="me-2" height="28"> xxxx 1123
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="assets/images/cards/visa.svg" alt="" class="me-2" height="28"> xxxx 3490
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><span class="badge badge-soft-success fs-xxs"><i class="ti ti-point-filled"></i> Paid</span></td>
                                                        <td>
                                                            <img src="assets/images/cards/american-express.svg" alt="" class="me-2" height="28"> xxxx 8765
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <img src="assets/images/cards/mastercard.svg" alt="" class="me-2" height="28"> xxxx 5566
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td><span class="badge badge-soft-success fs-xxs"><i class="ti ti-point-filled"></i> Paid</span></td>
                                                        <td>
                                                            <img src="assets/images/cards/visa.svg" alt="" class="me-2" height="28"> xxxx 9012
                                                        </td>
                                                    </tr>
                                                </tbody>
                                            </table>
