  ...
  return <Card>
      ...
      <CardBody>
        <div className="timeline timeline-icon-bordered">
          ...
          return <div key={event.id} className="timeline-item d-flex align-items-stretch">
                ...
                <div className="timeline-content ps-3">
                  ...
                  <div className="d-flex align-items-center gap-2">
                    <Image src={event.userImage} alt={event.userName} className="rounded-circle avatar-xxs" />
