...
import { Card, CardBody, CardHeader, CardTitle, Col, Container, Pagination, Row } from 'react-bootstrap';
...
const DefaultPagination = () => {
  ...
  return <ComponentCard title="Default Pagination">
...
const AlignmentPagination = () => {
  return <ComponentCard title="Alignment">
      <p className="text-muted fs-sm">
...
const CustomColorPagination = () => {
  return <ComponentCard title="Custom Color Pagination">
      <p className="text-muted fs-sm">
...
const DisabledAndActive = () => {
  return <ComponentCard title="Disabled and active states">
      <p className="text-muted fs-sm">
...
const CustomIconPagination = () => {
  return <ComponentCard title="Custom Icon Pagination">
      <p className="text-muted fs-sm">
        Add icons like
...
const SizingPagination = () => {
  ...
  return <ComponentCard title="Sizing">
      <p className="text-muted fs-sm">
...
const BoxedPagination = () => {
  return <ComponentCard title="Boxed Pagination">
      <p className="text-muted fs-sm">
...
const RoundedPagination = () => {
  return <ComponentCard title="Rounded Pagination">
      <p className="text-muted fs-sm">
...
const SoftPagination = () => {
  return <ComponentCard title="Soft Pagination">
      <p className="text-muted fs-sm">
            ...
            <Col xs={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0 fw-semibold" href="https://react-bootstrap.netlify.app/docs/components/pagination" target="_blank">
