...
const BasicDayPicker = () => {
  ...
  return <>
      ...
      <DayPickerClient animate mode="single" selected={selected} onSelect={setSelected} footer={selected ? `Selected: ${selected.toLocaleDateString()}` : 'Pick a day.'} />
    </>;
};
const CaptionLayout = () => {
  return <>
...
const InputWithDayPicker = () => {
  ...
  const CustomToggle = forwardRef(({
    onClick
  }, ref) => <FormControl type="text" ref={ref} value={selected?.toDateString()} readOnly onClick={onClick} />);
