<template>
  <div class="auth-box p-0 w-100">
    <BRow class="w-100 g-0">
      ...
      <BCol xl="auto">
        <BCard no-body class="auth-box-form border-0 mb-0">
          <BCardBody class="min-vh-100 d-flex flex-column justify-content-center">
            ...
            <div class="mt-auto text-center">
              ...
              <p class="text-muted auth-sub-text mx-auto mb-4">
              ...
              <form>
                <div class="mb-3">
                  <div class="input-group">
                    <BFormInput
                        type="email"
                        class="py-2 px-3 bg-light bg-opacity-40 border-light"
                ...
                <div class="mb-3">
                  <label class="form-label d-flex">
                    Enter your 6-digit code <span class="text-danger ms-1">*</span>
                  </label>
                  <VOtpInput
                      v-model:value="otp"
                      :num-inputs="6"
                      input-classes="form-control py-2 bg-light bg-opacity-40 border-light text-center"
                      input-type="tel"
                      :is-input-num="true"
                ...
                <div class="d-grid">
                  <BButton variant="primary" type="submit" class="fw-semibold py-2">Update Password</BButton>
                </div>
              </form>

              <p class="mt-4 text-muted text-center mb-4">
                Don’t have a code?
                <a href="javascript:void(0)" class="text-decoration-underline link-offset-2 fw-semibold">Resend</a> or
                <a href="javascript:void(0)" class="text-decoration-underline link-offset-2 fw-semibold">Call Us</a>
              </p>
            </div>

            <p class="text-muted text-center mt-4 mb-0">
              Return to
              <NuxtLink to="/auth-3/sign-in" class="text-decoration-underline link-offset-3 fw-semibold">
                Sign in
              </NuxtLink>
            </p>
