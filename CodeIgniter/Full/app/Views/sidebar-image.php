...
<head>
    <?php echo view("partials/title-meta", array("title" => "Image Menu")) ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            <div class="container-fluid">
                <?php echo view("./partials/page-title", array("title" => "Image Menu")) ?>
                        ...
                        <div data-table data-table-rows-per-page="5" class="card">
                            <div class="card-header justify-content-between align-items-center border-dashed">
                                ...
                                <div class="d-flex gap-2">
                                    <a href="ecommerce-add-product" class="btn btn-sm btn-soft-secondary">
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-product-details" class="text-body">Smart Watch</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-product-details" class="text-body">Bluetooth Speaker</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <h5 class="fs-base mt-1 fw-normal">
                                                        ...
                                                        <span class="ms-1"><a href="ecommerce-reviews" class="link-reset fw-semibold">(20)</a></span>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <span class="text-muted fs-xs">Status</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-product-details" class="text-body">Gaming Mouse</a></h5>
                                                ...
                                                <td>
                                                    ...
                                                    <h5 class="fs-base mt-1 fw-normal">
                                                        ...
                                                        <span class="ms-1"><a href="ecommerce-reviews" class="link-reset fw-semibold">(14)</a></span>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <span class="text-muted fs-xs">Status</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-product-details" class="text-body">4K Action Camera</a>
                                                            </h5>
                                                ...
                                                <td>
                                                    ...
                                                    <h5 class="fs-base mt-1 fw-normal">
                                                        ...
                                                        <span class="ms-1"><a href="ecommerce-reviews" class="link-reset fw-semibold">(31)</a></span>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <span class="text-muted fs-xs">Status</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-product-details" class="text-body">Fitness Tracker Band</a>
                                                            </h5>
                                                            <span class="text-muted fs-xs">Wearables</span>
                                                        </div>
                                                    </div>
                                                ...
                                                <td>
                                                    ...
                                                    <h5 class="fs-base mt-1 fw-normal">
                                                        ...
                                                        <span class="ms-1"><a href="ecommerce-reviews" class="link-reset fw-semibold">(18)</a></span>
                                                    </h5>
                                                </td>
                                                <td>
                                                    <span class="text-muted fs-xs">Status</span>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-order-details" class="text-body">#ORD-1001</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-order-details" class="text-body">#ORD-1002</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-order-details" class="text-body">#ORD-1003</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-order-details" class="text-body">#ORD-1004</a></h5>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <h5 class="fs-base my-1"><a href="ecommerce-order-details" class="text-body">#ORD-1005</a></h5>
