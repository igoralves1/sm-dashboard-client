...
<head>
    <?php $title = "Text Diff"; include 'partials/title-meta.php' ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Miscellaneous"; $title = "Text Diff"; include 'partials/page-title.php' ?>
                    ...
                    <div class="code-body">
                        <pre>
                           <code class="language-markup">
                            ...
                            &lt;!-- Find Javascript in File: assets/js/pages/misc-text-diff.js --&gt;
    ...
    <!-- Diff Plugin Js-->
    <script src="assets/plugins/diff/diff.min.js"></script>

    <!-- Text Diff Page Js-->
    <script src="assets/js/pages/misc-text-diff.js"></script>
</body>
