...
import SalesChart from '@/app/(admin)/(apps)/(ecommerce)/reports/sales/components/SalesChart';
import SalesTable from '@/app/(admin)/(apps)/(ecommerce)/reports/sales/components/SalesTable';
          ...
          <Card data-table data-table-rows-per-page={8}>
            <CardHeader className="border-light justify-content-between">
              ...
              <div className="d-flex align-items-center gap-2">
                ...
                <div className="app-search">
                  <FlatpickrClient className="form-control" style={{
                  minWidth: 250
                }} options={{
                  dateFormat: 'd M, Y',
                  mode: 'range',
