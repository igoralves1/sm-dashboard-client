      ...
      <Row>
        <Col xl={12}>
          <ComponentCard title="Basic Candlestick Chart">
            <EChartClient extensions={[CandlestickChart, CanvasRenderer]} getOptions={getBasicCandlestickChart} style={{
            height: '400px'
          }} />
          </ComponentCard>
        </Col>
        ...
        <Col xl={12}>
          <ComponentCard title="Mixed Candlestick Chart">
            <EChartClient extensions={[CandlestickChart, CanvasRenderer]} getOptions={getMixedCandlestickChart} style={{
            height: '400px'
          }} />
          </ComponentCard>
        </Col>
