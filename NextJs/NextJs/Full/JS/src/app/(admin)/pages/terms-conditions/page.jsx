          ...
          <Card className="position-relative">
            <div className="position-absolute top-0 end-0">
              ...
              opacity: 0.05
                ...
                <path d="M460 120 C470 90, 500 90, 510 120 S550 150, 560 120" stroke="#1c84c6" strokeWidth="2" fill="none" />
                ...
                <path d="M290 100 C300 90, 310 110, 300 120 C290 130, 270 130, 260 120 C250 110, 250 90, 260 80" stroke="#23c6c8" strokeWidth="2" fill="none" />

                <path d="M320 200 L330 210 L320 230 L300 230 L290 210 Z" fill="#fd7e14" />

                <circle cx="460" cy="250" r="20" stroke="#1c84c6" strokeWidth="3" fill="none" />
              </svg>
            </div>
