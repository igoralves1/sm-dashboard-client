  ...
  return <Card className="card-top-sticky">
      <CardBody className="pt-0">
        <article className="card card-out-of-container border-top-0">
          <div className="position-relative card-side-img overflow-hidden rounded-top" style={{
          height: 180,
          backgroundImage: `url(${sellerProfile.src})`
        }}>
          ...
          <CardBody className="pt-0 position-relative" style={{
          marginTop: '-40px'
        }}>
            <div className="d-flex justify-content-between align-items-center rounded border-light p-3 bg-light-subtle border">
              <div className="d-flex justify-content-start align-items-center gap-3">
                <div className="avatar avatar-xxl">
                  <Image src={seller4} alt="avatar-2" className="img-fluid img-thumbnail rounded-circle" />
                </div>
                <div>
        ...
        <div>
          ...
          <div className="d-flex align-items-center gap-2 mb-2">
            ...
            <p className="mb-0 fs-sm">
              Support:{' '}
              <a href="mailto:support@example.com" className="text-primary fw-semibold">
                support@example.com
              </a>
            </p>
          </div>
          <div className="d-flex align-items-center gap-2 mb-2">
            ...
            <p className="mb-0 fs-sm">
              Website:{' '}
              <a href="https://www.example.com" className="text-primary fw-semibold">
                www.example.com
              </a>
            </p>
          </div>
