            ...
            <BCol xxl="8">
                ...
                <BCard no-body class="position-relative">
                    <div class="position-absolute top-0 end-0">
                        <svg style="opacity: 0.05;" width="600" height="560" viewBox="0 0 600 560" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <!-- Circle -->
                            <circle cx="550" cy="80" r="40" fill="#ed5565" />

                            <!-- Wavy Path -->
                            <path d="M460 120 C470 90, 500 90, 510 120 S550 150, 560 120" stroke="#1c84c6"
                            ...
                            <!-- Rounded Diamond -->
                            <path d="M360 320 Q370 300 390 310 Q410 320 400 340 Q390 360 370 350 Q350 340 360 320 Z"
                                fill="#1ab394" />

                            <!-- Organic blob -->
                            <path
                                d="M470 400 C460 380, 490 370, 510 380 C530 390, 540 410, 520 430 C500 450, 480 440, 470 400 Z"
                                fill="#ff679b" />

                            <!-- Star -->
                            <path d="M380 80 L388 100 H410 L392 115 L400 135 L380 123 L360 135 L368 115 L350 100 H372 Z"
                                fill="#0acf97" />

                            <!-- Spiral -->
                            <path
                                d="M290 100 C300 90, 310 110, 300 120 C290 130, 270 130, 260 120 C250 110, 250 90, 260 80"
                                stroke="#23c6c8" stroke-width="2" fill="none" />
                    ...
                    <BCardBody class="position-relative">
                        <p class="fst-italic fs-sm">Welcome to our website. By accessing or using this site, you agree
                            to be bound by these terms and conditions. Please read them carefully.</p>

                        <h4 class="fw-bold mt-3">1. Acceptance of Terms</h4>
                        <p>By using this website, you acknowledge that you have read, understood, and agree to be bound
                            by these Terms and Conditions. If you do not agree, please do not use our services.</p>

                        <h4 class="fw-bold mt-4">2. Modifications</h4>
                        <p>We reserve the right to modify these Terms and Conditions at any time. Updated terms will be
                            posted on this page with the revised date. Continued use constitutes acceptance of any
                            changes.</p>

                        <h4 class="fw-bold mt-4">3. Intellectual Property</h4>
                        <p>All content, trademarks, graphics, and materials on this website are owned or licensed by us
                            and protected by copyright and intellectual property laws. Unauthorized use is strictly
                            prohibited.</p>
                        ...
                        <p>We are not liable for any indirect, incidental, or consequential damages arising from the use
