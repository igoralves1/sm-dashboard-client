...
const Discussions = () => {
  return <Card>
      <CardHeader className="d-flex justify-content-between align-items-center">
        ...
        <Link href="" className="badge text-bg-light fs-xs fw-semibold p-1">
          Mark all as read
        </Link>
      </CardHeader>
      <CardBody className="bg-light-subtle border-bottom border-dashed">
        <div className="d-flex gap-2">
          <div className="me-2 flex-shrink-0">
            <Image src={messageMail} height={36} alt="message img" />
          </div>
      ...
      <CardBody className="pt-1">
        <ListGroup variant="flush" className="mb-3">
          {discussionMessages.map(msg => <ListGroupItem key={msg.id} className="px-0 border-light">
              <div className="d-flex gap-2">
                <div className="me-2 flex-shrink-0">
                  {msg.hasAvatar ? <Image src={msg.userImage} className="avatar-md rounded-circle" alt={msg.userName} /> : <div className="avatar avatar-md">
                ...
                <div className="flex-grow-1 text-muted">
                  ...
                  <Link href="/chat" className="badge badge-soft-primary p-1">
                    Reply
                  </Link>
                </div>
              </div>
