...
<head>
    <?php $title = "Projects"; include 'partials/title-meta.php' ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Apps"; $title = "Projects"; include 'partials/page-title.php' ?>
                            ...
                            <div class="row gap-3">
                                ...
                                <div class="col-auto">
                                    <div class="d-flex gap-1">
                                        <a href="projects.php" class="btn btn-primary btn-icon">
                                            <i data-lucide="layout-grid" class="fs-lg"></i>
                                        </a>
                                        <a href="projects-list.php" class="btn btn-soft-primary btn-icon">
                                ...
                                <div class="d-flex mb-4">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a href="project-details.php" class="link-reset">AI Analytics Dashboard</a>
                                        </h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex mb-4">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a href="project-details.php" class="link-reset">Marketing Automation Platform</a>
                                        </h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex mb-4">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a href="project-details.php" class="link-reset">Website Redesign</a>
                                        </h5>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex mb-4">
                                    ...
                                    <div>
                                        <h5 class="mb-1 d-flex align-items-center">
                                            <a href="project-details.php" class="link-reset">Sales Insight Tool</a>
                                        </h5>
                                ...
                                <p class="my-2 text-muted fw-semibold fs-xxs">Team Members:</p>
                                <div class="avatar-group avatar-group-xs mb-3">
                                    <div class="avatar"><img src="assets/images/users/user-2.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                    <div class="avatar"><img src="assets/images/users/user-4.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                    <div class="avatar"><img src="assets/images/users/user-5.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                    <div class="avatar"><img src="assets/images/users/user-7.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                </div>
                    ...
                    <div class="col-md-6 col-xxl-3">
                        <div class="card">
                            <div class="card-header bg-light-subtle border-light p-3">
                                ...
                                <div>
                                    <h5 class="mb-1 d-flex align-items-center">
                                        <a href="project-details.php" class="link-reset">Cyber Security System</a>
                                    </h5>
                            ...
                            <div class="card-body">
                                ...
                                <p class="my-2 text-muted fw-semibold fs-xxs">Team Members:</p>
                                <div class="avatar-group avatar-group-xs mb-3">
                                    <div class="avatar"><img src="assets/images/users/user-1.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                    <div class="avatar"><img src="assets/images/users/user-4.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                    <div class="avatar"><img src="assets/images/users/user-5.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                    <div class="avatar"><img src="assets/images/users/user-8.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                </div>
                    ...
                    <div class="col-md-6 col-xxl-3">
                        <div class="card">
                            <div class="card-header bg-light-subtle border-light p-3">
                                ...
                                <div>
                                    <h5 class="mb-1 d-flex align-items-center">
                                        <a href="project-details.php" class="link-reset">AI Performance Dashboard</a>
                                    </h5>
                            ...
                            <div class="card-body">
                                ...
                                <p class="my-2 text-muted fw-semibold fs-xxs">Team Members:</p>
                                <div class="avatar-group avatar-group-xs mb-3">
                                    <div class="avatar"><img src="assets/images/users/user-6.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                    <div class="avatar"><img src="assets/images/users/user-7.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                    <div class="avatar"><img src="assets/images/users/user-2.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                    <div class="avatar"><img src="assets/images/users/user-3.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                </div>
                    ...
                    <div class="col-md-6 col-xxl-3">
                        <div class="card">
                            <div class="card-header bg-light-subtle border-light p-3">
                                ...
                                <div>
                                    <h5 class="mb-1 d-flex align-items-center">
                                        <a href="project-details.php" class="link-reset">Cloud Sync Platform</a>
                                    </h5>
                            ...
                            <div class="card-body">
                                ...
                                <p class="my-2 text-muted fw-semibold fs-xxs">Team Members:</p>
                                <div class="avatar-group avatar-group-xs mb-3">
                                    <div class="avatar"><img src="assets/images/users/user-9.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                    <div class="avatar"><img src="assets/images/users/user-10.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                    <div class="avatar"><img src="assets/images/users/user-2.jpg" class="rounded-circle avatar-xs" alt=""></div>
                                </div>
                    ...
                    <div class="col-md-6 col-xxl-3">
                        <div class="card">
                            <div class="card-header bg-light-subtle border-light p-3">
                                ...
                                <div>
                                    <h5 class="mb-1 d-flex align-items-center">
                                        <a href="project-details.php" class="link-reset">Data Mining Toolkit</a>
                                    </h5>
