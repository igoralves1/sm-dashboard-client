    ...
    <UICard title="My Tasks" body-class="p-0">
        <BTable thead-class="bg-light align-middle bg-opacity-25 thead-sm" hover
            ...
            <template #cell(task)="{ item }">
                <h5 class="fs-sm my-1">
                    <NuxtLink to="" class="text-body">{{ item.title }}</NuxtLink>
                </h5>
            ...
            <template #cell(assignBy)="{ item }">
                <div class="d-flex justify-content-start align-items-center gap-2">
                    <div class="avatar avatar-sm">
                        <NuxtImg :src="item.assignBy.image" alt="avatar-3" class="img-fluid rounded-circle"/>
                    </div>
                    <div>
            ...
            <template #cell(action)>
                <NuxtLink to="" class="text-muted fs-xxl">
