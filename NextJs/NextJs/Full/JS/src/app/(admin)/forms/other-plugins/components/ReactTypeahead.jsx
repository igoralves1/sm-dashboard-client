  ...
  return <Card>
      ...
      <CardBody>
        ...
        <Row className="g-3">
          ...
          <Col lg={6}>
            <TypeaheadClient className="typeahead" labelKey="state" placeholder="Enter states from USA" options={options} renderInput={({
            inputRef,
            referenceElementRef,
            ...inputProps
          }) => <Hint>
        ...
        <Row className="g-3">
          ...
          <Col lg={6}>
            <TypeaheadClient className="typeahead" labelKey="name" placeholder="Enter states from USA" options={states} renderMenu={(results, {
            newSelectionPrefix,
            paginationText,
        ...
        <Row className="g-3">
          ...
          <Col lg={6}>
            <TypeaheadClient className="typeahead" labelKey="name" placeholder="Enter states from USA" options={states} renderMenuItemChildren={(option, {
            text
          }) => <>
        ...
        <Row className="g-3">
          ...
          <Col lg={6}>
            <TypeaheadClient className="typeahead" labelKey="name" placeholder="Enter states from USA" options={states} multiple renderToken={(option, {
            onRemove
