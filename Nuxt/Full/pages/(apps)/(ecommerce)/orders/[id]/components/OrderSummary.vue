  ...
  <BCard no-body>
    <BCardHeader class="align-items-start p-4 d-flex">
      <div>
        ...
        <p class="text-muted mb-3">
          <Icon name="tabler:calendar" /> 24 Apr, 2025
          <small class="text-muted">10:10 AM</small>
        </p>
        <span class="badge badge-soft-success fs-xxs badge-label me-1">
          <Icon name="tabler:point-filled" class="align-middle fs-sm" /> Paid
        </span>
        <span class="badge badge-soft-info fs-xxs badge-label">
          <Icon name="tabler:truck" class="align-middle fs-sm" /> Shipped
        </span>
      </div>
      <div class="ms-auto">
        <BButton variant="light" class="me-1">
          <Icon name="tabler:pencil" class="me-1" /> Modify
        </BButton>
        <BButton variant="danger">
          <Icon name="tabler:trash" class="me-1" /> Delete
        </BButton>
      </div>
    </BCardHeader>
    ...
    <BCardBody class="px-4">
      ...
      <BTableSimple
        responsive
        bordered
        class="table-custom table-nowrap align-middle mb-1"
      >
          ...
          <tr>
            <td>
              <div class="d-flex">
                ...
                <div>
                  <h5 class="mb-1">
                    <NuxtLink to="" class="link-reset">Wireless Earbuds</NuxtLink>
                  </h5>
          ...
          <tr>
            <td>
              <div class="d-flex">
                ...
                <div>
                  <h5 class="mb-1">
                    <NuxtLink to="" class="link-reset">Smart Watch</NuxtLink>
                  </h5>
          ...
          <tr>
            <td>
              <div class="d-flex">
                ...
                <div>
                  <h5 class="mb-1">
                    <NuxtLink to="" class="link-reset">Gaming Mouse</NuxtLink>
                  </h5>
