        ...
        <div class="h-100 position-relative">
            <BCardBody>
                ...
                <BListGroup flush class="list-custom mt-3">
                    <BListGroupItem v-for="(item, idx) in items" :key="item.name" :href="''" action
                        :class="idx === 0 ? 'active' : ''">
                        <Icon :icon="item.icon" class="align-middle me-1 opacity-75 fs-lg" />
                    ...
                    <BListGroupItem v-for="item in categories" :key="item.name" :href="''" action>
