      ...
      <Row>
        <Col xl={6}>
          <ComponentCard title="Area Chart">
            <CustomEChart extensions={[LineChart, CanvasRenderer]} getOptions={getAreaChart} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
        <Col xl={6}>
          <ComponentCard title="Stacked Area Chart">
            <CustomEChart extensions={[LineChart, CanvasRenderer]} getOptions={getStackedAreaChart} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
        <Col xl={6}>
          <ComponentCard title="Area with Marker">
            <CustomEChart extensions={[LineChart, CanvasRenderer]} getOptions={getAreawithMarkerChart} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
        ...
        <Col xl={6}>
          <ComponentCard title="Step Area">
            <CustomEChart extensions={[LineChart, CanvasRenderer]} getOptions={getStepAreaChart} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
