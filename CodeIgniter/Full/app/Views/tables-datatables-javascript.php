...
<head>
    <?php echo view("partials/title-meta", array("title" => "Javascript Source Datatables")) ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "DataTables", "title" => "Javascript Source")) ?>
