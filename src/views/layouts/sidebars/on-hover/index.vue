<template>
  <MainLayout>
    <BContainer fluid>
      <PageBreadcrumb title="On Hover Sidebar" />
        ...
        <BCol cols="12">
          ...
          >
            ...
            <div>
              ...
              <code>data-sidenav-size="on-hover"</code> to the <code>&lt;html&gt;</code> tag. To
              apply this dynamically, use <code>setSideNavSize('on-hover')</code> from the
              <code>useLayout</code>.
            </div>
          </BAlert>
        </BCol>
