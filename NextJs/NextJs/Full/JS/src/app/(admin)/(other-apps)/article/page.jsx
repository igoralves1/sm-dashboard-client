            ...
            <CardBody className="p-lg-5">
              <Row className="g-5">
                <Col lg={8}>
                  ...
                  <Image src={blogPost} width={802} height={451.13} className="img-fluid rounded mt-4" alt="blog-img" />
                  ...
                  <div className="d-flex align-items-center gap-4 border mt-4 border-dashed p-4 rounded mb-14">
                    <div className="text-center flex-shrink-0 me-7 me-lg-13">
                      <div className="mb-2">
                        <Image src={user1} width={48} height={48} className="avatar-xl rounded-circle" alt="" />
                      </div>
                      <div className="mb-0">
                        <a href="#" className="fw-bold fs-sm">
                          Nathan Brooks
                        </a>
                    ...
                    <div className="mb-0">
                      ...
                      <a href="#" className="fw-semibold link-primary">
                        Author’s Profile
                      </a>
                    </div>
                  </div>
                  ...
                  <div className="my-4 text-center">
                    ...
                    <div className="d-flex justify-content-center gap-2">
                      {socialLinks.map((item, idx) => <Link href={item.link} key={idx} className={`btn btn-icon rounded-circle btn-${item.variant}`}>
                          {item.icon}
                        </Link>)}
                    </div>
                  </div>
                ...
                <Col lg={4}>
                  ...
                  <div className="align-items-center mt-5">
                    ...
                    <ul className="list-group list-group-flush fs-sm">
                      {relatedPosts.map((post, idx) => <li className="list-group-item ps-0" key={idx}>
                          <Link href={post.url} className="link-reset fw-medium">
                            {post.title}
                          </Link>
                        </li>)}
                    </ul>
