    ...
    <nav class="navbar navbar-expand-lg">
        <nav class="container-fluid">
            <div class="collapse navbar-collapse" id="topnav-menu-content">
                <ul class="navbar-nav">
                    <li class="nav-item">
                        <a class="nav-link" href="layouts-horizontal.php">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle drop-arrow-none" href="#" id="topnav-auth-v1" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-auth-v1">
                            <a href="auth-sign-in.php" class="dropdown-item">Menu Item Link</a>
                            <a href="auth-sign-in.php" class="dropdown-item">Menu Item Link</a>
                        </div>
                    </li>
                        ...
                        <div class="dropdown-menu" aria-labelledby="topnav-layouts">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="topnav-layouts-one">
                                    <a href="auth-sign-in.php" class="dropdown-item">Sub Item</a>
                                    <a href="auth-sign-in.php" class="dropdown-item">Sub Item</a>
                                </div>
                            </div>
                        </div>
