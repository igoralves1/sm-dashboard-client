                ...
                <BCard no-body class="h-100 mb-0 rounded-0 flex-grow-1 border-0">
                    <BCardHeader class="border-light justify-content-between">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="app-search">
                                ...
                                <Icon size="18" name="lucide:file" class="app-search-icon text-muted" />
                            </div>
                    ...
                    <simplebar class="card-body" style="height: calc(100% - 100px);">
                        ...
                        <BTable show-empty :filter="searchQuery" empty-text="Nothing found."
                            ...
                            hover :fields="fields" :items="files" :per-page="perPage" :current-page="currentPage"
                            ...
                            <template #cell(owner)="{ item }">
                                <div class="d-flex align-items-center gap-2">
                                    <div
                                        ...
                                        <NuxtImg :src="item.avatar" alt="" class="avatar-xs rounded-circle" />
                                    </div>
                                    <h5 class="mb-0 fs-base">
                                        <NuxtLink to="" data-sort="owner" class="link-reset">{{ item.email }}</NuxtLink>
                                    </h5>
                                </div>
                            </template>
                            <template #cell(shared)="{ item }">
                                <div class="avatar-group avatar-group-xs">
                                    <div v-for="(user, idx) in item.sharedWith" class="avatar" :key="idx">
                                        <NuxtImg :src="user.avatar" alt="" class="rounded-circle avatar-xs" />
                                    </div>
                            ...
                            <template #cell(action)="{ item }">
                                <div class="d-flex align-items-center justify-content-end gap-2">
                                    <span @click="item.starred = !item.starred">
                                        ...
                                        <a href="#" v-else>
                                            <Icon name="tabler:star-filled" class="text-muted fs-lg" />
                                        </a>
                                    </span>
                                    <BDropdown variant="link" toggle-class="drop-arrow-none fs-xxl link-reset p-0"
                                        ...
                                        <BDropdownItem>
                                            <Icon name="tabler:share" class="me-1" />
                                            Share
                                        </BDropdownItem>
                                        <BDropdownItem>
                                            <Icon name="tabler:link" class="me-1" />
                                            Get Sharable Link
                                        </BDropdownItem>
                                        <BDropdownItem>
                                            <Icon name="tabler:download" class="me-1" />
                                            Download
                                        </BDropdownItem>
                                        <BDropdownItem>
                                            <Icon name="tabler:pin" class="me-1" />
                                            Pin
                                        </BDropdownItem>
                                        <BDropdownItem>
                                            <Icon name="tabler:edit" class="me-1" />
                                            Edit
                                        </BDropdownItem>
                                        <BDropdownItem @click="handleDeleteItem(item)">
                                            <Icon name="tabler:trash" class="me-1" />
                                            Delete
                                        </BDropdownItem>
                                    </BDropdown>
                                </div>
...
import { BCard, BCardBody, BCardHeader, BCol, BContainer, BDropdown, BOffcanvas, type TableFieldRaw } from 'bootstrap-vue-next';
