                ...
                <BCardBody>
                  <div class="mb-3 d-flex justify-content-between align-items-center">
                    ...
                    <span
                      ...
                      <Icon
                        v-else-if="item.growth < 20 && item.growth > 0"
                  ...
                  <BProgress
                    ...
                    size="sm"
                    :variant="item.growth > 0 ? 'secondary' : 'danger'"
                    height="5px"
                    class="mb-0"
                  />
                </BCardBody>
...
import { orderStatistics, orderStatisticsChartOptions } from '@/views/dashboard/components/data'
</script>
