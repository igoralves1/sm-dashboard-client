...
const DefaultAlert = () => {
  return <ComponentCard title="Default Alert">
...
const DismissingAlert = () => {
  return <ComponentCard title="Dismissing Alert with Solid Colors">
...
const LinkColor = () => {
  return <ComponentCard title="Link Color">
      <div className="">
...
const AdditionalContent = () => {
  return <ComponentCard title="Additional Content">
...
const CustomAlerts = () => {
  return <ComponentCard title="Custom Alerts">
...
const LiveAlert = () => {
  ...
  return <ComponentCard title="Live Alert">
            ...
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0 fw-semibold" href="https://react-bootstrap.netlify.app/docs/components/alerts" target="_blank">
