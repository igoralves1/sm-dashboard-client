...
<head>
    <?php $title = "Nestable List"; include 'partials/title-meta.php' ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Miscellaneous"; $title = "Nestable List"; include 'partials/page-title.php' ?>
    ...
    <!-- nestable init js -->
    <script src="assets/js/pages/misc-nestable.js"></script>
