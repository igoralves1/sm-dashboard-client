            ...
            <div class="d-block">
                <div class="p-3 border-bottom">
                    ...
                    <div class="text-center mt-2">
                        <Link href="/chat" class="link-reset text-decoration-underline fw-semibold link-offset-3 d-flex align-items-center justify-content-center gap-1">
                            Go to Chat
                ...
                <div class="p-3">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <Link href="#" class="text-muted d-flex align-items-center fs-xs fw-semibold">
