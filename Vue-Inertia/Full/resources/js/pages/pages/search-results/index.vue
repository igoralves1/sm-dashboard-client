                    ...
                    <BCard no-body>
                        <BCardHeader class="d-block">
                            <div class="text-center w-md-75 w-xl-50 mx-auto py-3">
                                ...
                                <div class="d-flex justify-content-center align-items-center gap-1">
                                    ...
                                    <Link v-for="(item, idx) in ['Analytics', 'SaaS', 'Ecommerce', 'CRM']" :key="idx"
                                        href="#" class="badge bg-primary-subtle text-primary rounded-pill px-2 py-1 fs-6">
                                        {{ item }}
                                    </Link>
                                </div>
                            </div>
                        ...
                        <BCardBody class="p-0">
                            <div v-for="(item, idx) in searchResults" :key="idx"
                                ...
                                <h4 class="fs-md mb-1">
                                    <Link :href="item.url" target="_blank" class="text-reset">
                                        {{ item.title }}
                                    </Link>
                                </h4>
                                ...
                                <p class="d-flex flex-wrap gap-3 text-muted mb-1 align-items-center fs-base">
                                    <span class="d-flex align-items-center gap-1">
                                        ...
                                        <Link href="#" class="link-reset fw-semibold">{{ item.author }}</Link>
                                    </span>
