...
<head>
    <?php echo view("partials/title-meta", array("title" => "Checkbox Select Datatables")) ?>

    <!-- Datatables css -->
    <link href="/plugins/datatables/select.bootstrap5.min.css" rel="stylesheet" type="text/css">
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "DataTables", "title" => "Checkbox Select")) ?>
                    ...
                    <div class="col-xxl-10">
                        <div class="card">
                            <div class="card-header justify-content-between">
                                ...
                                <a href="https://datatables.net/extensions/select/examples/checkbox/checkbox.html" target="_blank" class="icon-link icon-link-hover link-primary fw-semibold">View Docs <i class="ti ti-arrow-right bi align-middle fs-lg"></i></a>
                            </div>
    ...
    <script src="/plugins/datatables/select.bootstrap5.min.js"></script>

    <!-- Page js -->
    <script src="/js/pages/datatables-checkbox-select.js"></script>
