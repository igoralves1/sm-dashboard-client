...
import { Button, Card, CardBody, CardHeader, CardTitle, Col, Container, OverlayTrigger, Popover, PopoverBody, PopoverHeader, Row } from 'react-bootstrap';
...
const SimplePopover = () => {
  ...
  return <ComponentCard title="Simple Popover">
...
const HoverPopovers = () => {
  ...
  return <ComponentCard title="Hover">
...
const CustomPopovers = () => {
  ...
  return <ComponentCard title="Custom Popovers">
...
const DismissOnPopover = () => {
  ...
  return <ComponentCard title="Dismiss on Next Click">
...
const FourDirections = () => {
  ...
  return <ComponentCard title="Four Directions">
      <div className="d-flex flex-wrap gap-2">
...
const DisabledPopover = () => {
  ...
  return <ComponentCard title="Disabled Elements">
            ...
            <Col xs={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/components/popovers/" target="_blank">
