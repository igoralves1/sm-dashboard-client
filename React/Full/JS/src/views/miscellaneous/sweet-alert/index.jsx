            ...
            <Table responsive className="mb-0">
              <tbody>
                <tr>
                  ...
                  <td>
                    <Button variant="primary" size="sm" onClick={() => showAlert({
                    title: 'Simple Alert',
                ...
                <tr>
                  ...
                  <td>
                    <div className="d-flex flex-wrap gap-2">
                      <Button variant="info" size="sm" onClick={() => showAlert({
                      ...
                      <Button variant="warning" size="sm" onClick={() => showAlert({
                      ...
                      <Button variant="danger" size="sm" onClick={() => showAlert({
                      ...
                      <Button variant="success" size="sm" onClick={() => showAlert({
                ...
                <tr>
                  ...
                  <td>
                    <Button variant="secondary" size="sm" onClick={() => showAlert({
                ...
                <tr>
                  ...
                  <td>
                    <Button variant="secondary" size="sm" onClick={() => ReactSwal.fire({
