...
const graphRoutes = [{
  ...
  path: '/graphs/echart/line',
  element: <EchartLine />
}, {
  path: '/graphs/echart/bar',
  element: <EchartBar />
}, {
  path: '/graphs/echart/pie',
  element: <EchartPie />
}, {
  path: '/graphs/echart/scatter',
  element: <EchartScatter />
}, {
  path: '/graphs/echart/geo-map',
  element: <EchartGeoMap />
}, {
  path: '/graphs/echart/gauge',
  element: <EchartGauge />
}, {
  path: '/graphs/echart/candlestick',
  element: <EchartCandlestick />
}, {
  path: '/graphs/echart/area',
  element: <EchartArea />
}, {
  path: '/graphs/echart/radar',
  element: <EchartRadar />
}, {
  path: '/graphs/echart/heatmap',
  element: <EchartHeatmap />
}, {
  path: '/graphs/echart/other',
  element: <EchartOther />
}, {
  path: '/graphs/apex-tree',
  element: <ApexTree />
}];
const formRoutes = [{
  path: '/forms/basic',
...
const allRoutes = [{
  ...
  }, ...dashboardRoutes, ...ecommerceRoutes, ...appsRoutes, ...otherAppsRoutes, ...pagesRoutes, ...miscellaneousRoutes, ...layoutRoutes, ...uiRoutes, ...componentRoutes, ...graphRoutes, ...formRoutes, ...tableRoutes, ...iconRoutes, ...mapRoutes]
}];
