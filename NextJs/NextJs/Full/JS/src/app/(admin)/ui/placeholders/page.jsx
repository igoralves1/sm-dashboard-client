...
const DefaultPlaceholders = () => {
  return <ComponentCard title="Placeholders">
...
const ColorPlaceholders = () => {
  return <ComponentCard title="Color">
      <p className="text-muted">
...
const WorksPlaceholder = () => {
  return <ComponentCard title="How it works">
      <p className="text-muted">
...
const AnimationPlaceholder = () => {
  return <ComponentCard title="Animation">
      <p className="text-muted">
          ...
          <Col xs={12}>
            <Card>
              ...
              <CardBody>
                ...
                <Link className="btn btn-link p-0 fw-semibold" href="https://react-bootstrap.netlify.app/docs/components/placeholder" target="_blank">
