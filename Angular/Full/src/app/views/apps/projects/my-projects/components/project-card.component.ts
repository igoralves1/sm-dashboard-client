            ...
            <div class="card-body">
                <div class="d-flex mb-4">
                    ...
                    <div>
                        ...
                        <span class="badge  {{getStatusVariant(project.status)}} fs-xxs badge-label">{{ toTitleCase(project.status)  }}</span>
                    </div>
                    <div class="ms-auto">
                        <div ngbDropdown>
                            <a href="javascript:void(0)" class="btn btn-icon btn-ghost-light text-muted drop-arrow-none" ngbDropdownToggle>
                                <ng-icon name="tablerDotsVertical" class="fs-xl"/>
                            </a>
                            <ul class="dropdown-menu-end" ngbDropdownMenu>
                                <li><a ngbDropdownItem href="javascript:void(0)"><ng-icon name="tablerShare" class="me-2"/>Share</a></li>
                                <li><a ngbDropdownItem href="javascript:void(0)"><ng-icon name="tablerEdit" class="me-2"/>Edit</a></li>
                                <li><a ngbDropdownItem href="javascript:void(0)"><ng-icon name="tablerBan" class="me-2"/>Block</a></li>
                                <li><a class="text-danger" ngbDropdownItem href="javascript:void(0)"><ng-icon
                                    name="tablerTrash" class="me-2"/>Delete</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
