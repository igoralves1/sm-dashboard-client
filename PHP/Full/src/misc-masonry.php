...
<head>
    <?php $title = "Masonry"; include 'partials/title-meta.php' ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Miscellaneous"; $title = "Masonry"; include 'partials/page-title.php' ?>
                ...
                <div class="row" data-masonry='{"percentPosition": true }'>
                        ...
                        <article class="card">
                            ...
                            <div class="card-body">
                                ...
                                <h6 class="card-title fs-lg lh-base mb-2">
                                    <a href="article.php" class="link-reset">Mastering Figma: 7 Pro Tips for Better UI Design</a>
                                </h6>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <article class="card">
                            ...
                            <!-- Card image -->
                            <img class="card-img-top" src="assets/images/blog/blog-1.jpg" alt="Building APIs">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <article class="card bg-danger bg-gradient">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Title -->
                                <h6 class="card-title fs-lg lh-base mb-2">
                                    <a href="article.php" class="text-white">AI Breakthroughs to Watch in 2025</a>
                                </h6>
                            ...
                            <div class="card-footer bg-transparent d-flex justify-content-between border-light border-opacity-25">
                                ...
                                <a class="text-white fw-semibold" href="article.php">Read more <i class="ti ti-arrow-right"></i></a>
                            </div>
                        </article>
                    ...
                    <div class="col-xl-3 col-md-6">
                        <article class="card">
                            ...
                            <!-- Card image -->
                            <img class="card-img-top" src="assets/images/blog/blog-2.jpg" alt="SEO Strategies">

                            <!-- Card Body -->
                            <div class="card-body">
                                <!-- Title -->
                                <h6 class="card-title fs-lg lh-base mb-2">
                                    <a href="article.php" class="link-reset">SEO Strategies for 2025: How to Rank Higher</a>
                                </h6>
                                <p class="mb-3 text-muted">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <article class="card">
                            ...
                            <!-- Card image -->
                            <img class="card-img-top" src="assets/images/gallery/8.jpg" alt="Building APIs">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <article class="card">
                            ...
                            <!-- Card image -->
                            <img class="card-img-top" src="assets/images/blog/blog-3.jpg" alt="Entrepreneur Tips">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <article class="card">
                            ...
                            <!-- Card image -->
                            <img class="card-img-top" src="assets/images/stock/small-4.jpg" alt="Tech Innovations">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <article class="card bg-secondary bg-gradient">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Title -->
                                <h6 class="card-title fs-lg lh-base mb-2">
                                    <a href="article.php" class="text-white">Cyber Threats to Watch Out for in 2025</a>
                                </h6>
                                <p class="mb-3 text-white-50">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <article class="card">
                            ...
                            <!-- Card image -->
                            <img class="card-img-top" src="assets/images/blog/blog-5.jpg" alt="Data Science Trends">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <article class="card">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Title -->
                                <h6 class="card-title fs-lg lh-base mb-2">
                                    <a href="article.php" class="link-reset">Web Design Trends to Watch in 2025</a>
                                </h6>
                                <p class="mb-3 text-muted">
                    ...
                    <div class="col-xl-3 col-md-6">
                        <article class="card bg-success bg-gradient">
                            ...
                            <div class="card-body">
                                ...
                                <!-- Title -->
                                <h6 class="card-title fs-lg lh-base mb-2">
                                    <a href="article.php" class="text-white">Sustainable Technologies Shaping the Future</a>
                                </h6>
                                <p class="mb-3 text-white-50">
