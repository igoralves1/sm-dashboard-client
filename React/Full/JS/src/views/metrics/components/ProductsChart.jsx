...
import { getProductsChartOptions } from '@/views/metrics/data';
const ProductsChart = () => {
  return <Card className="text-bg-secondary border-0">
      <CardBody className="p-0">
        ...
        <CustomEChart extensions={[LineChart, TooltipComponent, CanvasRenderer]} getOptions={getProductsChartOptions} style={{
        height: 120
      }} />
      </CardBody>
    </Card>;
