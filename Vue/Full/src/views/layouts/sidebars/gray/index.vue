<template>
  <MainLayout>
    <BContainer fluid>
      <PageBreadcrumb title="Gray Sidebar" />
        ...
        <BCol cols="12">
          ...
          >
            ...
            <div>
              ...
              <code>data-menu-color="gray"</code> to the <code>&lt;html&gt;</code> tag. To apply
              this dynamically, use <code>setSideNavColor('gray')</code> from the
              <code>useLayout</code>.
            </div>
          </BAlert>
        </BCol>
