                            ...
                            <BCardBody class="px-4">
                                <div class="d-flex align-items-center justify-content-between mb-3 border-bottom pb-3">
                                    <div class="auth-brand mb-0">
                                        <NuxtLink to="/" class="logo-dark">
                                            <NuxtImg :src="logoDark" alt="dark logo" height="36" width="127.8" />
                                        </NuxtLink>
                                        <NuxtLink to="/" class="logo-light">
                                            <NuxtImg :src="logoLight" alt="logo" height="36" width="127.8" />
                                        </NuxtLink>
                                    </div>
                                    <div class="text-end">
                                        <span
                                            class="badge bg-warning-subtle text-warning mb-2 fs-xs px-2 py-1">Pending</span>
                                ...
                                <BRow>
                                    ...
                                    <BCol cols="4" class="text-end">
                                        <NuxtImg :src="qrImg" alt="Barcode" class="img-fluid" height="80" width="80"
                                            style="max-height: 80px;" />
                                    </BCol>
                                </BRow>

                                <BTableSimple responsive bordered class="table-nowrap text-center align-middle mt-4">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="text-end">{{ currency }}350.00</td>
                                        </tr>
                                        <tr>
                                            <td>02</td>
                                            <td class="text-start">
                                            ...
                                            <td class="text-end">{{ currency }}600.00</td>
                                        </tr>
                                        <tr>
                                            <td>03</td>
                                            <td class="text-start">
                                            ...
                                            <td class="text-end">{{ currency }}220.00</td>
                                        </tr>
                                        <tr>
                                            <td>04</td>
                                            <td class="text-start">
                                            ...
                                            <td class="text-end">{{ currency }}100.00</td>
                                        </tr>
                                    </tbody>
                                </BTableSimple>

                                <div class="d-flex justify-content-end">
                                    <BTableSimple class="table w-100 table-borderless text-end">
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-danger">- {{ currency }}63.50</td>
                                            </tr>
                                            <tr>
                                ...
                                <div class="mt-lg-4 mt-2 bg-light bg-opacity-50 rounded px-3 py-2">
                                    <p class="mb-0 text-muted">
                                        <strong>Note:</strong> Please make payment within 10 days. For any billing
                                        inquiries,
                                        contact
                                        <NuxtLink to="mailto:billing@alinadesignco.com" class="fw-medium">
                                ...
                                <div class="mt-4">
                                    ...
                                    <NuxtImg :src="sign" alt="Company Logo" height="42" width="176.14" />
                            ...
                            <BCardBody>
                                <div class="justify-content-center d-flex flex-column gap-2">
                                    <BButton variant="light">
                                        <Icon name="tabler:pencil" class="me-1" /> Edit
                                    </BButton>
                                    <clientOnly>
                                        <BButton variant="primary" @click="handlePrint">
                                            <Icon name="tabler:printer" class="me-1" /> Print
                                        </BButton>
                                    </clientOnly>
                                    <BButton variant="info">
                                        <Icon name="tabler:download" class="me-1" /> Download
                                    </BButton>
...
import { BButton, BCard, BCardBody, BCol, BRow, BTableSimple } from 'bootstrap-vue-next'
