...
<head>
    <?php $title = "Blog Article"; include 'partials/title-meta.php' ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Apps"; $title = "Companies"; include 'partials/page-title.php' ?> {"subtitle": "Apps", "title":"Article"})
                            ...
                            <div class="card-body p-lg-5">
                                ...
                                <div class="row g-5">
                                    ...
                                    <div class="col-lg-8">
                                        ...
                                        <!-- Image -->
                                        <img src="assets/images/blog/blog-post.jpg" class="img-fluid rounded mt-4" alt="blog-img">
                                        ...
                                        <div class="d-flex align-items-center gap-4 border mt-4 border-dashed p-4 rounded mb-14">
                                            <div class="text-center flex-shrink-0 me-7 me-lg-13">
                                                <div class="mb-2">
                                                    <img src="assets/images/users/user-1.jpg" class="avatar-xl rounded-circle" alt=""> 
                                                </div>
                                                <div class="mb-0">
