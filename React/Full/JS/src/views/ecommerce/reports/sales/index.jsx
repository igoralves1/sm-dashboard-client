...
import SalesChart from '@/views/ecommerce/reports/sales/components/SalesChart';
import SalesTable from '@/views/ecommerce/reports/sales/components/SalesTable';
const Page = () => {
          ...
          <Card data-table data-table-rows-per-page={8}>
            <CardHeader className="border-light justify-content-between">
              ...
              <div className="d-flex align-items-center gap-2">
                ...
                <div className="app-search">
                  <Flatpickr className="form-control" style={{
                  minWidth: 250
                }} options={{
                  dateFormat: 'd M, Y',
                  mode: 'range',
