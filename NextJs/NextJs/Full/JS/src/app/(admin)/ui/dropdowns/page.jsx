...
const SingleButtonDropdowns = () => {
  return <ComponentCard title="Single Button Dropdowns">
...
const MenuAlignment = () => {
  return <>
      <ComponentCard title="Menu Alignment">
        <p className="text-muted">
...
const CustomDropdownArrow = () => {
  return <>
      <ComponentCard title="Custom Dropdown Arrow">
        <p className="text-muted">
          Any single <code>.btn</code> can be turned into a dropdown toggle with some markup changes. Here’s how you can put them to work with either
          <code>&lt;button&gt;</code>
          elements:
...
const DropupVariation = () => {
  return <>
      <ComponentCard title="Dropup Variation">
        <div className="">
          <p className="text-muted">
...
const DropstartVariation = () => {
  return <>
      <ComponentCard title="Dropstart variation">
        <div className="">
          <p className="text-muted">
...
const DropendVariation = () => {
  return <>
      <ComponentCard title="Dropend variation">
        <div className="">
          <p className="text-muted">
            Trigger dropdown menus at the right of the elements by adding
...
const ActiveItem = () => {
  return <ComponentCard title="Active Item">
      <p className="text-muted">
...
const DisabledItem = () => {
  return <ComponentCard title="Disabled Item">
      <p className="text-muted">
...
const Headers = () => {
  return <ComponentCard title="Headers">
...
const DarkDropdowns = () => {
  return <ComponentCard title="Dark dropdowns">
      <p className="text-muted">
...
const CenteredDropdowns = () => {
  return <ComponentCard title="Centered dropdowns">
      <p className="text-muted">
...
const DropdownOptions = () => {
  return <>
      <ComponentCard title="Dropdown Options">
        <div className="">
          <p className="text-muted">
...
const AutoCloseBehavior = () => {
  return <ComponentCard title="Auto close behavior">
      <p className="text-muted">
...
const Text = () => {
  return <ComponentCard title="Text">
      <p className="text-muted">
...
const FormsDropdown = () => {
  return <ComponentCard title="Forms">
      <p className="text-muted">
            ...
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0 fw-semibold" href="https://react-bootstrap.netlify.app/docs/components/dropdowns" target="_blank">
