...
<head>
    <?php echo view("partials/title-meta", array("title" => "Export Data Datatables")) ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "Datatables", "title" => "Export Data")) ?>
    ...
    <!-- Page js -->
    <script src="/js/pages/datatables-export-data.js"></script>
