'use client'
import { MasonryCardType, masonryItems } from '@/app/(admin)/miscellaneous/masonry/data'
          ...
          {data.tags && (
            <div>
              {data.tags.map((tag, idx) => (
                <Link key={idx} href="#" className={`badge badge-label badge-default ${idx != data.tags!.length - 1 ? 'me-1' : ''}`}>
                  {tag}
                </Link>
              ))}
            </div>
