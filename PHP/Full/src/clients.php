...
<head>
    <?php $title = "Clients"; include 'partials/title-meta.php' ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php $subtitle = "Apps"; $title = "Clients"; include 'partials/page-title.php' ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Emily
                                                                Parker</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Liam
                                                                Scott</a></h5>
                                            ...
                                            <td><span class="badge p-1 text-bg-light fs-sm"><img src="assets/images/flags/gb.svg" alt="" class="rounded-circle me-1" height="12"> UK</span></td>
                                            <td>Jan 15, 2024</td>
                                            <td>Contract</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Sofia
                                                                Müller</a></h5>
                                            ...
                                            <td><span class="badge p-1 text-bg-light fs-sm"><img src="assets/images/flags/de.svg" alt="" class="rounded-circle me-1" height="12"> DE</span></td>
                                            <td>Mar 12, 2024</td>
                                            <td>Project</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Carlos
                                                                Méndez</a></h5>
                                            ...
                                            <td><span class="badge p-1 text-bg-light fs-sm"><img src="assets/images/flags/mx.svg" alt="" class="rounded-circle me-1" height="12"> MX</span></td>
                                            <td>Jan 8, 2024</td>
                                            <td>Contract</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Nina
                                                                Patel</a></h5>
                                            ...
                                            <td><span class="badge p-1 text-bg-light fs-sm"><img src="assets/images/flags/in.svg" alt="" class="rounded-circle me-1" height="12"> IN</span></td>
                                            <td>Feb 19, 2024</td>
                                            <td>Project</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Oliver
                                                                Chen</a></h5>
                                            ...
                                            <td>+65 6789 1234</td>
                                            <td><span class="badge p-1 text-bg-light fs-sm"><img src="assets/images/flags/sg.svg" alt="" class="rounded-circle me-1" height="12"> SG</span></td>
                                            <td>Jan 30, 2024</td>
                                            <td>Retainer</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Maya
                                                                Tanaka</a></h5>
                                            ...
                                            <td><span class="badge p-1 text-bg-light fs-sm"><img src="assets/images/flags/jp.svg" alt="" class="rounded-circle me-1" height="12"> JP</span></td>
                                            <td>Mar 5, 2024</td>
                                            <td>Project</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Lucas
                                                                Ferreira</a></h5>
                                            ...
                                            <td><span class="badge p-1 text-bg-light fs-sm"><img src="assets/images/flags/br.svg" alt="" class="rounded-circle me-1" height="12"> BR</span></td>
                                            <td>Feb 24, 2024</td>
                                            <td>Contract</td>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Anna
                                                                Schmidt</a></h5>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="d-flex justify-content-start align-items-center gap-2">
                                                    ...
                                                    <div>
                                                        <h5 class="text-nowrap mb-0 lh-base fs-base"><a data-sort="name" href="pages-profile.php" class="link-reset">Jason
                                                                Lee</a></h5>
                                            ...
                                            <td><span class="badge p-1 text-bg-light fs-sm"><img src="assets/images/flags/au.svg" alt="" class="rounded-circle me-1" height="12"> AU</span></td>
                                            <td>Mar 14, 2024</td>
                                            <td>Contract</td>
                                            <td>Web Developer</td>
                                            <td><span class="badge bg-success-subtle text-success badge-label">Active</span>
