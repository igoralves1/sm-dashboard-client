...
const BasicBadges = () => {
  return <ComponentCard title="Basic Badges">
      ...
      <span className="badge me-1 text-bg-purple">Purple</span>
    </ComponentCard>;
};
const BasicPillBadges = () => {
  return <ComponentCard title="Basic Pill Badges">
      <p className="text-muted">
...
const OutlineBadges = () => {
  return <ComponentCard title="Outline Badges">
      <p className="text-muted">
      ...
      <span className="me-1 badge badge-outline-purple">Purple</span>
    </ComponentCard>;
};
const OutlinePillBadges = () => {
  return <ComponentCard title="Outline Badges">
      ...
      <span className="me-1 badge badge-outline-purple rounded-pill">Purple</span>
    </ComponentCard>;
};
const LightenBadges = () => {
  return <ComponentCard title="Lighten Badges">
      <p className="text-muted">
      ...
      <span className="me-1 badge badge-soft-purple">Purple</span>
    </ComponentCard>;
};
const LightenPillBadges = () => {
  return <ComponentCard title="Lighten Pill Badges">
      <p className="text-muted">
        Use the <code>.badge-soft--*</code> modifier class to make badges lighten.
      </p>
      ...
      <span className="me-1 badge rounded-pill badge-soft-purple">Purple</span>
    </ComponentCard>;
};
const LabelBadges = () => {
  return <ComponentCard title="Label Badges">
      <p className="text-muted">
      ...
      <span className="me-1 badge badge-label text-bg-purple">Purple</span>
    </ComponentCard>;
};
const SquareBadges = () => {
  return <ComponentCard title="Square Badges">
      <p className="text-muted">
      ...
      <span className="me-1 badge badge-square text-bg-purple">9</span>
    </ComponentCard>;
};
const CircleBadges = () => {
  return <ComponentCard title="Circle Badges">
      <p className="text-muted">
      ...
      <span className="me-1 badge badge-circle text-bg-purple">9</span>
    </ComponentCard>;
};
const Positioned = () => {
  return <ComponentCard title="Positioned">
      <p className="text-muted">
...
const HeadingswithBadges = () => {
  return <ComponentCard title="Headings with Badges">
      <h1>
            ...
            <Col xl={12}>
              <Card>
                ...
                <CardBody>
                  ...
                  <Link className="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/components/badge/" target="_blank">
