    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "Invoices", "title" => "Invoice Details")) ?>
                                    ...
                                    <div class="card-body px-4">
                                        ...
                                        <div class="d-flex align-items-center justify-content-between mb-3 border-bottom pb-3">
                                            <div class="auth-brand mb-0">
                                                <a href="/" class="logo-dark">
                                                    <img src="/images/logo-black.png" alt="dark logo" height="36">
                                                </a>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4 text-end">
                                                <img src="/images/qr.png" alt="Barcode" class="img-fluid" style="max-height: 80px;">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mt-4">
                                            ...
                                            <!-- <h4 class="fst-italic">WebAppLayers</h4> -->
                                            <img src="/images/sign.png" alt="Company Logo" height="42">
