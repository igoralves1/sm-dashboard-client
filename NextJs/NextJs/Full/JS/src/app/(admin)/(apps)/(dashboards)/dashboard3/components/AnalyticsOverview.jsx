      ...
      <CardBody className="p-0">
        <Row className="g-0">
          <Col xxl={3} className="order-2 order-xxl-1">
            ...
            }, idx) => <Col lg={6} xl={6} xxl={12} key={title}>
                  <div className={clsx('p-3 rounded m-1 border border-dashed', idx !== 0 && 'mt-xxl-0 ')}>
                    <div className="d-flex justify-content-between align-items-center">
                      <div>
                        <h3 className="mb-1">
                          <span>
                            <CountUpClient duration={1} end={value} decimals={2} enableScrollSpy scrollSpyOnce />
                          </span>
                          {unit}&nbsp;
            ...
            <CardHeader className="justify-content-between border-dashed">
              ...
              <div className="d-flex flex-wrap gap-1">
                <Button variant="primary" size="sm">
                  <TbDownload size={13} className="me-1" /> Export CSV
                </Button>
              </div>
            </CardHeader>
