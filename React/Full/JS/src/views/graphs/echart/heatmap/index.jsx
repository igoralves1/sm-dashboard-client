      ...
      <Row>
        <Col xl={6}>
          <ComponentCard title="Basic Heatmap Chart">
            <CustomEChart extensions={[RadarChart, CanvasRenderer]} getOptions={getBasicBasicHeatmapChart} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
        <Col xl={6}>
          <ComponentCard title="Heatmap Chart">
            <CustomEChart extensions={[RadarChart, CanvasRenderer]} getOptions={getHeatmapChart} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
        <Col xl={6}>
          <ComponentCard title="Heatmap - 20K Data Chart">
            <CustomEChart extensions={[RadarChart, CanvasRenderer]} getOptions={getHeatmapDataChart} style={{
            height: '300px'
          }} />
          </ComponentCard>
        </Col>
