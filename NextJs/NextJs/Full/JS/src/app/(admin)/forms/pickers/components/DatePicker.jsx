...
const BasicDatePicker = () => {
  ...
  return <Row className="g-4">
      ...
      <Col lg={6}>
        <DatePickerClient className="form-control" selected={selected} onChange={date => setSelected(date)} />
      </Col>
    </Row>;
};
const MultipleMonthsDatePicker = () => {
  ...
  return <Row className="g-4">
      ...
      <Col lg={6}>
        <DatePickerClient className="form-control" selected={selected} onChange={date => setSelected(date)} monthsShown={2} />
      </Col>
    </Row>;
};
...
const DatePickerSpecificRange = () => {
  ...
  return <Row className="g-4">
      ...
      <Col lg={6}>
        <DatePickerClient className="form-control" selected={selected} onChange={date => setSelected(date)} minDate={new Date()} maxDate={new Date(new Date().setDate(new Date().getDate() + 7))} />
      </Col>
    </Row>;
};
const DatePickerWithTime = () => {
  ...
  return <Row className="g-4">
      ...
      <Col lg={6}>
        <DatePickerClient className="form-control" selected={selected} onChange={date => setSelected(date)} showTimeSelect timeFormat="HH:mm" dateFormat="MMMM d, yyyy h:mm aa" />
      </Col>
    </Row>;
};
const TimeOnlyDatePicker = () => {
  ...
  return <Row className="g-4">
      ...
      <Col lg={6}>
        <DatePickerClient className="form-control" selected={selected} onChange={date => setSelected(date)} showTimeSelect showTimeSelectOnly dateFormat="h:mm aa" />
      </Col>
    </Row>;
};
const DatePicker = () => {
  return <Card>
      ...
      <CardBody>
        <p className="text-muted mb-2">A simple and reusable datepicker component for React.</p>

        <Link className="btn btn-link p-0 fw-semibold" href="https://reactdatepicker.com/" target="_blank">
          React DatePicker
