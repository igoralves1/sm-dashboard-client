            ...
            <BCol xxl="10">
                <BCard no-body>
                    ...
                    <BCardBody>
                        ...
                        <p class="text-muted">
                            The Idle Timer plugin allows you to monitor user activity on the page. Idle is defined as a
                            lack of mouse movement, scrolling, or keyboard input.
                        </p>

                        <div class="text-center p-3 h-200">
                            <Icon name="tabler:hand-finger" class="fs-36 mb-3 d-block mx-auto" />
