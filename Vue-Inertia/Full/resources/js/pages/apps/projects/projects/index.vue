                        ...
                        <BRow class="gap-3">
                                    ...
                                    <div class="col-auto">
                                        <div class="d-flex flex-wrap align-items-center gap-2">
                                            ...
                                            <div class="app-search">
                                                ...
                                                <Icon icon="lucide:users" class="app-search-icon text-muted" />
                                            </div>
                            ...
                            <div class="col-auto">
                                <div class="d-flex gap-1">
                                    <Link href="/projects" class="btn btn-primary btn-icon">
                                    <Icon icon="lucide:layout-grid" class="fs-lg" />
                                    </Link>
                                    <Link href="/projects-list" class="btn btn-soft-primary btn-icon">
