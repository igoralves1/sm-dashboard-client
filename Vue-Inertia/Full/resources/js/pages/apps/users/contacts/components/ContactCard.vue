    ...
    <BCard no-body class="card-h-100">
        <BCardBody>
            <div class="d-flex align-items-center mb-4">
                ...
                <div>
                    <h5 class="mb-1 d-flex align-items-center">
                        <Link href="/pages/profile" class="link-reset">{{ contact.name }}</Link>
            ...
            <ul class="list-unstyled text-muted mb-4">
                ...
                <li class="mb-2" v-if="contact.mobileNo">
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <h5 class="fs-base mb-0 fw-medium">
                            <Link href="">{{ contact.mobileNo }}</Link>
                        </h5>
                    </div>
                </li>
            ...
            <div class="d-flex justify-content-between align-items-center">
                ...
                <Link  href="/pages/profile"  class="btn btn-soft-primary btn-sm rounded-pill">
                    View Profile
                </Link>
            </div>
        </BCardBody>
