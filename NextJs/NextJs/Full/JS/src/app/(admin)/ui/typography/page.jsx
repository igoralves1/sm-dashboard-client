...
const DisplayHeadings = () => {
  return <ComponentCard title="Display Headings">
...
const Headings = () => {
  return <ComponentCard title="Headings">
      <h1>
...
const NamingASource = () => {
  return <ComponentCard title="Naming a Source">
...
const Unordered = () => {
  return <ComponentCard title="Unordered">
...
const Ordered = () => {
  return <ComponentCard title="Ordered">
...
const Unstyled = () => {
  return <ComponentCard title="Unstyled">
...
const Blockquotes = () => {
  return <ComponentCard title="Blockquotes">
      <p className="text-muted">
...
const DescriptionListAlignment = () => {
  return <ComponentCard title="Description List Alignment">
      <p className="text-muted">
          ...
          <Col xl={12}>
            <Card>
              ...
              <CardBody>
                ...
                <Link className="btn btn-link p-0 fw-semibold" href="https://getbootstrap.com/docs/5.3/content/typography/" target="_blank">
