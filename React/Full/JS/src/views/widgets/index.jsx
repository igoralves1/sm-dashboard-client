...
import FileManageCard from '@/views/widgets/components/FileMangeCard';
import Widget3 from '@/views/widgets/components/Widget3';
import Widget6 from '@/views/widgets/components/Widget6';
import Widget7 from '@/views/widgets/components/Widget7';
import Widget5 from '@/views/widgets/components/Widget5';
import Widget4 from '@/views/widgets/components/Widget4';
import TodaySchedule from '@/views/widgets/components/TodaySchedule';
