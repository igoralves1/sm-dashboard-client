<template>
    <div class="d-flex align-items-center justify-content-between">
        ...
        <div class="flex-grow-1 d-inline-flex align-items-center justify-content-end fs-lg">
            <Icon icon="tabler:star-filled" class="text-warning"/>
            <Icon icon="tabler:star-filled" class="text-warning"/>
            <Icon icon="tabler:star-filled" class="text-warning"/>
            <Icon icon="tabler:star-filled" class="text-warning"/>
            <Icon icon="tabler:star-filled" class="text-warning"/>
            <span class="ms-1 fs-base"><Link href="/reviews" class="link-reset fw-medium">(859 Reviews)</Link>
            </span>
        </div>
    </div>
    <div class="mt-3 mb-5">
    ...
    <Link href="" class="link-primary fw-semibold">Read More...</Link>
