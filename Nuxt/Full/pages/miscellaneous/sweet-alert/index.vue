                            ...
                            <table class="table mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button type="button" class="btn btn-sm btn-primary"
                                                @click="executeExample('customHtml')">Toggle HTML SweetAlert</button>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <h5 class="mb-1">All States</h5>
                                            <p class="text-muted mb-0">Examples of SweetAlert in different alert states.
                                            </p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p class="text-muted mb-0">A popup with extended content for demonstration.
                                            </p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p class="text-muted mb-0">A confirmation dialog with an attached action.
                                            </p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p class="text-muted mb-0">Displays a popup that closes automatically after
                                                a timeout.</p>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        <td>
                                            ...
                                            <p class="text-muted mb-0">Shows the alert in different screen positions.
                                            </p>
                                        </td>
                                        <td>
                                            <div class="d-flex flex-wrap gap-2">
