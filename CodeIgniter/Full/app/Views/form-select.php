...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "Forms", "title" => "Select")) ?>
    ...
    <!-- Tagify Plugin Js -->
    <script src="/js/plugins/tagify/tagify.js"></script>
    <script src="/js/plugins/dragsort/dragsort.js"></script>

    <!-- Select2 Plugin Js -->
    <script src="/plugins/select2/select2.min.js"></script>

    <!-- Choices Demo Js-->
    <script src="/js/pages/form-choice.js"></script>

    <!-- Tagify Demo Js -->
    <script src="/js/pages/form-tagify.js"></script>
