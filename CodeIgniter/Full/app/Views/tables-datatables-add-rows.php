...
<head>
    <?php echo view("partials/title-meta", array("title" => "Add New Row Datatables")) ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                ...
                <?php echo view("./partials/page-title", array("subtitle" => "DataTables", "title" => "Add Rows")) ?>
    ...
    <!-- Page js -->
    <script src="/js/pages/datatables-add-rows.js"></script>
