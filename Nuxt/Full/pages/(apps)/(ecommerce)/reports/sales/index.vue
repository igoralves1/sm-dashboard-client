                ...
                <BCard no-body>
                    <BCardHeader class="border-light justify-content-between">
                        ...
                        <div class="d-flex align-items-center gap-2">
                            ...
                            <div class="app-search">
                                <FlatPickr v-model="date" :config="config" type="text" style="min-width: 250px;"
                                    class="form-control" />
                                <Icon size="18" name="lucide:calendar" class="app-search-icon text-muted" />
                            </div>

                            <button type="submit" class="btn btn-secondary">
                                <Icon name="tabler:download" class="me-2" />
                                Export Report
                            </button>
                        </div>
                    </BCardHeader>
                    ...
                    <BCardBody>
                        <CustomApexChart :get-options="getSalesChartOptions" :series="getSalesChartOptions().series" />
                    </BCardBody>
