                    ...
                    <BCol xs="12">
                        <BCard no-body>
                            <BCardHeader class="border-light justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-2">
                                    ...
                                    <div class="app-search">
                                        ...
                                        <Icon name="lucide:tag" size="18" class="app-search-icon text-muted" />
                                    </div>
                                    ...
                                    <div class="app-search">
                                        ...
                                        <Icon name="lucide:box" size="18" class="app-search-icon text-muted" />
                                    </div>
                                    ...
                                    <div class="app-search">
                                        ...
                                        <Icon name="lucide:dollar-sign" size="18" class="app-search-icon text-muted" />
                                    </div>
                                ...
                                <div class="d-flex gap-1">
                                    <NuxtLink to="/products-grid" class="btn btn-soft-primary btn-icon">
                                        <Icon name="lucide:layout-grid" class="fs-lg" />
                                    </NuxtLink>
                                    <NuxtLink to="/products" class="btn btn-primary btn-icon">
                            ...
                            <BTable show-empty :filter="searchQuery" empty-text="No products found."
                                ...
                                :items="products" :per-page="perPage" :current-page="currentPage" @filtered="onFiltered"
                                ...
                                <template #cell(name)="data">
                                    <div class="d-flex">
                                        <div class="avatar-md me-3">
                                            <NuxtImg :src="data.item.image" alt="Product" class="img-fluid rounded" />
                                        </div>
                                        <div>
                                            <h5 class="mb-1">
                                                <NuxtLink to="/ecommerce/product-details" class="link-reset">{{
                                                    data.item.name
                                                    }}
                                                </NuxtLink>
                                            </h5>
                                ...
                                <template #cell(rating)="data">
                                    ...
                                    <NuxtLink to="/ecommerce/reviews" class="link-reset ms-1 fw-semibold">
                                        ({{ data.item.reviews }})</NuxtLink>
                                ...
                                <template #cell(publishDate)="data">
                                    {{ data.item.publishedDate }} <small class="text-muted">{{ data.item.publishedTime
                                    }}</small>
                                </template>
