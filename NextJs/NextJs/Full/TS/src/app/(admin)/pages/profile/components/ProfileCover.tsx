...
const ProfileCover = () => {
  return (
    <article className="card card-out-of-container border-top-0">
      <div className="position-relative card-side-img overflow-hidden" style={{ height: '250px', backgroundImage: `url(${profileBg.src})` }}>
        ...
        <div className="d-flex justify-content-between align-items-center">
          <div className="d-flex justify-content-start align-items-center gap-3">
            <div className="avatar avatar-xxl">
              <Image src={user2.src} width={80} height={80} alt="avatar-2" className="img-fluid img-thumbnail rounded-circle" />
            </div>
            <div>
