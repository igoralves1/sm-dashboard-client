...
<head>
    <?php echo view("partials/title-meta", array("title" => "Forms Layout")) ?>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                <?php echo view("./partials/page-title", array("subtitle" => "Forms", "title" => "Layouts")) ?>
            </div>
                            ...
                            <div class="card-body">
                                <div class="row g-4 align-items-center">
                                    ...
                                    <div class="col-sm-6 text-center">
                                        ...
                                        <a href="auth-sign-up" class="link-primary text-decoration-underline fw-semibold link-offset-3">Create Your Account</a>
                                    </div>
                                </div> <!-- end row-->
                            </div> <!-- end card-body-->
                        </div> <!-- end card-->
