<template>
  <section class="bg-light bg-opacity-50 border-top border-light position-relative" id="home">
    <div class="position-absolute top-0 start-50 translate-middle-x mt-5">
      <NuxtImg src="/images/bg-pattern.png" alt="bg pattern"/>
    </div>
        ...
        <BCol lg="8" class="mx-auto text-center">
          ...
          <div class="avatar-group avatar-group-sm justify-content-center mt-2">
            <div class="avatar" v-for="(img, index) in avatars" :key="index">
              <NuxtImg :src="img" alt="user" class="avatar-sm rounded-circle"/>
            </div>
          </div>
          ...
          <div class="d-flex gap-1 gap-sm-2 flex-wrap justify-content-center">
            <NuxtLink to="/" class="btn btn-secondary py-2 fw-semibold">
              <Icon name="tabler:basket" class="fs-xl me-2"/>
              Buy Now!
            </NuxtLink>
            <a
                ...
                target="_blank"
            >
              <Icon name="tabler:confetti" class="fs-xl me-2"/>
              Contact Us
            </a>
          </div>
        </BCol>
...
const avatars: string[] = [
  '/images/users/user-7.jpg',
  '/images/users/user-8.jpg',
  '/images/users/user-9.jpg',
