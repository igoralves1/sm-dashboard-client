...
import { getSellerReportChartOptions, sellers } from '../data';
...
const SellersCard = () => {
  const columns = [{
    ...
    cell: ({
      row
    }) => <CustomApexChart getOptions={() => getSellerReportChartOptions(row.original.chartType)} series={getSellerReportChartOptions(row.original.chartType).series} type={row.original.chartType} width={100} height={30} />
  })];
