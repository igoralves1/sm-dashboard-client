...
import { getOrderChartOptions } from '@/views/metrics/data';
const OrdersCard = () => {
  return <Card>
      <CardBody className="p-0">
        ...
        <div className="mb-3">
          <CustomEChart extensions={[BarChart, TooltipComponent, CanvasRenderer]} getOptions={getOrderChartOptions} style={{
          height: 120
        }} />
        </div>
      </CardBody>
