      ...
      <CardBody>
          ...
          <div className="d-flex justify-content-between align-items-center">
            <div className="avatar-group avatar-group-xs">
              <div className="avatar">
                <Image src={user5} alt="Liam Carter" className="avatar-xs rounded-circle" />
              </div>
              <div className="avatar">
                <Image src={user6} alt="Zoe Miles" className="avatar-xs rounded-circle" />
              </div>
        ...
        <div className="py-2 border-bottom border-light border-dashed">
          ...
          <div className="d-flex justify-content-between align-items-center">
            <div className="avatar-group avatar-group-xs">
              <div className="avatar">
                <Image src={user7} alt="Ava Lee" className="avatar-xs rounded-circle" />
              </div>
              <div className="avatar">
                <Image src={user8} alt="Ethan King" className="avatar-xs rounded-circle" />
              </div>
              <div className="avatar">
                <Image src={user9} alt="Lucas White" className="avatar-xs rounded-circle" />
              </div>
            </div>
            <Button variant="soft-secondary" type="button" size={'sm'} className="rounded-circle btn-icon">
