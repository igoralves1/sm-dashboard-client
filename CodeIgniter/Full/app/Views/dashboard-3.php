...
<head>
    <?php echo view("partials/title-meta", array("title" => "Dashboard 3")) ?>
...
<body>
    ...
    <div class="wrapper">
        ...
        <div class="content-page">
            ...
            <div class="container-fluid">
                <?php echo view("./partials/page-title", array("title" => "Dashboard 3")) ?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
    ...
    <!-- Dashboard 3 Page Js-->
    <script src="/js/pages/dashboard-3.js"></script>
