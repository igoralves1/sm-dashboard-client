...
import { files, teamMembers } from '@/app/(admin)/(apps)/(projects)/projects/[projectId]/data';
import { formatBytes } from '@/helpers/file';
const Sidebar = () => {
  return <Card className="card-h-100 rounded-0 rounded-end">
      <CardBody className="p-0">
        ...
        <div className="p-3 border-bottom border-dashed">
          <div className="d-flex mb-3 justify-content-between align-items-center">
            ...
            <a href="#" className="btn btn-light btn-sm btn-icon rounded-circle">
              <TbPlus />
            </a>
          </div>

          {teamMembers.map((member, idx) => <div className={clsx('d-flex justify-content-between align-items-center', {
          'pb-2': idx !== teamMembers.length - 1
        })} key={idx}>
              <div className="d-flex align-items-center py-1 gap-2">
                <div className="avatar avatar-sm">
                  <Image src={member.avatar} alt="avatar-3" className="img-fluid rounded-circle" />
                </div>
                <div>
              ...
              <div>
                <a href="#" className="btn btn-sm btn-icon btn-default" title="Message">
        ...
        <div className="px-3 pt-3 border-bottom border-dashed">
          ...
          size,
          icon: Icon
        }, idx) => <div className="d-flex justify-content-between align-items-center pb-2" key={idx}>
              <div className="d-flex align-items-center py-1 gap-2">
              ...
              <div>
                <a href="#" className="btn btn-sm btn-icon btn-default" title="Download">
