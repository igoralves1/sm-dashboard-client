...
function createInitialData(count = 1000, start = new Date(2023, 9, 3), base = 1000) {
  let now = start;
  let value = base;
  const d = [];
...
const DynamicLineChart = () => {
  ...
  return <ComponentCard title="Dynamic Line">
      <CustomEChart extensions={[LineChart, CanvasRenderer]} getOptions={getDynamicLineChart} style={{
      height: '300px'
    }} />
    </ComponentCard>;
};
