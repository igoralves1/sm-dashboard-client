...
import { files, teamMembers } from '@/pages/apps/projects/projects/[projectId]/data'
      ...
      <CardBody className="p-0">
        ...
        <div className="p-3 border-bottom border-dashed">
          <div className="d-flex mb-3 justify-content-between align-items-center">
            ...
            <Link href="#" className="btn btn-light btn-sm btn-icon rounded-circle">
              <TbPlus />
            </Link>
          </div>
          ...
          {teamMembers.map((member, idx) => (
            <div className={clsx('d-flex justify-content-between align-items-center', { 'pb-2': idx !== teamMembers.length - 1 })} key={idx}>
              ...
              <div>
                <Link href="#" className="btn btn-sm btn-icon btn-default" title="Message">
